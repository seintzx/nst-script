...
var Y,V,Z,tt,et,nt,ot,it,rt,at,st,ct,lt,ut,dt,ft,mt,pt,ht,bt,gt,vt,wt,yt,kt,xt=!1,_t=!1,Lt=[],Ot=!1,Mt=!1,jt=[],Dt=!1,Tt=[],St="undefined"!=typeof document,It=p,Pt=d||u?"cssFloat":"float",Et=St&&!h&&!p&&"draggable"in document.createElement("div"),At=function(){
...
function Ht(t){t.draggable=!1}function Ft(){Dt=!1}function Gt(t){
...
},a.ignore.split(",").forEach((function(t){j(Y,t.trim(),Ht)
})),g(s,"dragover",Nt),
...
var o=T(I(n.el,0,n.options,!0)),i=R(n.el,n.options,Z)
...
;if(!1!==$)return 1!==$&&-1!==$||(z=1===$),
Dt=!0,setTimeout(Ft,30),U(),z&&!q?a.appendChild(Y):s.parentNode.insertBefore(Y,z?q:s),
...
detectDirection:qt,getChild:I},Bt.get=function(t){return t[H]
},Bt.mount=function(){
...
;(0,o.p)(t,n)})(e),e.className.includes("input-money")&&(async t=>{if(!t)return
...
},r=await(0,o.h)(i);if(!r?.status)return
;const{bazaar:a}=r,s=(0,o.v)(a[1]?.cost??"")-1;(0,o.k)(t,s.toString())
...
select:"bazaar",objID:(0,o.L)("userId")??""},e=await(0,o.h)(t)
;if(!e?.status)return
...
o.v)(e).toString();(0,o.k)(t,n)})(e)}))}},980:(t,e,n)=>{
...
;const n=e.parentElement?.parentElement,i=(0,o.v)(n?.querySelector(".instock").innerText)
;e.value=""+Math.min(i,100)}))}},488:(t,e,n)=>{
Object.defineProperty(e,"__esModule",{value:!0}),e.S=void 0;const o=n(185)
;e.S=()=>{console.log("nst - init default start")
;const t=(0,o.I)()??{},e={},n=i.script,r=t?.script??n
...
;if(n.length>2){
const t=n[0].replace(/:/g,""),e=(0,o.v)(n[1]),r=n[2].replace(/%/g,""),a=r.charAt(0),s=(0,
o.v)(r),c="+"==a?s/100+1:1-s/100;i[t]=Math.round(e*c),i.Total+=Math.round(e*c)}}
...
;s&&a.classList.add(s)}))};e.R=async t=>{if(!t)return;const e=await(0,o.h)({
...
}),e.H=void 0;const o=n(185);e.H=t=>{const{step:e,action:n,confirm:i}=(0,o.F)(t)
;return"actionForm"!==e||"equip"!==n||1===i?(0,o.G)({...(0,o.F)(t)}):(0,o.G)({
...(0,o.F)(t),confirm:1})}},355:(t,e)=>{Object.defineProperty(e,"__esModule",{
...
Object.defineProperty(e,"__esModule",{value:!0}),e.K=void 0;const o=n(185),i=(0,
o.L)("user2ID")??"",r=(0,
o.I)(),{hold:a,outcome:s,reloadone:c,reloadtwo:l,weapon:u,assaperk:d}=r
...
;e.K=t=>(t=>{const e=(0,o.Y)({title:"fighterino",element:t}),n=(0,o.O)({
classList:"nst-box-column"}),i=(0,o.V)({id:"nst-fighteroo",
classList:"torn-btn m-2",innerText:"fighterino"});i.addEventListener("click",x),
n.appendChild(i),e.appendChild(n)})(t)},689:(t,e)=>{
Object.defineProperty(e,"__esModule",{value:!0}),e.Z=void 0,e.Z=t=>{
document.getElementById("skip-to-content").innerText=t?.innerText}},470:(t,e)=>{
Object.defineProperty(e,"__esModule",{value:!0}),e.tt=void 0,e.tt=t=>{}},
...
;e.nt=t=>{if(!t)return
;const e=t?.parentElement,n=(0,o.I)("userdata"),i=(0,o.v)(n?.networth?.total),r=(0,
o.v)(n?.personalstats?.networth),a=Math.round(i-r),s=a>0?"text-nstgreen":a<0?"text-nstred":"",c=`<b class='${s}'>$${(0,
...
style:"margin-left: 3px; margin-right: 3px;"}),f=(0,o.ot)("i",{
...
}),e.it=e.rt=void 0;const o=n(185);e.rt=t=>{const{step:e}=(0,o.F)(t)
;if("buyItem"!==e)return(0,o.G)({...(0,o.F)(t)})
;const n=(0,o.$)()?.match(/(shop|market)/g)?.[0],i={market:t=>{
const e=t.replace("step=buyItem","step=buyItemConfirm");return(0,o.G)({
...(0,o.F)(e),item:0})},shop:t=>{
const e=t.replace("step=buyItem","step=buyItemConfirm");return(0,o.G)({
...(0,o.F)(e),item:0})},noloc:t=>(0,o.G)({...(0,o.F)(t)})}
;return(i[n]??i.noloc)(t)},e.it=t=>{new MutationObserver((e=>{e.forEach((e=>{
...
Object.defineProperty(e,"__esModule",{value:!0}),e.st=void 0;const o=n(185)
;e.st=()=>{document.addEventListener("dblclick",(t=>{const e=t?.target
;if("INPUT"!==e?.tagName)return
;const n=e?.parentElement?.parentElement?.parentElement?.parentElement,i=(0,
o.v)(document?.querySelector(".travel-agency-market .availableItemsAmount")?.getAttribute("value")),r=(0,
o.v)(document.getElementById("user-money").innerText),a=(0,
o.v)(n?.querySelector(".cost .c-price").innerText),s=(0,
o.v)(n?.querySelector(".stock .stck-amount").innerText),c=r/a>=i?i:Math.trunc(r/a),l=Math.min(c,s).toString()
;(0,o.k)(e,l)}))}},717:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0
}),e.ct=void 0;const o=n(185),i=n(607);let r;const a=t=>{
t.querySelector("#nst-lastaction")||t.appendChild((0,o.C)({id:"nst-lastaction",
classList:"sub-desc",innerText:"last action: "+r}))};e.ct=t=>{
r=(0,o.lt)(+t.user.lastAction.seconds).trim(),
(0,i.ut)(a,"#profile-mini-root .profile-container .description")}},
763:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.dt=void 0
...
task:"Injure (P)'s both arms."},wrath_of_duke:{task:"Defeat 4 (P)."}};e.dt=t=>{
...
}))}},243:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.ft=void 0
;const o=n(185),i=t=>{
const e=t?.querySelector(".total-price"),n=t?.querySelector(".action")
;(0,o.v)(e?.innerText)*o.minMugPerc>=o.mugThres&&n.classList.add("text-black","bg-nstmain")
};e.ft=t=>{new MutationObserver((t=>{t.forEach((t=>{
Array.from(t.addedNodes).forEach((t=>{
...
}},982:(t,e)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.ht=void 0
...
;t.setAttribute("href",e)};e.ht=t=>{new MutationObserver((t=>{t.forEach((t=>{
Array.from(t.addedNodes).forEach((t=>{
...
value:!0}),e.bt=void 0;const i=o(n(246)),r=n(185),a=t=>{t.stopPropagation()
...
;u.appendChild((0,r.gt)({innerHTML:l}));const d=(0,r.gt)({})
;Object.values(c).forEach((t=>{const e=(0,r.vt)({
...
id:"nst-quick-use",classList:"nst-box-button"}),d=(0,r.wt)({src:c,alt:o,
...
r.v)(o.getAttribute("src")).toString(),a=n?.innerText.replace(/ x\d+$/,"").replace(/[ ]*Blood Bag[ :]*/,"").replace(/[ ]*Bottle of[ :]*/,"").replace(/[ ]*First Aid[ :]*/,"").replace(/[ ]*Lawyer's Business Card[ :]*/,"LBC").replace(/[ ]*Can of[ :]*/,"")
;if(!i)return;const s=(0,r.I)(r.qfs);if(Object.keys(s).includes(i))return
...
},nopager:()=>{}};e.bt=t=>{new MutationObserver((t=>{t.forEach((t=>{
...
})).json(),c=s.links??{},l=s.text??{},u=(0,r.O)({});u.appendChild((0,r.gt)({
innerHTML:l}));const d=(0,r.gt)({});Object.values(c).forEach((t=>{
const e=(0,r.vt)({classList:"t-blue h m-left10 "+t.class,href:t.url,
...
id:"nst-quick-use",classList:"nst-box-button"}),d=(0,r.wt)({src:a,alt:o,
classList:"nst-box-img"}),f=(0,r.C)({id:"nst-quick-name",innerText:o
}),m=(0,r.C)({id:"nst-quick-close",classList:"nst-box-close",innerText:"✕"})
...
;if(!(n&&o&&a&&s.includes(a)))return;const f=(0,r.I)(r.qis)
...
;const o=n(185),i=(t,e)=>{
const{item:n,selector:i,reg:r}=e,a=(0,o.I)("quick"+n)??!1,s=t?.parentElement,c=s.querySelector("a."+i),l=c?.getAttribute("href")
;if(!c||!l)return
;const u=RegExp(r+"$","g"),d=RegExp(r+"1$","g"),f=a?l.replace(u,r+"1"):l.replace(d,r)
;c.setAttribute("href",f)},r=t=>{
const e=+((0,o.I)("jailscore")??"0"),n=t?.parentElement,r=t.querySelector("span.time").innerText.split(" ").reduce(((t,e)=>t+(/h/.test(e)?60*+e.replace(/h/g,""):/m/.test(e)?+e.replace(/m/g,""):0)),0),a=(0,
o.v)(t.querySelector("span.level").innerText.match(/\d+/g)?.join())*r
...
;Array.from(i).forEach((t=>r(t)))};e.kt=t=>{(t=>{const e=(0,o.Y)({
title:"Quick Jail",element:t?.parentElement}),n=(0,o.O)({
classList:"nst-box-column"}),i=(0,o.O)({classList:"nst-box-column"})
;e.appendChild(n),e.appendChild(i),(0,o.xt)({elem:n,title:"Jail Score",
cback:()=>{const e=t.querySelectorAll("span.info-wrap")
;Array.from(e).forEach((t=>r(t)))}});const s="Quick Bust",c=(0,o._t)(s),l={
id:"nst-"+c,type:"checkbox",value:c,checked:(0,o.I)(c)??!1}
;i.appendChild((0,o.Lt)(l,s,"",a));const u="Quick Bail",d=(0,o._t)(u),f={
id:"nst-"+d,type:"checkbox",value:d,checked:(0,o.I)(d)??!1}
;i.appendChild((0,o.Lt)(f,u,"",a))})(t),new MutationObserver((t=>{
...
value:!0}),e.Ot=void 0;const o=n(185);e.Ot=t=>{t=t.parentElement
;const{refills:{energy_refill_used:e,nerve_refill_used:n}}=(0,o.I)("userdata")
...
value:!0}),e.Mt=void 0,e.Mt=t=>t?.remove()},263:(t,e)=>{
Object.defineProperty(e,"__esModule",{value:!0}),e.jt=void 0;const n=t=>{
...
e=e.nextSibling};e.jt=t=>{o(t);const e=document.querySelector("#map")
...
Object.defineProperty(e,"__esModule",{value:!0}),e.Dt=void 0;const o=n(185),i={
...
;e.Dt=t=>i[(0,o.Tt)()](t)},268:function(t,e,n){
...
void(t.innerText="Invalid Key Length");const o=await(0,a.It)({api:n,selection:""
})
...
;const o={section:"user",select:"profile",api:n},i=await(0,a.h)(o)
;i?.status&&((0,a.P)({apikey:n}),(0,a.Pt)(i)?((0,a.P)({userdata:i
}),l()):t.innerText="You are not allowed, contact seintz[2460991]")},l=()=>{
if(!(0,a.Pt)())return;(0,r.S)();const t=document.querySelector("#nst-ul-main")
...
a.I)("script"),i=Object.keys(o).sort().reduce(((t,e)=>(o?.[e]?.onpage===n&&(t[e]=o?.[e]),
t)),{}),r=(0,a.O)({classList:"nst-script-block"})
;Object.entries(i).forEach((([t,e])=>{const n=e?.name,o=(0,a._t)(t),i={
id:"nst-"+o,value:o,checked:e?.enabled??!1
},s=(0,a.Lt)(i,n,e.description.toLowerCase(),(t=>{
...
const t=(0,a.O)({classList:"nst-block"}),e=(0,a.ot)("h4",{
classList:"nst-block-title",innerText:"mug threshold"});return t.appendChild(e),
(0,a.xt)({elem:t,title:"mug threshold"}),t})()),e.appendChild((()=>{
const t=(0,a.O)({classList:"nst-block"}),e=(0,a.ot)("h4",{
...
;const o=(0,a.Et)("leave","outcome"),i=(0,
a.Et)("mug","outcome"),r=(0,a.Et)("hospitalize","outcome"),s={id:"nst-hold",
checked:(0,a.I)("hold")},c=(0,a.Lt)(s,"hold","",(t=>{const e=t.target.checked
;(0,a.P)({hold:e})}));return n.appendChild(o),n.appendChild(i),n.appendChild(r),
t.appendChild(e),t.appendChild(n),t.appendChild(c),t})()),e.appendChild((()=>{
const t=(0,a.I)("weapon"),e=(0,a.O)({classList:"nst-block"}),n=(0,a.ot)("h4",{
...
id:"nst-temp",checked:(0,a.I)("temp")},s=(0,a.Lt)(r,"use temp first","",(t=>{
const e=t.target.checked;(0,a.P)({temp:e})})),c={id:"nst-assa",
checked:(0,a.I)("assaperk")},l=(0,a.Lt)(c,"assassinate","",(t=>{
...
}),e=(0,a.ot)("h4",{classList:"nst-block-title",innerText:"weapon reload"
}),n=(0,a.O)({id:"reload",classList:"nst-outcome"}),o={id:"nst-reloadone",
checked:(0,a.I)("reloadone")},i=(0,a.Lt)(o,"primary","",(t=>{
const e=t.target.checked;(0,a.P)({reloadone:e})})),r={id:"nst-reloadtwo",
checked:(0,a.I)("reloadtwo")},s=(0,a.Lt)(r,"secondary","",(t=>{
...
;const n=(0,a.vt)({href:"https://www.tornstats.com/settings/general",
...
})),c="tsapikey",l=(0,a.ot)("input",{id:"nst-"+c,type:"password",
...
;if(!e)return;e.innerHTML="";const n=(0,a.vt)({
href:"https://www.torn.com/preferences.php#tab=api",target:"_blank",
innerText:"limited",classList:"text-nstyellow font-bold"}),o=(0,a.vt)({
...
})),l="apikey",u=(0,a.ot)("input",{id:"nst-"+l,type:"password",
classList:"nst-input m-2",maxLength:16,required:!0,value:(0,a.I)(l)??""
}),d=(0,a.V)({id:"nst-login",classList:"torn-btn m-2",innerText:"save"})
...
})).appendChild((0,a.ot)("b",{innerText:"NST"}))
;const r=i.appendChild((0,a.ot)("ul",{id:"nst-ul-main",classList:"nst-ul-main"
}))
...
classList:"nst-box-column"});o.appendChild((0,r.ot)("table",{
...
})(t);const e=await(0,r.It)({selection:"/spy/user/"+a})
...
classList:"nst-table-row nst-nodrag text-center"}),a=(0,r.ot)("td",{
classList:"nst-table-cell",colSpan:3}),s=(0,r.vt)({
...
}),u=(0,r.ot)("td",{innerText:""+(0,r.M)(o+i),classList:"nst-table-cell"})
;u.classList.add(a),
...
Object.defineProperty(e,"__esModule",{value:!0}),e.qt=void 0;const o=n(185)
;e.qt=t=>{const e=t?.querySelectorAll(".trade-cont .user.right li.color2 ul li")
;if(0===e.length)return;let n=0;const i=(0,o.I)("items")
...
}),e.zt=e.$t=e.G=e.F=e.Ct=e.Nt=e.Ut=e.Pt=e.Bt=e.Rt=e.Ht=e.It=e.h=e.p=e.k=e.Y=e.Ft=e.Gt=e.Xt=e.Kt=e.Et=e.Lt=e.xt=e.Wt=e.Jt=e.wt=e.vt=e.gt=e.B=e.V=e.C=e.O=e.ot=e.Qt=e._t=e.lt=e.Yt=e.Vt=e.M=e.v=e.Zt=e.P=e.I=e.te=e.W=e.$=e.Tt=e.ee=e.L=e.J=void 0,
...
e.ee=()=>window.location.search.match(/\?sid=(\w+)/)?.[1],
e.Tt=()=>window.location.pathname.replace(/\//,"").replace(/\.php/,""),
e.$=()=>window.location.hash.replace(/#\/\w+=/g,""),
e.W=t=>!t||null==t||0===Object.keys(t).length,e.te=t=>{try{return JSON.parse(t)
...
},e.v=t=>+(t+"").replace(/[^\d]/g,""),e.M=t=>Math.round(t).toString().replace(/\B(?=(\d{3})+(?!\d))/g,","),
e.Vt=t=>{const e=["K","M","B","T","Q"];let n=Math.abs(t)
;if(n<1e3)return""+ +n.toFixed(2)
;for(let t=0;t<5;t++)if(n/=1e3,!(n>=1e3))return`${+n.toFixed(2)} ${e[t]}`
},e.Yt=t=>{const n=t.toLowerCase();let o=(0,e.v)(n),i=1
;return-1!==n.indexOf("k")?i=1e3:-1!==n.indexOf("m")?i=1e6:-1!==n.indexOf("b")?i=1e9:-1!==n.indexOf("t")&&(i=1e12),
o*=i,o>0?o.toLocaleString("en-US"):""},e.lt=t=>{let e=""
...
},e._t=t=>t.toLowerCase().replace(/ /g,""),e.Qt=t=>{const e=t.replace(/ /g,"")
;return e.charAt(0).toLowerCase()+e.slice(1)
},e.ot=(t,e)=>Object.assign(document.createElement(t),e),
e.O=t=>(0,e.ot)("div",t),
e.C=t=>(0,e.ot)("span",t),e.V=t=>(0,e.ot)("button",t),e.B=t=>(0,
e.ot)("li",t),e.gt=t=>(0,
e.ot)("p",t),e.vt=t=>(0,e.ot)("a",t),e.wt=t=>(0,e.ot)("img",t),
e.Jt=t=>(0,e.ot)("input",t),e.Wt=t=>(0,e.ot)("label",t),e.xt=t=>{
const{elem:n,title:o,cback:i=(()=>{})}=t,r=(0,e._t)(o),a=(0,e.O)({
classList:"nst-box-item"}),s=(0,e.ot)("input",{id:"nst-"+r,type:"text",
classList:"nst-input",value:(0,e.M)(+((0,e.I)(r)??"0")),placeholder:r})
;return s.addEventListener("keyup",(t=>{const n=t.target,o=(0,e.v)(n.value)
;n.value=o.toLocaleString("en-US");const r=(0,e._t)(n.placeholder);(0,e.P)({
[r]:o}),i()})),a.appendChild(s),n.appendChild(a),a},e.Lt=(t,n,o,i)=>{const r=(0,
e.O)({classList:"nst-box-item"}),a=(0,e.Jt)({...t,type:"checkbox"}),s={
innerText:n,htmlFor:t?.id,title:o},c=(0,e.Wt)(s)
;return r.addEventListener("change",i),r.appendChild(a),r.appendChild(c),r
},e.Et=(t,n)=>{const o=(0,e.I)("outcome").toString(),i=(0,e.O)({
classList:"nst-box-item"}),r=(0,e.Jt)({id:t,type:"radio",name:n,value:t,
checked:o===t}),a=(0,e.Wt)({innerText:"hospitalize"===t?"hosp":t,htmlFor:t,
classList:""});return i.appendChild(r),i.appendChild(a),i
},e.Kt=(t,e)=>document?.getElementById(t)?.appendChild(e),
e.Xt=t=>document.body.appendChild(t),e.Gt=(t,e)=>{
...
e._t)(i)+"Folded",a=o.classList.toggle("hidden");(0,e.P)({[r]:a})};e.Ft=t=>{
...
;if(!n)return
;const i=(0,e._t)(o),r=i+"Folded",a=(0,e.I)(r)?"nst-box-content hidden":"nst-box-content",s=(0,
e.O)({classList:"nst-box"}),c=(0,e.Ft)(o),l=(0,e.O)({classList:a})
...
;o&&o!==r?r.call(t,e):o.call(t,e),t.dispatchEvent(n),t.select()},e.h=async t=>{
const{section:n,select:o,objID:i,api:a}=t,s="https://api.torn.com/"+n+`/${i??""}?selections=${o}`+`&key=${a??(0,
e.I)("apikey")}&comment=nst`,c=await r("GET",s)
...
e.I)("tsapikey")??(0,e.I)("apikey")}${n}`,a=await r("GET",i)
...
status:!1}):s},e.Ht=(t={})=>{const n=(0,e.W)(t)?(0,e.I)("userdata"):t;return{
ne:n?.player_id,oe:n?.faction?.faction_id}},e.Rt=t=>t.toString(16),e.Bt=()=>{
const{oe:t}=(0,e.Ht)();return!!(0,o.t)().u.includes((0,e.Rt)(t))},e.Pt=(t={})=>{
const n=(0,e.I)("apikey");if(16!==n?.length)return!1
;const i=(0,e.W)(t)?(0,e.I)("userdata"):t,{ne:r,oe:a}=(0,e.Ht)(i)
;return!((0,e.W)(i)||!(0,
o.t)().u.includes((0,e.Rt)(a))&&!(0,o.t)().l.includes((0,e.Rt)(r)))
},e.Ut=async()=>{const t=(0,e.I)("apikey");if(16!==t?.length)return
;const n=(0,e.I)("userdata"),o=1e3*n?.timestamp??0;if(Date.now()-6e4<=o)return
...
api:t},r=await(0,e.h)(i);if(!r?.status)return
;const a=r.merit_perks.filter((t=>t.includes("mug"))).join(),s=((0,
e.v)(a)/5+20)/400;if((0,e.P)({userdata:r}),(0,e.P)({mugperc:s
}),Date.now()-36e5<=o)return;const c={section:"torn",select:"items",api:t
},l=await(0,e.h)(c);if(!l?.status)return;const{items:u}=l;(0,e.P)({items:u})
},e.Nt=(t="")=>{if(!(0,e.Pt)())return!1;const n=(0,e.I)("script")
;if(""===t)return!0;const o=n?.[t]?.enabled;return!!o},e.Ct=()=>{
...
})),{}),e.G=t=>Object.keys(t).map((e=>`${e}=${t[e]}`)).join("&"),e.$t=t=>{
...
}catch(t){console.error(t),this._original_send(e)}})},e.zt=(t,e)=>{
...
e.v)((0,e.I)("mugthreshold")),e.qit="Quick Items",
e.qis=(0,e._t)(e.qit),e.qft="Quick Faction",e.qfs=(0,e._t)(e.qft)
...
value:!0}),e.ut=void 0,e.ut=(t,e,n=!1)=>{const o=document?.querySelector(e)
...
;const t=n(185),e=n(268),o=n(607),i=n(276),r=n(913),a=n(661),s=n(51),c=n(980),l=n(714),u=n(108),d=n(149),f=n(188),m=n(716),p=n(355),h=n(718),b=n(689),g=n(379),v=n(620),w=n(954),y=n(424),k=n(763),x=n(243),_=n(982),L=n(215),O=n(840),M=n(957),j=n(292),D=n(263),T=n(52),S=n(538),I=n(549),P=n(470),E=n(717),A=n(527),q={
home:()=>{
(0,t.Nt)("livenetworth")&&(0,o.ut)(v.nt,'ul.info-cont-wrap [aria-label^="Networth"]'),
(0,t.Nt)("effectivestats")&&(0,o.ut)(d.U,".battle")},abro:()=>{
(0,t.Nt)("maxbuyabroad")&&(0,o.ut)(y.st,"body")},trav:()=>{}},z={amarket:()=>{
(0,t.Nt)("rwbonusdisplay")&&(0,o.ut)(T.Dt,"body")},bazaar:()=>{
(0,t.Nt)("rwbonusdisplay")&&(0,
o.ut)(T.Dt,"body"),(0,t.Nt)("bazaarvalue")&&(0,o.ut)(r._,"#bazaarRoot .wrapper")
},city:()=>{},companies:()=>{},displaycase:()=>{},faction:()=>{},index:()=>{},
item:()=>{(0,t.Nt)("equipnoconfirm")&&(0,t.$t)(m.H)},imarket:()=>{
(0,t.Nt)("marketnoconfirm")&&(0,t.$t)(w.rt)},loader:()=>{},pmarket:()=>{},
profiles:()=>{},search:()=>{},trade:()=>{},all:()=>{
(0,o.ut)(e.St,"#sidebar"),(0,
t.Nt)("leftalign")&&(0,g.et)(),(0,t.Nt)("minilastaction")&&(0,
t.zt)(E.ct,"UserMiniProfile")},nopager:()=>{}},$={amarket:()=>{},bazaar:()=>{(0,
t.Nt)("bazaarautoprice")&&(0,o.ut)(i.m,"body")},city:()=>{
(0,t.Nt)()&&(0,o.ut)(D.jt,"body"),
(0,t.Nt)("cityfinds")&&(0,o.ut)(a.j,"#map .leaflet-marker-pane")},
companies:()=>{
(0,t.Nt)("ezmoneydeposit")&&(0,o.ut)(p.X,"body"),(0,t.Nt)("employeela")&&(0,
o.ut)(f.R,".manage-company"),
(0,t.Nt)("companyrestock")&&/stock/.test((0,t.$)())&&(0,o.ut)(s.D,"body")},
displaycase:()=>{
(0,t.Nt)("displaycaseitemid")&&(0,o.ut)(l.q,"ul.dc-list"),(0,t.Nt)("rwbonusdisplay")&&(0,
o.ut)(T.Dt,"ul.display-cabinet")},factions:()=>{
(0,t.Nt)("ezmoneydeposit")&&(0,o.ut)(p.X,"body"),
(0,t.Nt)(t.qfs)&&(0,o.ut)(h.bt,"#faction-armoury")},index:()=>{q[(0,t.Ct)()]()},
item:()=>{
(0,t.Nt)("removeuglyimage")&&(0,o.ut)(j.Mt,'[class^="itemPreviewWrapper"]',!0),
(0,
t.Nt)("easyloadoutequip")&&(0,o.ut)(u.N,'ul[class^="slots"]'),(0,t.Nt)(t.qis)&&(0,
o.ut)(L.yt,"div.items-wrap")},imarket:()=>{
(0,t.Nt)("marketnoconfirm")&&(0,o.ut)(w.it,"body")},jailview:()=>{
(0,t.Nt)("quickjail")&&(0,o.ut)(O.kt,"ul.users-list")},loader:()=>{
(0,t.Nt)("missionhelper")&&"missions"===(0,
t.ee)()&&(0,o.ut)(k.dt,".giver-cont-wrap"),
(0,t.Nt)("fighterino")&&"attack"===(0,
t.ee)()&&(0,t.Bt)()&&(0,o.ut)(I.K,'div[class^="playersModelWrap"]'),
(0,t.Nt)("intercept")&&"attack"===(0,
t.ee)()&&(0,o.ut)(P.tt,'div[class^="playersModelWrap"]')},pmarket:()=>{
(0,t.Nt)("pointsnoconfirm")&&(0,
o.ut)(_.ht,".users-point-sell"),(0,t.Nt)("pointsmuglight")&&(0,
o.ut)(x.ft,".users-point-sell")},profiles:()=>{
(0,t.Nt)("idtoname")&&(0,o.ut)(b.Z,".user-info-value"),
(0,t.Nt)("statspies")&&(0,o.ut)(A.At,".user-info-value")},properties:()=>{
(0,t.Nt)("ezmoneydeposit")&&(0,o.ut)(p.X,"body")},shops:()=>{
(0,t.Nt)("cshopmaxbuy")&&(0,o.ut)(c.T,"body")},trade:()=>{
(0,t.Nt)("tradevalue")&&(0,o.ut)(S.qt,"#trade-container .trade-cont")},all:()=>{
(0,t.Nt)("refillreminder")&&(0,o.ut)(M.Ot,'[class*="bar"][class*="energy"]')},
nopager:()=>{}},C={loading:async()=>{const e=(0,t.I)()
;if(!(0,t.W)(e)&&!(0,t.Pt)())return
;document.onreadystatechange=()=>C[document.readyState]();const n=(0,t.Tt)()
;(z.all??z.nopager)(),(z[n]??z.nopager)(),(0,t.W)(e)||(0,t.Ut)()},
interactive:()=>{const e=(0,t.Tt)();($.all??$.nopager)(),($[e]??$.nopager)()},
