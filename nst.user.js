...
;(0,i.p)(t,Math.min((0,i.h)(n),1e4).toString())
...
t?.querySelector("#nst-lastaction")||t.appendChild((0,i.O)({id:"nst-lastaction",
innerText:"last action: "+r}))};e.dt=t=>{
r=(0,i.ft)(+t.user.lastAction.seconds).trim(),
(0,o.ht)(a,'#profile-mini-root [class*="profile-mini-_userProfileWrapper"]')}},
...
p.appendChild(w),
p.appendChild(y),h.appendChild(v),h.appendChild(g),m.appendChild(p),
...
i.h)(l)/(0,i.h)(u)*100);n.innerText=`life: ${d}%`})(g,v,b)),2e3)}},
...
}catch(t){console.error(t),this._original_send(e)}})},e.ie=(t,n,i="sid")=>{
if((0,e.Nt)())return;const{fetch:o}=unsafeWindow
;unsafeWindow.fetch=async(...e)=>{
const r=await o(...e),a=new URL("https://www.torn.com"+e[0])?.searchParams,s=a?.get(i)
;if(s!==n)return r;let c;try{c=await(r?.clone()?.json())}catch(t){
return console.error(e,t),r}return t(c),r}
...
index:()=>{},item:()=>{(0,t.Bt)("equipnoconfirm")&&(0,t.Ct)(m.R)},imarket:()=>{
