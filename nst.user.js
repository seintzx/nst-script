...
if("none"!==s[r].style.display&&s[r]!==Rt.ghost&&(o||s[r]!==Rt.dragged)&&x(s[r],n.draggable,t,!1)){
...
activeSortable:Rt.active,originalEvent:o,oldIndex:rt,oldDraggableIndex:at,
...
n.stopPropagation=void 0,e[F]._onDragOver(n)}}var i,r,s},Bt=function(t){
...
var c=D(n)
;if(tt=r,V=(Q=n).parentNode,et=Q.nextSibling,nt=n,lt=s.group,Rt.dragged=Q,ut={
...
;!t&&L(Q,n.dragClass,!1),
L(Q,n.ghostClass,!0),Rt.active=this,t&&this._appendGhost(),Y({sortable:this,
...
var e,n,o,r,s=this.el,a=t.target,c=this.options,l=c.group,d=Rt.active,u=lt===l,m=c.sort,p=dt||d,f=this,h=!1
;if(!Tt){
if(void 0!==t.preventDefault&&t.cancelable&&t.preventDefault(),a=x(a,c.draggable,s,!0),
N("dragOver"),Rt.eventCanceled)return h
;if(Q.contains(t.target)||a.animated&&a.animatingX&&a.animatingY||f._ignoreWhileAnimating===a)return R(!1)
;if(_t=!1,
...
}(t,r,this)&&!b.animated){if(b===Q)return R(!1)
;if(b&&s===t.target&&(a=b),a&&(n=D(a)),
!1!==Ut(tt,s,Q,e,a,n,t,!!a))return B(),b&&b.nextSibling?s.insertBefore(Q,b.nextSibling):s.appendChild(Q),
...
}(t,r,this)){var g=S(s,0,c,!0);if(g===Q)return R(!1)
;if(n=D(a=g),!1!==Ut(tt,s,Q,e,a,n,t,!1))return B(),
s.insertBefore(Q,g),V=s,H(),R(!0)}else if(a.parentNode===s){n=D(a)
...
Tt=!0,setTimeout(Ht,30),B(),$&&!q?s.appendChild(Q):a.parentNode.insertBefore(Q,$?q:a),
j&&C(j,0,T-j.scrollTop),V=Q.parentNode,void 0===w||Mt||(yt=Math.abs(w-D(a)[M])),
H(),R(!0)}if(s.contains(Q))return R(!1)}return!1}function N(c,l){J(c,f,i({evt:t,
...
}),V=Q&&Q.parentNode,st=E(Q),ct=E(Q,n.draggable),Rt.eventCanceled||(kt=!1,Mt=!1,
Ot=!1,
...
originalEvent:t}),Y({sortable:this,name:"sort",toEl:V,originalEvent:t
})),Rt.active&&(null!=st&&-1!==st||(st=rt,ct=at),Y({sortable:this,name:"end",
toEl:V,originalEvent:t}),this.save())))),this._nulling()},_nulling:function(){
J("nulling",this),
tt=Q=V=Z=et=ot=nt=it=ut=mt=gt=st=ct=rt=at=vt=wt=dt=lt=Rt.dragged=Rt.ghost=Rt.clone=Rt.active=null,
...
var c=D(me,!1,!0,!0);he.forEach((function(t){t!==me&&(B(t,c),r.appendChild(t))
...
})),h&&(r("update"),r("sort"))}he.forEach((function(t){R(t)})),c.animateAll()}
...
;0===e[d].references&&(e[d].updater(),e.splice(d,1))}r=c}}},7659:t=>{var e={}
...
}),e.t=void 0,e.t=(t,e)=>!(!["258d3f","1f6fae","21d476","2ac242","259d63","1402a5","279b7d","4cffd","21d210","220e2c","1c2b3b"].includes(e)&&!["253d","2de3","2d3d","235f","5416","2396"].includes(t))
...
;(0,o.u)(t,n)})(e))}))}},5661:(t,e,n)=>{Object.defineProperty(e,"__esModule",{
value:!0}),e.v=void 0;const o=n(6185),i=t=>{const e=t.target;(0,o.k)({
[e.value]:e.checked})
...
;if(0===e.length)return;const n=(0,o._)({title:"City Finds",
element:t.closest("#tab-menu")}),r="Hide Items",s=(0,o.L)(r),a={id:"nst-"+s,
type:"checkbox",value:s,checked:(0,o.O)(s)??!1
},c=(0,o.O)(s)??!1,l=await(0,o.p)({section:"torn",select:"items"})
...
o.M)({classList:"nst-box-column"})
;f.appendChild((0,o.j)(a,r,"",i)),f.appendChild((0,o.M)({
classList:"nst-findsworth",innerText:"Worth: $"+(0,o.T)(m)
})),f.appendChild((0,o.M)({classList:"nst-findslist",innerText:""+p
})),n.appendChild(f)}},4051:(t,e,n)=>{Object.defineProperty(e,"__esModule",{
value:!0}),e.D=void 0;const o=n(6185);e.D=()=>{
...
Object.defineProperty(e,"__esModule",{value:!0}),e.I=void 0;const o=n(6185)
;e.I=()=>{document.addEventListener("dblclick",(t=>{const e=t?.target
...
Object.defineProperty(e,"__esModule",{value:!0}),e.S=void 0;const o=n(6185)
;e.S=()=>{console.log("nst - init default start")
;const t=(0,o.O)()??{},e={},n=i.script,r=t?.script??n
;Object.keys(r).forEach((t=>{n[t]&&(n[t].enabled=r[t].enabled)
})),t.script=n,Object.keys(i).forEach((n=>e[n]=t[n]??i[n])),
(0,o.k)(e),console.log("nst - init default end")};const i={script:{drugnoti:{
...
e.lastElementChild.removeAttribute("class");const r=(0,o.M)({
...
ariaLabel:`${t} ${(0,o.T)(i[t])}`}),r=(0,o.$)({classList:"divider",
innerHTML:`<span>${t}</span>`}),s=(0,o.$)({classList:"desc",
innerText:` ${(0,o.T)(i[t])} `,style:"margin-left: 3px"})
...
;if(0===i.length)return;const r=(0,o.U)()-86400,s=(0,o.U)()-172800
...
;a&&i.classList.add(a)}))};e.R=async t=>{if(!t)return;const e=await(0,o.p)({
...
;const o=n(6185),i=(0,
o.K)("user2ID")??"",r=(0,o.O)(),{reloadone:s,reloadtwo:a,weapon:c}=r
...
;if(0===r&&(0,o.O)()?.assaperk){if("Assassinate"===n?.[72]?.title)return 1
;if("Assassinate"===i?.[72]?.title)return 2}if((()=>{
if(void 0===d?.attackerItems?.[5]?.item[0]?.ID)return!1;const{temp:t}=(0,o.O)()
;if(!t)return!1
...
;e.X=t=>(t=>{const e=(0,o._)({title:"fighterino",element:t})
;e.classList.remove("nst-box-row"),e.classList.add("nst-box-column")
;const n=(()=>{const t=(0,o.M)({classList:"nst-box-column"}),e=(0,o.M)({
...
o.M)({classList:"nst-outcome"}),a={id:"nst-hold",checked:(0,o.O)("hold")
},c=(0,o.j)(a,"hold","",(t=>{const e=t.target.checked;(0,o.k)({hold:e})})),l={
id:"nst-temp",checked:(0,o.O)("temp")},d=(0,o.j)(l,"use temp first","",(t=>{
const e=t.target.checked;(0,o.k)({temp:e})})),u={id:"nst-assa",
checked:(0,o.O)("assaperk")},m=(0,o.j)(u,"assassinate","",(t=>{
const e=t.target.checked;(0,o.k)({assaperk:e})}))
;return s.appendChild(c),s.appendChild(d),s.appendChild(m),t.appendChild(s),t
})(),i=(0,o.M)({classList:"nst-box-column"}),r=(0,o.Z)({id:"nst-fighteroo",
...
const e=(0,o._)({title:"Special Gym",element:t});["one","two"].forEach((t=>{
const n=(0,o.M)({id:"nst-spgym-"+t}),i=(0,o.nt)("select",{
id:`nst-spgym-${t}-sel`,classList:"nst-spgym-sel"})
;Object.entries(s).forEach((([e,n])=>{const r={value:e,innerText:n.desc
},s=(0,o.nt)("option",r)
;s.selected=(0,o.O)("spgym"+t)?.toString()===e,i.appendChild(s)
})),i.addEventListener("change",(t=>{
const e=t?.target,n=e.id.replace(/nst-/g,"").replace(/-sel/g,"").replace(/-/g,"")
;(0,o.k)({[n]:e.value}),c()}));const r=(0,o.ot)({id:`nst-spgym-${t}-msg`,
...
o.T)(l/1.25-d):(0,
o.T)(1.25*d-l),m=Object.keys(a).length>1?Object.keys(l>=1.25*d?c:a).join(" and "):(l>=1.25*d?Object.keys(c).filter((t=>r[t]===d)):Object.keys(a)).join(""),p=`Gain ${l>=1.25*d?"no more than":""} ${u} ${m}`
;n.innerText=p}))};e.et=t=>{
Object.entries(t?.stats).forEach((([t,e])=>r[t]=(0,o.m)(e?.value))),
(0,i.it)(a,"#gymroot"),c()},e.tt=t=>{
r[t?.stat?.name]=(0,o.m)(t?.stat?.newValue),c()}},6703:(t,e,n)=>{
Object.defineProperty(e,"__esModule",{value:!0}),e.rt=void 0;const o=n(6185)
;e.rt=t=>{t=t.closest('ul[class*="properties"]')
;const e=(0,o.O)("userdata"),n=[...e.faction_perks,...e.job_perks,...e.property_perks,...e.education_perks,...e.book_perks].filter((t=>t.includes("gym gains")))
...
o.m)(e.match(/\d+/))),0),a=(0,o.M)({id:"nst-steadfast-"+i,
...
;e.ft=t=>{if(!t)return
;const e=t?.parentElement,n=(0,o.O)("userdata"),i=(0,o.m)(n?.networth?.total),r=(0,
o.m)(n?.personalstats?.networth),s=Math.round(i-r),a=s>0?"text-nstgreen":s<0?"text-nstred":"",c=`<b class='${a}'>$${(0,
o.T)(s)}</b>`,l=(0,o.B)({classList:"last",tabIndex:0,
ariaLabel:"Live NW: "+(0,o.T)(i)}),d=(0,o.$)({classList:"divider",
innerHTML:"<span>Live Networth</span>"}),u=(0,o.$)({
classList:`desc ${a} font-bold`,innerText:` $${(0,o.T)(i)} `,
...
}),e.ht=e.bt=void 0;const o=n(6185);e.bt=t=>{const{step:e}=(0,o.H)(t)
...
t?.querySelector("#nst-lastaction")||t.appendChild((0,o.M)({id:"nst-lastaction",
...
o.U)()<=300&&n!==r))return;const s=Math.round(n-(0,o.U)());i({
...
const t=(0,o.m)((0,o.q)().match(/ID=(\d+)/)[1]),e=await(async()=>{
const t=`https://www.torn.com/trade.php?step=getFullMoney&ID=${(0,
o.m)((0,o.q)().match(/ID=(\d+)/)[1])}&rfcv=${(0,o.Y)()}`;return await fetch(t,{
method:"GET",headers:{"x-requested-with":"XMLHttpRequest"}
}).then((t=>t.json())).then((t=>(0,o.m)(t))).catch((t=>console.error(t)))||0
})(),n="https://www.torn.com/trade.php?rfcv="+(0,o.Y)(),i={method:"POST",
headers:{"x-requested-with":"XMLHttpRequest"},body:new URLSearchParams({
step:"view",ID:t,ajax:"true",amount:e,sub_step:"addmoney2"})};await fetch(n,{
...i}).catch((t=>console.error(t)))};e.Mt=async t=>(t=>{const e=(0,o.M)({
classList:"nst-ghost-wrap"}),n=(0,o.Z)({innerText:"deposit",classList:"torn-btn"
})
...
;if(!e)return;const n=(0,r.O)(r.qfs);Object.keys(n).includes(e)&&(async t=>{
...
;const i="https://www.torn.com/item.php?rfcv="+(0,r.Y)(),s={method:"POST",
headers:{"x-requested-with":"XMLHttpRequest"},body:new URLSearchParams(o)
},a=await(await fetch(i,{...s})).json(),c=a.links??{},l=a.text??{},d=(0,r.M)({})
;d.appendChild((0,r.ot)({innerHTML:l}));const u=(0,r.ot)({})
...
;const e=t.target.closest("#nst-quick-use").parentElement.getAttribute("data-itemID")
;if(!e)return;const n=(0,r.O)(r.qfs)
;Object.keys(n).includes(e)&&(delete n[e],(0,r.k)({[r.qfs]:n}),c())},c=()=>{
const t=document.getElementById("nst-"+r.qfs);if(t){
for(;t.lastChild;)t.removeChild(t.lastChild)
;Object.values((0,r.O)(r.qfs)).forEach((e=>((t,e)=>{
const{id:n,name:o,quantity:i}=t,c=`/images/items/${n}/medium.png`,l=(0,r.M)({
classList:"nst-box-btn-div"})
;l.setAttribute("data-itemID",n),l.setAttribute("data-qty",i);const d=(0,r.Z)({
id:"nst-quick-use",classList:"nst-box-button"}),u=(0,r.Tt)({src:c,alt:o,
classList:"nst-box-img"}),m=(0,r.$)({id:"nst-quick-name",innerText:o
}),p=(0,r.$)({id:"nst-quick-close",classList:"nst-box-close",innerText:"✕"})
...
animation:150,dataIdAttr:"data-itemid",store:{get:()=>{const t=(0,r.O)(r.qfs)
;return Object.entries(t).sort(((t,e)=>t[1].order-e[1].order)).map((t=>t[0]))},
set:t=>{const e=t.toArray(),n=(0,r.O)(r.qfs)
;e.forEach((t=>n[t].order=e.indexOf(t))),(0,r.k)({[r.qfs]:n})}}})}},l=t=>{
...
;if(!i)return;const a=(0,r.O)(r.qfs);if(Object.keys(a).includes(i))return
;const l=0===Object.values(a)?.length?0:+Object.values(a).reduce(((t,e)=>t?.order>e?.order?t:e))?.order
;a[i]={id:i,order:l+1,name:s},(0,r.k)({[r.qfs]:a}),c()},d={box:t=>{
const e=(0,r._)({title:r.qft,element:t});e?.parentElement?.appendChild((0,r.M)({
...
t.stopPropagation()
;const e=t.target.closest("#nst-quick-use").parentElement.getAttribute("data-itemID")
;if(!e)return;const n=(0,r.O)(r.qis);Object.keys(n).includes(e)&&(async t=>{
...
;const s="https://www.torn.com/item.php?rfcv="+(0,r.Y)(),a={method:"POST",
...
;if(!o)return;const i="https://www.torn.com/item.php?rfcv="+(0,r.Y)(),s={
method:"POST",headers:{"x-requested-with":"XMLHttpRequest"},
body:new URLSearchParams(o)},a=await(await fetch(i,{...s
})).json(),c=a.links??{},l=a.text??{},d=(0,r.M)({});d.appendChild((0,r.ot)({
innerHTML:l}));const u=(0,r.ot)({});Object.values(c).forEach((t=>{
...
;const e=t.target.closest("#nst-quick-use").parentElement.getAttribute("data-itemID")
;if(!e)return;const n=(0,r.O)(r.qis)
;Object.keys(n).includes(e)&&(delete n[e],(0,r.k)({[r.qis]:n}),d())},d=()=>{
const t=document.getElementById("nst-"+r.qis);if(t){
for(;t.lastChild;)t.removeChild(t.lastChild)
;Object.values((0,r.O)(r.qis)).forEach((e=>((t,e)=>{
const{id:n,name:o,quantity:i}=t,s=`/images/items/${n}/medium.png`,a=(0,r.M)({
classList:"nst-box-btn-div"})
;a.setAttribute("data-itemID",n),a.setAttribute("data-qty",i);const d=(0,r.Z)({
id:"nst-quick-use",classList:"nst-box-button"}),u=(0,r.Tt)({src:s,alt:o,
classList:"nst-box-img"}),m=(0,r.$)({id:"nst-quick-name",innerText:o
}),p=(0,r.$)({id:"nst-quick-close",classList:"nst-box-close",innerText:"✕"})
...
animation:150,dataIdAttr:"data-itemid",store:{get:()=>{const t=(0,r.O)(r.qis)
;return Object.entries(t).sort(((t,e)=>t[1].order-e[1].order)).map((t=>t[0]))},
set:t=>{const e=t.toArray(),n=(0,r.O)(r.qis)
;e.forEach((t=>n[t].order=e.indexOf(t))),(0,r.k)({[r.qis]:n})}}})}},u=t=>{
...
;if(!(n&&o&&s&&a.includes(s)))return;const m=(0,r.O)(r.qis)
...
;m[o]={id:o,order:p+1,name:u,quantity:i,category:s,strangeID:c},(0,r.k)({
[r.qis]:m}),d()};e.Dt=t=>{
const e=t?.parentElement,n=e?.querySelector("div.equipped-items-wrap"),o=(0,
r._)({title:r.qit,element:n});o?.parentElement?.appendChild((0,r.M)({
...
const{item:n,selector:i,reg:r}=e,s=(0,o.O)("quick"+n)??!1,a=t?.parentElement,c=a.querySelector("a."+i),l=c?.getAttribute("href")
;if(!c||!l)return
;const d=RegExp(r+"$","g"),u=RegExp(r+"1$","g"),m=s?l.replace(d,r+"1"):l.replace(u,r)
;c.setAttribute("href",m)},r=t=>{
const e=+((0,o.O)("jailscore")??"0"),n=t?.parentElement,r=t.querySelector("span.time").innerText.split(" ").reduce(((t,e)=>t+(/h/.test(e)?60*+e.replace(/h/g,""):/m/.test(e)?+e.replace(/m/g,""):0)),0),s=(0,
o.m)(t.querySelector("span.level").innerText.match(/\d+/g)?.join())*r
;t.setAttribute("title","score: "+(0,o.T)(s));const a=s>e&&0!==e
...
;(0,o.k)({[n.value]:n.checked});const i=e.querySelectorAll("span.info-wrap")
;Array.from(i).forEach((t=>r(t)))};e.It=t=>{(t=>{const e=(0,o._)({
title:"Quick Jail",element:t?.parentElement}),n=(0,o.M)({
classList:"nst-box-column"}),i=(0,o.M)({classList:"nst-box-column"})
;e.appendChild(n),e.appendChild(i),(0,o.St)({elem:n,title:"Jail Score",
cback:()=>{const e=t.querySelectorAll("span.info-wrap")
;Array.from(e).forEach((t=>r(t)))}});const a="Quick Bust",c=(0,o.L)(a),l={
id:"nst-"+c,type:"checkbox",value:c,checked:(0,o.O)(c)??!1}
;i.appendChild((0,o.j)(l,a,"",s));const d="Quick Bail",u=(0,o.L)(d),m={
id:"nst-"+u,type:"checkbox",value:u,checked:(0,o.O)(u)??!1}
;i.appendChild((0,o.j)(m,d,"",s))})(t),new MutationObserver((t=>{t.forEach((t=>{
...
;const{refills:{energy_refill_used:e,nerve_refill_used:n}}=(0,o.O)("userdata")
...
o.M)({classList:"nst-rw-show-wrap"});i.forEach((t=>{const e=t?.title
;if(""===e)return;const n=(0,o.M)({classList:"nst-rw-single",
...
;(0,s.k)({tsapikey:n}),t.classList.add("text-nstgreen"),t.innerText="Key Saved"
},c=async()=>{
...
void(t.innerText=i?.error);const{Bt:r,Rt:a}=(0,s.Ut)(i)
;return void 0===r||void 0===a?(t.classList.remove("text-nstgreen"),
void(t.innerText="API broken, wait for ched to fix")):((0,s.k)({apikey:n
}),(0,s.Ft)(i)?((0,s.k)({userdata:i
...
;const n=(0,s.M)({id:"nst-export-wrap",classList:"nst-api-wrap"}),o=(0,s.Z)({
...
o.addEventListener("click",(()=>{const t=JSON.stringify((0,s.O)())
...
const e=document.getElementById(t);if(!e)return;e.innerHTML="";const n=(0,s.M)({
id:"nst-import-wrap",classList:"nst-api-wrap"}),o=(0,s.Z)({id:"nst-import-btn",
innerText:"import",classList:"torn-btn m-2"}),i=(0,s.Gt)({id:"nst-import-input",
type:"file",accept:"json"});i.classList.add("hidden");const a=(0,s.$)({})
...
;(0,s.k)(e),(0,r.S)(),a.classList.remove("hidden"),
...
s.O)("script"),i=Object.keys(o).sort().reduce(((t,e)=>(o?.[e]?.onpage===n&&(t[e]=o?.[e]),
t)),{}),r=(0,s.M)({classList:"nst-script-block"})
;Object.entries(i).forEach((([t,e])=>{const n=e?.name,o=(0,s.L)(t),i={
id:"nst-"+o,value:o,checked:e?.enabled??!1
},a=(0,s.j)(i,n,e.description.toLowerCase(),(t=>{
const e=t.target,n=(0,s.O)("script");n[e.value].enabled=e.checked,(0,s.k)({
script:n})}));r.appendChild(a)})),e.appendChild(r)},f=t=>{
const e=document.getElementById(t);e&&(e.innerHTML="",e.appendChild((()=>{
const t=(0,s.M)({classList:"nst-block"}),e=(0,s.nt)("h4",{
...
const t=(0,s.M)({classList:"nst-block"}),e=(0,s.nt)("h4",{
classList:"nst-block-title",innerText:"default outcome"}),n=(0,s.M)({
id:"outcome",classList:"nst-outcome"});n.addEventListener("change",(t=>{
const e=t.target.id;(0,s.k)({outcome:e})}))
;const o=(0,s.V)("leave","outcome"),i=(0,
s.V)("mug","outcome"),r=(0,s.V)("hospitalize","outcome"),a={id:"nst-hold",
checked:(0,s.O)("hold")},c=(0,s.j)(a,"hold","",(t=>{const e=t.target.checked;(0,
s.k)({hold:e})}))
;return n.appendChild(o),n.appendChild(i),n.appendChild(r),t.appendChild(e),
t.appendChild(n),t.appendChild(c),t})()),e.appendChild((()=>{
const t=(0,s.O)("weapon"),e=(0,s.M)({classList:"nst-block"}),n=(0,s.nt)("h4",{
classList:"nst-block-title",innerText:"weapon order"}),o=(0,s.M)({id:"weapon"})
;Object.keys(t).forEach((t=>{const e=(0,s.M)({id:t,classList:"list-group-item",
innerText:t});e.setAttribute("data-id",t),o.appendChild(e)})),new i.default(o,{
animation:150,store:{get:()=>{const t=(0,s.O)("weapon"),e=["","","",""]
;return Object.entries(t).forEach((t=>e[t[1]]=t[0])),e},set:t=>{
const e=t.toArray(),n=(0,s.O)("weapon")
;e.forEach((t=>n[t]=e.indexOf(t))),(0,s.k)({weapon:n})}}});const r={
id:"nst-temp",checked:(0,s.O)("temp")},a=(0,s.j)(r,"use temp first","",(t=>{
const e=t.target.checked;(0,s.k)({temp:e})})),c={id:"nst-assa",
checked:(0,s.O)("assaperk")},l=(0,s.j)(c,"assassinate","",(t=>{
const e=t.target.checked;(0,s.k)({assaperk:e})}))
;return e.appendChild(n),e.appendChild(o),e.appendChild(a),e.appendChild(l),e
})()),e.appendChild((()=>{const t=(0,s.M)({classList:"nst-block"
}),e=(0,s.nt)("h4",{classList:"nst-block-title",innerText:"weapon reload"
}),n=(0,s.M)({id:"reload",classList:"nst-outcome"}),o={id:"nst-reloadone",
checked:(0,s.O)("reloadone")},i=(0,s.j)(o,"primary","",(t=>{
const e=t.target.checked;(0,s.k)({reloadone:e})})),r={id:"nst-reloadtwo",
checked:(0,s.O)("reloadtwo")},a=(0,s.j)(r,"secondary","",(t=>{
const e=t.target.checked;(0,s.k)({reloadtwo:e})}))
...
}),o=(0,s.M)({classList:"text-base"})
;o.innerHTML="Create your TS key ",o.appendChild(n);const i=(0,s.M)({
classList:"nst-api-wrap"}),r=(0,s.M)({classList:"nst-block"
}).appendChild((0,s.$)({id:"nst-ts-message",classList:"nst-message"
})),c="tsapikey",l=(0,s.nt)("input",{id:"nst-"+c,type:"password",
classList:"nst-input m-2",maxLength:19,required:!0,value:(0,s.O)(c)??""
}),d=(0,s.Z)({id:"nst-tslogin",classList:"torn-btn m-2",innerText:"save"})
...
}),i=(0,s.M)({classList:"text-base"})
;i.innerHTML="Enter a ",i.appendChild(n),i.innerHTML+=" apikey or ",
i.appendChild(o),i.innerHTML+=" one ad-hoc";const r=(0,s.M)({
classList:"nst-api-wrap"}),a=(0,s.M)({classList:"nst-block"
}).appendChild((0,s.$)({id:"nst-message",classList:"nst-message"
})),d="apikey",u=(0,s.nt)("input",{id:"nst-"+d,type:"password",
classList:"nst-input m-2",maxLength:16,required:!0,value:(0,s.O)(d)??""
}),m=(0,s.Z)({id:"nst-login",classList:"torn-btn m-2",innerText:"save"
}),p=(0,s.Z)({id:"nst-reset",classList:"torn-btn m-2",innerText:"reset"})
...
const o=t?.parentElement,i="nst-"+e.toLowerCase(),r=i+"-li",a=(0,s.B)({id:r,
classList:"nst-menu-page",innerText:e})
;o.querySelector("#"+i)||o.querySelector("#"+r)||(t.appendChild(a),
o.appendChild((0,s.M)({id:i,classList:"nst-menu-item hidden"
...
const e=(0,s.M)({id:"nst-menu",classList:"nst-menu"}),n=(0,s.M)({
id:"nst-menu-wrap",classList:"nst-menu-wrap "}),o=(0,s.M)({id:"nst-menu-title",
classList:"nst-menu-title"}),i=(0,s.M)({id:"nst-menu-body",
classList:"nst-menu-body"});o.appendChild((0,s.$)({classList:"nst-logo"
})).appendChild((0,s.nt)("b",{innerText:"NST"}))
;const r=i.appendChild((0,s.nt)("ul",{id:"nst-ul-main",classList:"nst-ul-main"
}))
...
;e.Xt=async t=>{(t=>{const e=t?.closest(".profile-wrapper"),n=(0,r._)({
title:"Stat Spies",element:e}),o=(0,r.M)({id:"nst-compare",
classList:"nst-box-column"}),i=(0,r.M)({id:"nst-spies",
classList:"nst-box-column item-start"});o.appendChild((0,r.nt)("table",{
id:"nst-compare-table",classList:"nst-table"})),i.appendChild((0,r.nt)("table",{
id:"nst-spies-table",classList:"nst-table"})),i.appendChild((0,r.nt)("table",{
...
const e=document.getElementById("nst-compare-table"),n=(0,r.nt)("tr",{
classList:"nst-table-row text-center nst-nodrag"})
;e.appendChild(n),["Stat","Them","You"].forEach((t=>n.appendChild((0,
r.nt)("th",{innerText:t,classList:"nst-table-cell nst-table-cell-head"
})))),Object.keys(t).forEach((n=>{const o=(0,r.nt)("tr",{
...
r.nt)("td",{innerText:""+n,classList:"nst-table-cell text-nsttorntext"
}),l=(0,r.nt)("td",{innerText:""+(0,r.T)(i),
classList:"nst-table-cell text-nsttorntext"}),d=(0,r.nt)("td",{
innerText:""+(0,r.T)(i+s),classList:"nst-table-cell"})
...
get:()=>(0,r.O)("tscompare")??Object.keys(t),set:t=>(0,r.k)({
tscompare:t.toArray()})}});const o=(0,r.nt)("tr",{
classList:"nst-table-row nst-nodrag text-center"}),s=(0,r.nt)("td",{
...
const e=document.getElementById("nst-spies-table"),n=(0,r.nt)("tr",{
...
r.nt)("tr",{classList:"nst-table-row"}),c=(0,r.nt)("td",{innerText:""+n,
classList:"nst-table-cell text-nsttorntext"}),l=(0,r.nt)("td",{
innerText:""+(0,r.T)(o),classList:"nst-table-cell text-nsttorntext"
}),d=(0,r.nt)("td",{innerText:""+(0,r.T)(o+i),classList:"nst-table-cell"})
;d.classList.add(s),
a.appendChild(c),a.appendChild(l),a.appendChild(d),e.appendChild(a)}))
;const o=(0,r.nt)("tr",{classList:"nst-table-row nst-nodrag text-center"}),i=(0,
r.nt)("td",{classList:"nst-table-cell text-nsttorntext",colSpan:3,
...
o.wt)((0,o.U)()-s),m=(0,o.wt)(r-(0,o.U)()),p=(0,o.M)({id:"nst-target-status",
classList:"nst-status-wrap"}),f=(0,o.M)({classList:"nst-status-middle"
}),h=(0,o.M)({classList:"nst-status-middle"}),b=(0,o.M)({id:"nst-status-life",
classList:"nst-status-item",innerText:`life: ${Math.floor(c/a*100)}%`
}),g=(0,o.M)({id:"nst-status-la",classList:"nst-status-item",innerText:"la: "+u
});g.setAttribute("data-time",s);const v=(0,o.M)({id:"nst-status-hosp",
classList:"nst-status-item",innerText:"hosp: "+(""===m?"OUT":m)})
;v.setAttribute("data-time",r);const w=(0,o.M)({id:"nst-status-wall",
classList:"nst-status-item",innerText:"wall: "+(d?"ON":"OFF")}),y=(0,o.M)({
...
;n+=parseInt(a?.market_value)*s}));const s=(0,o.M)({classList:"nst-trade-value",
innerText:"MV: $"+(0,o.T)(n)});t.insertAdjacentElement("beforebegin",s)}},
6185:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0
}),e.Yt=e.G=e.H=e.Qt=e.kt=e.Vt=e.Ft=e.Zt=e.Ut=e.Nt=e.p=e.u=e.h=e._=e.te=e.ee=e.ne=e.oe=e.V=e.j=e.St=e.ie=e.Gt=e.Tt=e.dt=e.ot=e.B=e.Z=e.$=e.M=e.nt=e.re=e.L=e.wt=e.se=e.ae=e.T=e.m=e.Ht=e.k=e.O=e.Wt=e.J=e.U=e.q=e.zt=e.ce=e.le=e.K=e.Y=void 0,
e.qfs=e.qft=e.qis=e.qit=e.mugThres=e.minMugPerc=e.de=e.ue=void 0
;const o=n(3376),i=n(8689)
;e.Y=()=>document.cookie.split("; ").find((t=>t.startsWith("rfc_v"))).split("=")[1],
...
e.J=t=>!t||null==t||0===Object.keys(t).length,e.Wt=t=>{try{return JSON.parse(t)
}catch(t){console.error(t)}return null},e.O=(t="")=>{let e;try{
e=JSON.parse(localStorage.getItem("nstdata"))}catch{e={}}
return""===t?e??{}:e?.[t]},e.k=t=>{const n=(0,e.O)()
;Object.entries(t).forEach((([t,e])=>n[t]=e)),
localStorage.setItem("nstdata",JSON.stringify(n))},e.Ht=t=>{
localStorage.removeItem(t)
},e.m=t=>+(t+"").replace(/[^\d]/g,""),e.T=t=>Math.round(t).toString().replace(/\B(?=(\d{3})+(?!\d))/g,","),
...
},e.L=t=>t.toLowerCase().replace(/ /g,""),e.re=t=>{const e=t.replace(/ /g,"")
;return e.charAt(0).toLowerCase()+e.slice(1)
},e.nt=(t,e)=>Object.assign(document.createElement(t),e),
e.M=t=>(0,e.nt)("div",t),
e.$=t=>(0,e.nt)("span",t),e.Z=t=>(0,e.nt)("button",t),e.B=t=>(0,
e.nt)("li",t),e.ot=t=>(0,
e.nt)("p",t),e.dt=t=>(0,e.nt)("a",t),e.Tt=t=>(0,e.nt)("img",t),
e.Gt=t=>(0,e.nt)("input",t),e.ie=t=>(0,e.nt)("label",t),e.St=t=>{
const{elem:n,title:o,cback:i=()=>{}}=t,r=(0,e.L)(o),s=(0,e.M)({
classList:"nst-box-item"}),a=(0,e.nt)("input",{id:"nst-"+r,type:"text",
classList:"nst-input",value:(0,e.T)(+((0,e.O)(r)??"0")),placeholder:r})
;return a.addEventListener("keyup",(t=>{const n=t.target,o=(0,e.m)(n.value)
;n.value=o.toLocaleString("en-US");const r=(0,e.L)(n.placeholder);(0,e.k)({[r]:o
}),i()})),s.appendChild(a),n.appendChild(s),s},e.j=(t,n,o,i)=>{const r=(0,e.M)({
...
},e.V=(t,n)=>{const o=(0,e.O)("outcome").toString(),i=(0,e.M)({
...
e.L)(i)+"Folded",c=o.classList.toggle("hidden")
;n.querySelector("#nst-arrow").innerHTML=c?s:r,(0,e.k)({[a]:c})};e.te=t=>{
const n=(0,e.M)({classList:"nst-box-header"});return n.appendChild((0,e.$)({
classList:"nst-box-title"})).appendChild((0,e.$)({id:"nst-box-title",innerText:t
})),n.appendChild((0,e.M)({id:"nst-arrow"})),n.addEventListener("click",a),n
},e._=t=>{const{element:n,title:o}=t;if(!n)return
;const i=(0,e.L)(o),a=i+"Folded",c=(0,
e.O)(a)?"nst-box-content hidden":"nst-box-content",l=(0,e.M)({
classList:"nst-box"}),d=(0,e.te)(o)
;d.querySelector("#nst-arrow").innerHTML=(0,e.O)(a)?s:r;const u=(0,e.M)({
classList:c});if(document.querySelector("#nst-"+i))return;const m=(0,e.M)({
...
e.O)("apikey")}&comment=nst`,a=await c("GET",s),l=(0,e.Yt)()?a:a?.response
...
e.O)("tsapikey")??(0,
e.O)("apikey")}${n}`,r=await c("GET",i),s=(0,e.Yt)()?r:r?.response
;return void 0===s?.status||!1===s?.status?(console.error(s?.message,s),{
status:!1}):s},e.Ut=(t={})=>{const n=(0,e.J)(t)?(0,e.O)("userdata"):t;return{
Bt:n?.player_id,Rt:n?.faction?.faction_id}
},e.Zt=t=>t.toString(16),e.Ft=(t={})=>{const n=(0,e.O)("apikey")
;if(16!==n?.length)return!1
;const i=(0,e.J)(t)?(0,e.O)("userdata"):t,{Bt:r,Rt:s}=(0,e.Ut)(i)
;return!(0,e.J)(i)&&!!(0,o.t)((0,e.Zt)(s),(0,e.Zt)(r))},e.Vt=async()=>{
setTimeout(e.Vt,6e4);const t=(0,e.O)();if((0,e.J)(t))return;const n=t?.apikey
...
api:n},a=await(0,e.p)(s);if(!a?.status)return;const{Bt:c,Rt:l}=(0,e.Ut)(a)
;if(void 0===c||void 0===l)return
;const d=a?.merit_perks?.filter((t=>t.includes("mug")))?.join()??0,u=((0,
e.m)(d)/5+20)/400;"player_id"in a&&(0,e.k)({userdata:a}),(0,e.k)({mugperc:u
}),(0,e.Yt)()||(0,i.xt)(o,a)},e.kt=(t="")=>{if(!(0,e.Ft)())return!1
;const n=(0,e.O)("script");if(""===t)return!0;const o=n?.[t]?.enabled;return!!o
},e.Qt=()=>{
...
e.G=t=>Object.keys(t).map((e=>`${e}=${t[e]}`)).join("&"),e.Yt=()=>void 0!==window.flutter_inappwebview,
e.ue=t=>{
...
}catch(t){console.error(t),this._original_send(e)}})},e.de=(t,n)=>{
...
},e.minMugPerc=+(0,e.O)("mugperc"),e.mugThres=(0,
e.m)((0,e.O)("mugthreshold")),e.qit="Quick Items",
e.qis=(0,e.L)(e.qit),e.qft="Quick Faction",e.qfs=(0,e.L)(e.qft)
...
Object.defineProperty(e,"__esModule",{value:!0}),e.me=void 0;const o=n(6185),i={
"Small Arms Cache":20,"Melee Cache":30,"Medium Arms Cache":50,
"Heavy Arms Cache":70,"Armor Cache":60};e.me=async t=>{
...
;s+=n,r+=c*n,a+=n*+i[o]}));const c=`caches: ${s} | BB: ${a} | MV: $`+(0,o.T)(r)
;t.appendChild((0,o.M)({innerText:c}))})(t,r)))}},9607:(t,e)=>{
...
;const t=n(6185),e=n(2268),o=n(9607),i=n(276),r=n(5661),s=n(4051),a=n(3980),c=n(714),l=n(1108),d=n(9149),u=n(7188),m=n(7716),p=n(9355),f=n(2718),h=n(5689),b=n(1379),g=n(8620),v=n(8954),w=n(3424),y=n(763),x=n(3243),k=n(8601),_=n(6215),L=n(3840),O=n(2957),M=n(8292),j=n(263),T=n(291),D=n(4538),I=n(1549),S=n(2470),P=n(1717),E=n(8527),A=n(8990),q=n(8257),$=n(6703),z=n(7673),C=n(7298),N=n(1896),B=n(2585),R=n(3403),U={
home:()=>{
(0,t.kt)("livenetworth")&&(0,o.it)(g.ft,'ul.info-cont-wrap [aria-label^="Networth"]'),
(0,t.kt)("effectivestats")&&(0,o.it)(d.N,".battle")},abro:()=>{
(0,t.kt)("maxbuyabroad")&&(0,o.it)(w.gt,"body")},trav:()=>{}},F={amarket:()=>{
(0,t.kt)("rwbonus")&&(0,o.it)(T.$t,"body")},bazaar:()=>{(0,t.kt)("rwbonus")&&(0,
o.it)(T.$t,"body")},city:()=>{},companies:()=>{},displaycase:()=>{},
faction:()=>{},gym:()=>{
(0,t.kt)("specialgym")&&((0,t.de)(q.et,"getInitialGymInfo"),
(0,t.de)(q.tt,"train"))},index:()=>{},item:()=>{
(0,t.kt)("equipnoconfirm")&&(0,t.ue)(m.F),
(0,t.kt)("rwbonus")&&(0,o.it)(T.$t,"body")},imarket:()=>{
(0,t.kt)("marketnoconfirm")&&(0,t.ue)(v.bt)},loader:()=>{
(0,t.kt)("intercept")&&"attack"===(0,t.le)()&&(0,t.de)(S.lt,"attackData")},
page:()=>{
(0,t.kt)("rrtimeout")&&"russianRoulette"===(0,t.le)()&&(0,t.de)(N.qt,"russianRouletteData")
},pmarket:()=>{},profiles:()=>{},search:()=>{},trade:()=>{},all:()=>{
(0,t.kt)("leftalign")&&(0,
b.ut)(),(0,t.kt)("minilastaction")&&(0,t.de)(P.vt,"UserMiniProfile")},
nopager:()=>{}},H={amarket:()=>{},bazaar:()=>{
(0,t.kt)("bazaarautoprice")&&(0,o.it)(i.l,"body")},city:()=>{
(0,t.kt)()&&(0,o.it)(j.At,"body"),
(0,t.kt)("cityfinds")&&(0,o.it)(r.v,"#map .leaflet-marker-pane")},
companies:()=>{
(0,t.kt)("ezmoneydeposit")&&(0,o.it)(p.W,"body"),(0,t.kt)("employeela")&&(0,
o.it)(u.R,".manage-company"),
(0,t.kt)("companyrestock")&&/stock/.test((0,t.q)())&&(0,o.it)(s.D,"body")},
displaycase:()=>{
(0,t.kt)("displaycaseitemid")&&(0,o.it)(c.P,"ul.dc-list"),(0,t.kt)("rwbonus")&&(0,
o.it)(T.$t,"ul.display-cabinet")},factions:()=>{
(0,t.kt)("ezmoneydeposit")&&(0,o.it)(p.W,"body"),
(0,t.kt)(t.qfs)&&(0,o.it)(f.jt,"#faction-armoury")},gym:()=>{
(0,t.kt)("")&&(0,o.it)($.rt,'#gymroot ul[class*="properties"] [class*="strength"]')
},index:()=>{U[(0,t.Qt)()]()},item:()=>{
(0,t.kt)("removeuglyimage")&&(0,o.it)(M.Et,'[class^="itemPreviewWrapper"]',!0),
(0,
t.kt)("easyloadoutequip")&&(0,o.it)(l.C,'ul[class^="slots"]'),(0,t.kt)(t.qis)&&(0,
o.it)(_.Dt,"div.items-wrap")},imarket:()=>{
(0,t.kt)("marketnoconfirm")&&(0,o.it)(v.ht,"body")},jailview:()=>{
(0,t.kt)("quickjail")&&(0,o.it)(L.It,"ul.users-list")},loader:()=>{
(0,t.kt)("missionhelper")&&"missions"===(0,
t.le)()&&(0,o.it)(y.yt,".giver-cont-wrap"),
(0,t.kt)("fighterino")&&"attack"===(0,
t.le)()&&(0,o.it)(I.X,'div[class^="playersModelWrap"]'),
(0,t.kt)("targetstatus")&&"attack"===(0,
t.le)()&&(0,o.it)(A.Kt,'[class^="playerWindow"] [class*="defender"]')},
page:()=>{
(0,t.kt)("pokername")&&"holdem"===(0,t.le)()&&(0,o.it)(z.Ot,"div[class^=players]")
},pmarket:()=>{
(0,t.kt)("pointsnoconfirm")&&(0,o.it)(k.Lt,".users-point-sell"),(0,
t.kt)("pointsmuglight")&&(0,o.it)(x._t,".users-point-sell")},profiles:()=>{
(0,t.kt)("idtoname")&&(0,
o.it)(h.ct,".user-info-value"),(0,t.kt)("hidemedals")&&(0,
o.it)(R.st,".medals-wrapper"),
(0,t.kt)("statspies")&&(0,o.it)(E.Xt,".user-info-value")},properties:()=>{
(0,t.kt)("ezmoneydeposit")&&(0,o.it)(p.W,"body")},shops:()=>{
(0,t.kt)("cshopmaxbuy")&&(0,o.it)(a.I,"body")},trade:()=>{
(0,t.kt)("tradevalue")&&(0,
o.it)(D.Jt,"#trade-container .trade-cont"),(0,t.kt)("quickghost")&&(0,
o.it)(B.Mt,"#trade-container .trade-cont .user.left")},war:()=>{
(0,t.kt)("warvalue")&&"rankreport"===(0,
t.ce)()&&(0,o.it)(C.me,'li[class^="members-bonus-row"]')},all:()=>{
(0,t.kt)("refillreminder")&&(0,o.it)(O.Pt,'[class*="bar"][class*="energy"]')},
nopager:()=>{}},G={loading:async()=>{
(0,o.it)(e.Ct,"#sidebar"),(0,t.Ft)()&&(document.onreadystatechange=()=>G[document.readyState](),
