...
(function () {
	...
	function q(t={}){return O("input",t)}function A(t={}){return O("label",t)}
	function z(t={}){return O("li",t)}function N(t={}){return O("p",t)}
	function H(t={}){return O("span",t)}function C(t){var n
	...
	}),l=f(s)??"",u=q({id:"nst-"+a,type:"text",classList:"nst-input",value:l,
	...
	classList:"nst-box-item"}),d=q({id:"nst-"+s,type:"number",classList:"nst-input",
	...
	classList:"nst-box-item"}),s=!!f(i),c=q({...t,type:"checkbox",checked:s,
	onchange:t=>{const n=t.target,e=r(null==n?void 0:n.id);!!f(e)!==n.checked&&(p({
	[e]:n.checked}),o&&o(t));}}),l=A({innerText:n,htmlFor:null==t?void 0:t.id,title:e
	...
	classList:"nst-box-item"}),r=q({id:t,type:"radio",name:n,value:t,checked:o===e
	}),a=A({innerText:e,htmlFor:t,classList:""})
	...
	onclick:C}),e=H({classList:"nst-box-title"});return e.appendChild(H({
	id:"nst-box-title",innerText:t})),n.appendChild(e),n.appendChild(j({
	id:"nst-arrow"})),n}(e);l.querySelector("#nst-arrow").innerHTML=a?I:T
	...
	hidemedals:".medals-wrapper",hideprofilelogs:'div[class*="logList"]',
	idtoname:".user-info-value",
	...
	if(ut())"GET"===t?PDA_httpGet(n).then(t=>r(i(t.responseText))).catch(l):PDA_httpPost(n,o,e).then(t=>r(i(t.responseText))).catch(l);else if(a)fetch(n,c).then(async t=>{
	...
	onerror:l};GM.xmlHttpRequest(t);}})}async function kt(){var t,n
	;setTimeout(kt,6e4);const e=f();if(d(e))return;const o=null==e?void 0:e.apikey
	...
	;W(t,parseInt((null==(e=null==(n=null==i?void 0:i.innerText)?void 0:n.match(/x(\d+)/))?void 0:e[1])??"1",10).toString());
	}(n);});}const It=[{key:"bazaarautoprice",name:"bazaar auto price",
	...
	run:()=>nt(Tt,Q.bazaarautoprice)}];async function Mt(){var t,n
	...
	run:()=>nt(Mt,Q.bazaarvalue)}];function Ot(t){
	...
	document.addEventListener("dblclick",jt);}const qt=[{key:"companyrestock",
	...
	;function At(t){var e;const o=t.target
	...
	document.addEventListener("dblclick",At);}const Nt=[{key:"cshopmaxbuy",
	...
	run:()=>nt(zt,Q.cshopmaxbuy)}];function Ht(t){const n=t.getAttribute("itemid")
	;if(!n)return;const e=t.querySelector(".name .desc")
	;e&&!e.querySelector(".text-nstmain")&&e.insertAdjacentElement("afterbegin",H({
	classList:"text-nstmain",innerText:"ID: "+n}));}function Ct(t){if(function(t){
	return !!t&&/manage/.test(mt())}(t))for(const n of Array.from(t.children))Ht(n);}
	...
	run:()=>nt(Ct,Q.displaycaseitemid)}];let Rt
	;const{easyoutcome:Bt,easytemp:Ut,easyweapon:Gt}=f(),Wt={primary:Q.primary,
	secondary:Q.secondary,melee:Q.melee,temp:Q.temp
	},Xt=new MutationObserver(()=>Vt());function Jt(){
	nt(Zt,'div[class^="playerArea"] [class^="playerWindow"] [class*="defender"]');}
	const Kt=[],Yt=Node.prototype.removeChild;function Qt(t=document){
	...
	function Vt(t=document){const n=Qt(t);n&&function(t){if(!t)return
	...
	r.style.left="15px",t.addEventListener("click",()=>{r.remove();}),Kt.push(t);}(n);}
	function Zt(t){Vt(t),Xt.disconnect(),Xt.observe(t.parentNode,{attributes:true,
	childList:true,subtree:true});}function tn(t){const n=async()=>{
	...
	var n;const e=await new Promise(t=>{const n=Qt();if(n)return t(n)
	;const e=new MutationObserver(()=>{const n=Qt();n&&(t(n),e.disconnect());})
	...
	}(t)),t}function nn(){Jt(),window.addEventListener("resize",()=>{
	clearTimeout(Rt),Rt=setTimeout(Jt,250);});}Node.prototype.removeChild=function(t){
	if(-1!==Kt.indexOf(t))return t;try{return Yt.call(this,t)}catch(n){
	return console.error("Failed to deposit ghost money:",n),t}};const en=[],on=[]
	;function rn(t){var n
	;return null==(n=null==t?void 0:t.match(RegExp("(?<=step=|sid=)(\\w+)","g")))?void 0:n[0]
	}function an(t,n){const e=ut()?window:unsafeWindow;if(!e.fetch.i){
	...
	t.addEventListener("click",cn);});}const un=[{key:"easyloadoutequip",
	...
	run:()=>nt(ln,Q.easyloadoutequip)}];function dn(t){if(!t)return
	...
	classList:"nst-box-header"});return o.appendChild(H({classList:"nst-box-title"
	})).appendChild(H({id:"nst-box-title",innerText:"Effective Stats"
	})),n.appendChild(o),Object.keys(t).forEach(o=>{const i=z({tabIndex:0,
	ariaLabel:`${o} ${e(t[o])}`}),r=H({classList:"divider",
	innerHTML:`<span>${o}</span>`}),a=H({classList:"desc",innerText:` ${e(t[o])} `,
	style:"margin-left: 3px"});i.appendChild(r),i.appendChild(a),n.appendChild(i);}),
	n}(i)),o.lastElementChild&&o.lastElementChild.classList.add("last");}const fn=[{
	...
	run:()=>nt(dn,Q.effectivebs),condition:()=>"home"===yt()}];function pn(t,n){
	...
	async function mn(t){if(!t)return;const n=await xt({section:"company",
	select:"employees"});if(!(null==n?void 0:n.status))return
	;const e=null==n?void 0:n.company_employees;pn(t,e),function(t,n){
	new MutationObserver(t=>{t.forEach(t=>{Array.from(t.addedNodes).forEach(t=>{
	t instanceof HTMLElement&&pn(t,n);});});}).observe(t,{childList:true,subtree:true});
	}(t,e);}const hn=[{key:"employeela",name:"employee last action",
	description:"highlight employee with last action before one or two days",
	onpage:V.Company,category:Z.Company,enabled:false,readyStates:["interactive"],
	run:()=>nt(mn,Q.employeela)}];function vn(t){
	const n=lt(t),{step:e,action:o,confirm:i,item_id:r}=n,a=f(w)
	;return (null==a?void 0:a[r])&&"isEquipped"in a[r]&&(a[r].isEquipped=false,p({[w]:a
	})),function(t){return Object.entries(t).map(([t,n])=>`${t}=${n}`).join("&")
	}("actionForm"!==e||"equip"!==o||"1"===i?n:{...n,confirm:"1"})}const gn=[{
	...
	return t=vn,n=Q.equipnoconfirm,
	...
	;for(const{handler:e,stepId:o}of on)if(t&&"string"==typeof t){
	...
	},XMLHttpRequest.prototype.l=true,on.push({handler:t,stepId:n})));var t,n;}
	}],bn=Q.depositDollaSel,yn=Q.depositMutSelector,wn=Q.depsoitHandlerSelector,kn=Q.depositArmorySelector,xn=new WeakSet
	;function Ln(t){if(xn.has(t))return;xn.add(t);let n=0
	;t.addEventListener("click",()=>{if(1!==n++)return;n=0
	;const t=document.querySelector(wn);t&&t.click()
	;const e=document.querySelector(kn);e&&e.click();});}function Sn(t){
	const n=document.querySelector(bn);n&&Ln(n),function(t){
	new MutationObserver(t=>{t.forEach(t=>{Array.from(t.addedNodes).forEach(t=>{
	var n;if(t instanceof Element)if(t.matches&&t.matches(yn))Ln(t);else {
	const e=null==(n=t.querySelector)?void 0:n.call(t,yn);e&&Ln(e);}});});
	}).observe(t,{childList:true,subtree:true});}(t);}const _n=[{key:"ezdepositcompany",
	name:"fast deposit",
	description:"deposit money with a double click (double-click on dollar sign)",
	onpage:V.Company,category:Z.Company,enabled:false,readyStates:["interactive"],
	run:()=>nt(Sn,Q.ezmoneydeposit)},{key:"ezdepositfaction",name:"fast deposit",
	description:"deposit money with a double click (double-click on dollar sign)",
	onpage:V.Faction,category:Z.Faction,enabled:false,readyStates:["interactive"],
	run:()=>nt(Sn,Q.ezmoneydeposit)},{key:"ezdepositproperty",name:"fast deposit",
	description:"deposit money with a double click (double-click on dollar sign)",
	onpage:V.Properties,category:Z.Properties,enabled:false,
	readyStates:["interactive"],run:()=>nt(Sn,Q.ezmoneydeposit)
	}],{reloadone:Tn,reloadtwo:In,weapon:Mn}=f(),Dn=ft("user2ID")??"",On={primary:1,
	secondary:2,melee:3,temp:5};let En={},Pn={},jn=false,$n=0;const qn={check:()=>{
	var t
	;return "error"in Pn?Pn.error:"startButtonTimer"in Pn?`attack in ${+(null==(t=null==Pn?void 0:Pn.startButtonTimer)?void 0:t.timeLeft)}s`:"checking"
	},start:()=>"start fight",finish:()=>"executing",end:()=>{var t,n
	;return (null==(t=null==Pn?void 0:Pn.endResult)?void 0:t.info)??(null==(n=null==Pn?void 0:Pn.endResult)?void 0:n.groupEvent)??""
	},hit:()=>{var t,n
	;const e=+(null==(t=null==Pn?void 0:Pn.defenderUser)?void 0:t.life),o=+(null==(n=null==Pn?void 0:Pn.defenderUser)?void 0:n.maxlife)
	;return `${e} / ${o} (${Math.floor(e/o*100)}%)`},hold:()=>""},An={hold:()=>({}),
	end:()=>({user2ID:Dn}),finish:()=>{var t;return {step:"finish",
	fightResult:null==(t=f())?void 0:t.outcome}},check:()=>({user2ID:Dn}),
	start:()=>({step:"startFight",user2ID:Dn}),hit:()=>({step:"attack",user2ID:Dn,
	user1EquipedItemID:Hn()})};function zn(t){p({outcome:t.target.id});}
	function Nn(){var t
	;const n=null==(t=null==Pn?void 0:Pn.defenderUser)?void 0:t.life,e=null==En?void 0:En.currentAttackStatus,o=null==Pn?void 0:Pn.attackStatus,{hold:i}=f()
	;return i&&n<2?"hold":"end"===o&&"endResult"in Pn?"end":n<2&&"finishOptions"in Pn?"finish":"error"in Pn||"startButtonTimer"in Pn?"check":jn||"notStarted"!==o?jn||"process"===e?"hit":"check":"start"
	}function Hn(){var t,n,e,o,i,r,a,s,c,l,u,d,p,m
	;const h=null==Pn?void 0:Pn.attackerAmmoStatus,v=null==(t=null==Pn?void 0:Pn.currentClips)?void 0:t[0],g=null==(i=null==(o=null==(e=null==(n=null==Pn?void 0:Pn.attackerItems)?void 0:n[1])?void 0:e.item)?void 0:o[0])?void 0:i.currentBonuses,b=null==(c=null==(s=null==(a=null==(r=null==Pn?void 0:Pn.attackerItems)?void 0:r[2])?void 0:a.item)?void 0:s[0])?void 0:c.currentBonuses,y=null==Pn?void 0:Pn.currentMove,{assaperk:w,executeperk:k}=f(),x={
	primary:()=>{var t,n,e,o,i
	;const r=null!=(null==(o=null==(e=null==(n=null==(t=null==Pn?void 0:Pn.attackerItems)?void 0:t[1])?void 0:n.item)?void 0:e[0])?void 0:o.ID),a=0!==+(null==v?void 0:v.attackerPrimaryRoundsLeft),s=!(null==(i=null==h?void 0:h[1])?void 0:i.includes("No ammo"))
	;return r&&s&&(a||Tn)},secondary:()=>{var t,n,e,o,i
	;const r=null!=(null==(o=null==(e=null==(n=null==(t=null==Pn?void 0:Pn.attackerItems)?void 0:t[2])?void 0:n.item)?void 0:e[0])?void 0:o.ID),a=0!==+(null==v?void 0:v.attackerSecondaryRoundsLeft),s=!(null==(i=null==h?void 0:h[2])?void 0:i.includes("No ammo"))
	;return r&&s&&(a||In)},melee:()=>{var t,n,e,o
	;return null!=(null==(o=null==(e=null==(n=null==(t=null==Pn?void 0:Pn.attackerItems)?void 0:t[3])?void 0:n.item)?void 0:e[0])?void 0:o.ID)
	}};if(0===y&&w){
	...
	const t=b[75].value
	;if(+(null==(p=null==Pn?void 0:Pn.defenderUser)?void 0:p.life)/+(null==(m=null==Pn?void 0:Pn.defenderUser)?void 0:m.maxlife)*100<=t)return 2
	}if(function(){var t,n,e,o,i,r,a,s
	;const c=null==(o=null==(e=null==(n=null==(t=null==Pn?void 0:Pn.attackerItems)?void 0:t[5])?void 0:n.item)?void 0:e[0])?void 0:o.ID
	;if(!c)return  false;const{temp:l}=f();if(!l)return  false
	;const u=null==(s=null==(a=null==(r=null==(i=null==Pn?void 0:Pn.defenderItems)?void 0:i[6])?void 0:r.item)?void 0:a[0])?void 0:s.ID
	;return !u||!("256"===c&&["670","1355","348"].includes(u)||"392"===c&&["348","642","644","655","670","675","680","1355"].includes(u))
	}())return 5;do{const t=Object.keys(Mn).find(t=>+Mn[t]===$n)
	...
	airstrip:.7,private:.5,business:.3},Gn={},Wn={},Xn={},Jn=Object.keys(Un)
	;function Kn(t){const n=Xn[t];if(n&&document.body.contains(n))return n
	;const e=document.querySelector(t);return Xn[t]=e,e}
	function Yn(t,e="standard",o=false){if(d(t))return new Date
	;const i=new Date(t.timestamp).getTime(),r=t.country,a=(Bn[r]??0)*(Un[e]??1)*6e4,s=o?1e3*n(t.variance):0
	;return new Date(i+a+s)}function Qn(t,n="standard",e=false){const o=Yn(t,n,e)
	...
	}function Vn(t,n,e){const o=Kn("#profile-mini-root span.sub-desc")
	;if(!o)return clearInterval(Gn[e]),void delete Gn[e]
	...
	;null==(i=o.parentNode)||i.replaceChild(r,o),Vn(t,"standard"===n?"business":"standard",e);
	},{once:true}));const i=Date.now(),r=Wn[t];if(!r)return
	;const a=Yn(r,n,false),s=Yn(r,n,true),c=(+a-i)/1e3;let l;var u
	;l=c<=0?"Landing in "+((u=(+s-i)/1e3)<60?Math.max(0,Math.floor(u))+" sec":Math.floor(u/60)+" min"):"Landing after "+Qn(r,n),
	...
	async function Zn(t){const n=await t.clone().json()
	;return Gn.miniProfile&&clearInterval(Gn.miniProfile),async function(t,n){
	var e,o
	;const i=null==(e=t.user)?void 0:e.userID,r=null==(o=t.userStatus)?void 0:o.status,{type:a,flightType:s}=r||{}
	;if(!a||!a.startsWith("traveling"))return;const c=Jn.includes(s)?s:"business"
	;requestAnimationFrame(()=>{
	const t=Kn("#profile-mini-root span.sub-desc"),n=`(${c||"standard/business"})`
	;t&&t.innerText!==n&&(t.innerText=n);});const l=await St({playerID:i,
	selection:"fly"});Wn[i]={timestamp:l.timestamp??Date.now(),
	country:(l.country??"Unknown")+"",...l
	},Gn[n]&&(clearInterval(Gn[n]),delete Gn[n]),Vn(i,c,n),Gn[n]=setInterval(()=>{
	Vn(i,c,n);const t=Wn[i];if(t){const e=Yn(t,c,false)
	;Date.now()>+e&&(clearInterval(Gn[n]),delete Gn[n]);}},1e3)
	;const u=Kn("div.profile-container > svg");if(u){
	u.setAttribute("style","top: 14px");const t=u.nextElementSibling;if(t){
	const n=Jn.map(t=>`${t}${t===c?" (current)":""}: ${Qn(Wn[i],t)}`).join("\n")
	;t.setAttribute("title",n);}}}(n,"miniProfile"),t}const te=[{key:"flighttimer",
	name:"flight timer",
	...
	run:()=>an(Zn,"UserMiniProfile")}],ne={},ee={balboas:{
	...
	req:["dexterity"],desc:["elites (dex)"]}};function oe(t){
	const n=null==t?void 0:t.target,e=r(n.id).replace(/-sel/g,"");p({[e]:n.value
	}),ie();}function ie(){["one","two"].forEach(t=>{
	const n=document.getElementById(`nst-spgym-${t}-sel`),o=document.getElementById(`nst-spgym-${t}-msg`)
	;if(!n||!o)return
	;const i=n.value,r=ee[i].req,{mainStat:a,secStat:s}=function(t){const n={},e={}
	;for(const o in ne)t.includes(o)?n[o]=ne[o]:e[o]=ne[o];return {mainStat:n,
	secStat:e}
	...
	}(c,l)),d=Object.keys(a).length>1?Object.keys(c>=1.25*l?s:a).join(" and "):(c>=1.25*l?Object.keys(s).filter(t=>ne[t]===l):Object.keys(a)).join(""),f=c>=1.25*l?"no more than":""
	;o.innerText=`Gain ${f} ${u} ${d}`;});}function re(t){!function(t){const n=G({
	...
	onchange:n}),r=null==(e=f("spgym"+t))?void 0:e.toString()
	;return Object.entries(ee).forEach(([t,n])=>{const e=O("option",{value:t,
	innerText:n.desc.join()});e.selected=r===t,i.appendChild(e);}),i}(t,oe),i=N({
	id:`nst-spgym-${t}-msg`,classList:"nst-spgym-msg"})
	;e.appendChild(o),e.appendChild(i),n.appendChild(e);});}(t);}async function ae(t){
	var e;const o=await t.clone().json()
	;if(o&&"object"==typeof o)if("stats"in o&&"object"==typeof o.stats)for(const[i,r]of Object.entries(o.stats))ne[i]=n(null==r?void 0:r.value);else "stat"in o&&(null==(e=o.stat)?void 0:e.name)&&(ne[o.stat.name]=n(o.stat.newValue))
	;return ie(),t}const se=[{key:"gymspecial",name:"special gym",
	description:"show needed stats for special gyms",onpage:V.Gym,category:Z.Gym,
	enabled:false,readyStates:["loading"],run:()=>{
	nt(re,Q.specialgym),an(ae,"getInitialGymInfo"),an(ae,"train");}}]
	;function ce(t,e){return t.reduce((t,o)=>{if(e.test(o)){const e=o.match(/\d+/)
	;return t+(e?n(e[0]):0)}return t},0)}function le(t){
	...
	const r=(e.faction_perks??[]).filter(n=>n.includes(t+" gym gains")),a=(o??[]).filter(n=>n.includes(t+" gym gains")),s=ce(r,/\d+/),c=ce(i,/\d+/),l=ce(a,/\d+/),u=j({
	...
	});}const ue=[{key:"gymsteadfast",name:"gym steadfast",
	description:"show steadfast and bonus gains",onpage:V.Gym,category:Z.Gym,
	enabled:false,readyStates:["interactive"],run:()=>nt(le,Q.gymsteadfast)}],de=[{
	...
	}()}];function fe(t){null==t||t.classList.add("nst-hide-medal");}const pe=[{
	...
	run:()=>nt(fe,Q.hidemedals)}],me=[{key:"hidewargraph",name:"hide war graph",
	...
	document.documentElement.classList.add("nst-left-align");}}];function be(t){
	...
	classList:"last nst-live-networth",tabIndex:0,ariaLabel:"Live NW: "+e(s)}),m=H({
	classList:"divider",innerHTML:"<span>Live Networth</span>"}),h=H({
	...
	r.appendChild(p);}const ye=[{key:"livenetworth",name:"live networth",
	description:"display live changes on newtworth",onpage:V.Home,category:Z.Home,
	enabled:false,readyStates:["interactive"],run:()=>nt(be,Q.livenetworth),
	condition:()=>"home"===yt()}];function we(){
	...
	const ke=[{key:"maxbuyabroad",name:"max buy abroad",
	...
	run:()=>nt(we,Q.maxbuyabroad),condition:()=>"abro"===yt()}]
	;async function xe(t){
	...
	;o&&(o.innerText=e),(null==o?void 0:o.innerText)!==e&&t.appendChild(H({
	id:"nst-lastaction",innerText:e}));}(t,n),Q.minilastaction),t}const Le=[{
	...
	enabled:false,readyStates:["loading"],run:()=>an(xe,"UserMiniProfile")
	}],Se=function(){const t={};for(const[n,e]of Object.entries({
	...
	}))t[_e(n)]=e;return t}();function _e(t){
	return t.toLowerCase().replace(/[ -]/g,"_").replace(/[:!,]/g,"")}function Te(t){
	var n;const e=_e(t);return (null==(n=Se[e])?void 0:n.task)??"mission not found"}
	function Ie(t,n){const e=t.querySelector(".max-height-fix");if(!e)return
	;const o=H({innerHTML:"<br/><br/><b>todo:</b> "+n,classList:"text-nstmain"})
	;e.appendChild(o),t.classList.add("nst-edit");}function Me(t){var n,e
	...
	;o&&Ie(i,Te(o));}}const De=[{key:"missionhelper",name:"mission helper",
	description:"tips for missions before accepting",onpage:V.Page,
	category:Z.Mission,enabled:false,readyStates:["interactive"],
	run:()=>nt(Me,Q.missionhelper),condition:()=>"missions"===pt()}],Oe=[{
	...
	text:`You have ${r} new event${1===r?"":"s"}.`});}(t)}];function Ee(t){
	if(!t)return
	...
	;document.querySelectorAll(".users-point-sell > li").forEach(Ee),
	n=t,new MutationObserver(t=>{
	for(const n of t)for(const t of Array.from(n.addedNodes))t instanceof HTMLElement&&("LI"===t.tagName?Ee(t):t.querySelectorAll&&t.querySelectorAll("li").forEach(Ee));
	}).observe(n,{childList:true,subtree:true});}const je=[{key:"pointsmuglight",
	...
	run:()=>nt(Pe,Q.pointsmuglight)}];function $e(t){
	...
	;t.setAttribute("href",e);}function qe(t){
	t.firstElementChild&&$e(t.firstElementChild);}function Ae(t){
	document.querySelectorAll(".users-point-sell > li").forEach(qe),
	new MutationObserver(t=>{
	for(const n of t)for(const t of Array.from(n.addedNodes))t instanceof HTMLElement&&"LI"===t.tagName&&t.firstElementChild&&$e(t.firstElementChild);
	}).observe(t,{childList:true,subtree:true});}const ze=[{key:"pointsnoconfirm",
	name:"points quick buy",description:"remove confirmation in points market",
	onpage:V.Points,category:Z.Points,enabled:false,readyStates:["interactive"],
	run:()=>nt(Ae,Q.pointsnoconfirm)}],Ne=Q.pokerNameSelector;function He(t){var n
	...
	target:"_blank",innerText:e});t.textContent="",t.appendChild(o);}function Ce(t){
	t.querySelectorAll(Ne).forEach(He),new MutationObserver(t=>{var n
	;for(const e of t)for(const t of Array.from(e.addedNodes))t instanceof HTMLElement&&(t.matches(Ne)&&He(t),
	null==(n=t.querySelectorAll)||n.call(t,Ne).forEach(He));}).observe(t,{
	childList:true,subtree:true});}const Fe=[{key:"pokername",name:"poker name link",
	description:"add link to poker player name",onpage:V.Page,category:Z.Casino,
	enabled:false,readyStates:["interactive"],run:()=>nt(Ce,Q.pokername),
	condition:()=>"holdem"===pt()}];function Re(t,n){var e=Object.keys(t)
	...
	return e}function Be(t){for(var n=1;n<arguments.length;n++){
	var e=null!=arguments[n]?arguments[n]:{}
	;n%2?Re(Object(e),true).forEach(function(n){Ge(t,n,e[n]);
	}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(e)):Re(Object(e)).forEach(function(n){
	...
	})(t)}function Ge(t,n,e){return n in t?Object.defineProperty(t,n,{value:e,
	enumerable:true,configurable:true,writable:true}):t[n]=e,t}function We(){
	return We=Object.assign||function(t){for(var n=1;n<arguments.length;n++){
	var e=arguments[n];for(var o in e)({}).hasOwnProperty.call(e,o)&&(t[o]=e[o]);}
	return t},We.apply(this,arguments)}function Xe(t){
	if("undefined"!=typeof window&&window.navigator)return !!navigator.userAgent.match(t)
	}
	var Je=Xe(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),Ke=Xe(/Edge/i),Ye=Xe(/firefox/i),Qe=Xe(/safari/i)&&!Xe(/chrome/i)&&!Xe(/android/i),Ve=Xe(/iP(ad|od|hone)/i),Ze=Xe(/chrome/i)&&Xe(/android/i),to={
	capture:false,passive:false};function no(t,n,e){t.addEventListener(n,e,!Je&&to);}
	function eo(t,n,e){t.removeEventListener(n,e,!Je&&to);}function oo(t,n){if(n){
	...
	return  false}}function io(t){
	return t.host&&t!==document&&t.host.nodeType?t.host:t.parentNode}
	function ro(t,n,e,o){if(t){e=e||document;do{
	if(null!=n&&(">"===n[0]?t.parentNode===e&&oo(t,n):oo(t,n))||o&&t===e)return t
	;if(t===e)break}while(t=io(t))}return null}var ao,so=/\s+/g;function co(t,n,e){
	if(t&&n)if(t.classList)t.classList[e?"add":"remove"](n);else {
	var o=(" "+t.className+" ").replace(so," ").replace(" "+n+" "," ")
	;t.className=(o+(e?" "+n:"")).replace(so," ");}}function lo(t,n,e){
	...
	}}function uo(t,n){var e="";if("string"==typeof t)e=t;else do{
	var o=lo(t,"transform");o&&"none"!==o&&(e=o+" "+e);}while(!n&&(t=t.parentNode))
	;var i=window.DOMMatrix||window.WebKitCSSMatrix||window.CSSMatrix||window.MSCSSMatrix
	;return i&&new i(e)}function fo(t,n,e){if(t){
	var o=t.getElementsByTagName(n),i=0,r=o.length;if(e)for(;i<r;i++)e(o[i],i)
	;return o}return []}function po(){
	return document.scrollingElement||document.documentElement}
	function mo(t,n,e,o,i){if(t.getBoundingClientRect||t===window){var r,a,s,c,l,u,d
	;if(t!==window&&t.parentNode&&t!==po()?(a=(r=t.getBoundingClientRect()).top,
	s=r.left,
	...
	!Je))do{
	if(i&&i.getBoundingClientRect&&("none"!==lo(i,"transform")||e&&"static"!==lo(i,"position"))){
	var f=i.getBoundingClientRect()
	;a-=f.top+parseInt(lo(i,"border-top-width")),s-=f.left+parseInt(lo(i,"border-left-width")),
	c=a+r.height,l=s+r.width;break}}while(i=i.parentNode);if(o&&t!==window){
	var p=uo(i||t),m=p&&p.a,h=p&&p.d;p&&(c=(a/=h)+(u/=h),l=(s/=m)+(d/=m));}return {
	top:a,left:s,bottom:c,right:l,width:d,height:u}}}function ho(t,n,e){
	for(var o=wo(t,true),i=mo(t)[n];o;){if(!(i>=mo(o)[e]))return o;if(o===po())break
	;o=wo(o,false);}return  false}function vo(t,n,e,o){
	for(var i=0,r=0,a=t.children;r<a.length;){
	if("none"!==a[r].style.display&&a[r]!==Li.ghost&&(o||a[r]!==Li.dragged)&&ro(a[r],e.draggable,t,false)){
	if(i===n)return a[r];i++;}r++;}return null}function go(t,n){
	for(var e=t.lastElementChild;e&&(e===Li.ghost||"none"===lo(e,"display")||n&&!oo(e,n));)e=e.previousElementSibling
	;return e||null}function bo(t,n){var e=0;if(!t||!t.parentNode)return  -1
	;for(;t=t.previousElementSibling;)"TEMPLATE"===t.nodeName.toUpperCase()||t===Li.clone||n&&!oo(t,n)||e++
	;return e}function yo(t){var n=0,e=0,o=po();if(t)do{var i=uo(t),r=i.a,a=i.d
	;n+=t.scrollLeft*r,e+=t.scrollTop*a;}while(t!==o&&(t=t.parentNode));return [n,e]}
	function wo(t,n){if(!t||!t.getBoundingClientRect)return po();var e=t,o=false;do{
	if(e.clientWidth<e.scrollWidth||e.clientHeight<e.scrollHeight){var i=lo(e)
	...
	if(!e.getBoundingClientRect||e===document.body)return po();if(o||n)return e;o=true;
	}}}while(e=e.parentNode);return po()}function ko(t,n){
	...
	}function xo(t,n){return function(){if(!ao){var e=arguments
	;1===e.length?t.call(this,e[0]):t.apply(this,e),ao=setTimeout(function(){
	ao=void 0;},n);}}}function Lo(t,n,e){t.scrollLeft+=n,t.scrollTop+=e;}
	function So(t){var n=window.Polymer,e=window.jQuery||window.Zepto
	;return n&&n.dom?n.dom(t).cloneNode(true):e?e(t).clone(true)[0]:t.cloneNode(true)}
	function _o(t,n,e){var o={};return Array.from(t.children).forEach(function(i){
	var r,a,s,c;if(ro(i,n.draggable,t,false)&&!i.animated&&i!==e){var l=mo(i)
	...
	var To="Sortable"+(new Date).getTime(),Io=[],Mo={initializeByDefault:true},Do={
	mount:function(t){for(var n in Mo)Mo.hasOwnProperty(n)&&!(n in t)&&(t[n]=Mo[n])
	;Io.forEach(function(n){
	if(n.pluginName===t.pluginName)throw "Sortable: Cannot mount plugin ".concat(t.pluginName," more than once")
	}),Io.push(t);},pluginEvent:function(t,n,e){var o=this
	;this.eventCanceled=false,e.cancel=function(){o.eventCanceled=true;};var i=t+"Global"
	;Io.forEach(function(o){
	n[o.pluginName]&&(n[o.pluginName][i]&&n[o.pluginName][i](Be({sortable:n
	},e)),n.options[o.pluginName]&&n[o.pluginName][t]&&n[o.pluginName][t](Be({
	sortable:n},e)));});},initializePlugins:function(t,n,e,o){
	for(var i in Io.forEach(function(o){var i=o.pluginName
	;if(t.options[i]||o.initializeByDefault){var r=new o(t,n,t.options)
	;r.sortable=t,r.options=t.options,t[i]=r,We(e,r.defaults);}
	}),t.options)if(t.options.hasOwnProperty(i)){
	var r=this.modifyOption(t,i,t.options[i]);void 0!==r&&(t.options[i]=r);}},
	getEventProperties:function(t,n){var e={};return Io.forEach(function(o){
	"function"==typeof o.eventProperties&&We(e,o.eventProperties.call(n[o.pluginName],t));
	}),e},modifyOption:function(t,n,e){var o;return Io.forEach(function(i){
	t[i.pluginName]&&i.optionListeners&&"function"==typeof i.optionListeners[n]&&(o=i.optionListeners[n].call(t[i.pluginName],e));
	}),o}},Oo=["evt"],Eo=function(t,n){
	...
	n.indexOf(e)>=0||{}.propertyIsEnumerable.call(t,e)&&(i[e]=t[e]);}return i}(e,Oo)
	;Do.pluginEvent.bind(Li)(t,n,Be({dragEl:jo,parentEl:$o,ghostEl:qo,rootEl:Ao,
	nextEl:zo,lastDownEl:No,cloneEl:Ho,cloneHidden:Co,dragStarted:Zo,putSortable:Wo,
	activeSortable:Li.active,originalEvent:o,oldIndex:Fo,oldDraggableIndex:Bo,
	newIndex:Ro,newDraggableIndex:Uo,hideGhostForTarget:yi,unhideGhostForTarget:wi,
	cloneNowHidden:function(){Co=true;},cloneNowShown:function(){Co=false;},
	dispatchSortableEvent:function(t){Po({sortable:n,name:t,originalEvent:o});}},i));}
	;function Po(t){!function(t){
	...
	;!window.CustomEvent||Je||Ke?(h=document.createEvent("Event")).initEvent(o,true,true):h=new CustomEvent(o,{
	...
	;var b=Be(Be({},m),Do.getEventProperties(o,n));for(var y in b)h[y]=b[y]
	;e&&e.dispatchEvent(h),v[g]&&v[g].call(n,h);}}(Be({putSortable:Wo,cloneEl:Ho,
	targetEl:jo,rootEl:Ao,oldIndex:Fo,oldDraggableIndex:Bo,newIndex:Ro,
	newDraggableIndex:Uo},t));}
	var jo,$o,qo,Ao,zo,No,Ho,Co,Fo,Ro,Bo,Uo,Go,Wo,Xo,Jo,Ko,Yo,Qo,Vo,Zo,ti,ni,ei,oi,ii=false,ri=false,ai=[],si=false,ci=false,li=[],ui=false,di=[],fi="undefined"!=typeof document,pi=Ve,mi=Ke||Je?"cssFloat":"float",hi=fi&&!Ze&&!Ve&&"draggable"in document.createElement("div"),vi=function(){
	if(fi){if(Je)return  false;var t=document.createElement("x")
	;return t.style.cssText="pointer-events:auto","auto"===t.style.pointerEvents}
	}(),gi=function(t,n){
	var e=lo(t),o=parseInt(e.width)-parseInt(e.paddingLeft)-parseInt(e.paddingRight)-parseInt(e.borderLeftWidth)-parseInt(e.borderRightWidth),i=vo(t,0,n),r=vo(t,1,n),a=i&&lo(i),s=r&&lo(r),c=a&&parseInt(a.marginLeft)+parseInt(a.marginRight)+mo(i).width,l=s&&parseInt(s.marginLeft)+parseInt(s.marginRight)+mo(r).width
	...
	return i&&("block"===a.display||"flex"===a.display||"table"===a.display||"grid"===a.display||c>=o&&"none"===e[mi]||r&&"none"===e[mi]&&c+l>o)?"vertical":"horizontal"
	},bi=function(t){function n(t,e){return function(o,i,r,a){
	...
	var e={},o=t.group;o&&"object"==Ue(o)||(o={name:o
	}),e.name=o.name,e.checkPull=n(o.pull,true),
	e.checkPut=n(o.put),e.revertClone=o.revertClone,t.group=e;},yi=function(){
	!vi&&qo&&lo(qo,"display","none");},wi=function(){!vi&&qo&&lo(qo,"display","");}
	;fi&&!Ze&&document.addEventListener("click",function(t){
	if(ri)return t.preventDefault(),
	t.stopPropagation&&t.stopPropagation(),t.stopImmediatePropagation&&t.stopImmediatePropagation(),
	ri=false,false},true);var ki=function(t){if(jo){t=t.touches?t.touches[0]:t
	;var n=(i=t.clientX,r=t.clientY,ai.some(function(t){
	var n=t[To].options.emptyInsertThreshold;if(n&&!go(t)){
	var e=mo(t),o=i>=e.left-n&&i<=e.right+n,s=r>=e.top-n&&r<=e.bottom+n
	;return o&&s?a=t:void 0}}),a);if(n){var e={}
	;for(var o in t)t.hasOwnProperty(o)&&(e[o]=t[o])
	;e.target=e.rootEl=n,e.preventDefault=void 0,
	e.stopPropagation=void 0,n[To]._onDragOver(e);}}var i,r,a;},xi=function(t){
	jo&&jo.parentNode[To]._isOutsideThisEl(t.target);};function Li(t,n){
	if(!t||!t.nodeType||1!==t.nodeType)throw "Sortable: `el` must be an HTMLElement, not ".concat({}.toString.call(t))
	;this.el=t,this.options=n=We({},n),t[To]=this;var e,o,i={group:null,sort:true,
	...
	return gi(t,this.options)},ghostClass:"sortable-ghost",
	...
	supportPointer:false!==Li.supportPointer&&"PointerEvent"in window&&(!Qe||Ve),
	emptyInsertThreshold:5}
	;for(var r in Do.initializePlugins(this,t,i),i)!(r in n)&&(n[r]=i[r])
	;for(var a in bi(n),
	this)"_"===a.charAt(0)&&"function"==typeof this[a]&&(this[a]=this[a].bind(this))
	;this.nativeDraggable=!n.forceFallback&&hi,
	this.nativeDraggable&&(this.options.touchStartThreshold=1),
	n.supportPointer?no(t,"pointerdown",this._onTapStart):(no(t,"mousedown",this._onTapStart),
	no(t,"touchstart",this._onTapStart)),
	this.nativeDraggable&&(no(t,"dragover",this),
	no(t,"dragenter",this)),ai.push(this.el),
	n.store&&n.store.get&&this.sort(n.store.get(this)||[]),We(this,(o=[],{
	captureAnimationState:function(){
	o=[],this.options.animation&&[].slice.call(this.el.children).forEach(function(t){
	if("none"!==lo(t,"display")&&t!==Li.ghost){o.push({target:t,rect:mo(t)})
	;var n=Be({},o[o.length-1].rect);if(t.thisAnimationDuration){var e=uo(t,true)
	...
	var e=0,o=t.target,a=o.fromRect,s=mo(o),c=o.prevFromRect,l=o.prevToRect,u=t.rect,d=uo(o,true)
	;d&&(s.top-=d.f,
	s.left-=d.e),o.toRect=s,o.thisAnimationDuration&&ko(c,s)&&!ko(a,s)&&(u.top-s.top)/(u.left-s.left)===(a.top-s.top)/(a.left-s.left)&&(e=function(t,n,e,o){
	...
	ko(s,a)||(o.prevFromRect=a,o.prevToRect=s,e||(e=n.options.animation),
	n.animate(o,u,s,e)),
	...
	animate:function(t,n,e,o){if(o){lo(t,"transition",""),lo(t,"transform","")
	;var i=uo(this.el),r=i&&i.a,a=i&&i.d,s=(n.left-e.left)/(r||1),c=(n.top-e.top)/(a||1)
	;t.animatingX=!!s,
	t.animatingY=!!c,lo(t,"transform","translate3d("+s+"px,"+c+"px,0)"),
	this.forRepaintDummy=function(t){return t.offsetWidth
	}(t),lo(t,"transition","transform "+o+"ms"+(this.options.easing?" "+this.options.easing:"")),
	lo(t,"transform","translate3d(0,0,0)"),
	"number"==typeof t.animated&&clearTimeout(t.animated),
	t.animated=setTimeout(function(){
	lo(t,"transition",""),lo(t,"transform",""),t.animated=false,
	t.animatingX=false,t.animatingY=false;},o);}}}));}function Si(t,n,e,o,i,r,a,s){
	var c,l,u=t[To],d=u.options.onMove
	;return !window.CustomEvent||Je||Ke?(c=document.createEvent("Event")).initEvent("move",true,true):c=new CustomEvent("move",{
	bubbles:true,cancelable:true
	}),c.to=n,c.from=t,c.dragged=e,c.draggedRect=o,c.related=i||n,
	c.relatedRect=r||mo(n),c.willInsertAfter=s,c.originalEvent=a,t.dispatchEvent(c),
	d&&(l=d.call(u,c,a)),l}function _i(t){t.draggable=false;}function Ti(){ui=false;}
	function Ii(t){
	for(var n=t.tagName+t.className+t.src+t.href+t.textContent,e=n.length,o=0;e--;)o+=n.charCodeAt(e)
	;return o.toString(36)}function Mi(t){return setTimeout(t,0)}function Di(t){
	return clearTimeout(t)}Li.prototype={constructor:Li,
	_isOutsideThisEl:function(t){this.el.contains(t)||t===this.el||(ti=null);},
	_getDirection:function(t,n){
	return "function"==typeof this.options.direction?this.options.direction.call(this,t,n,jo):this.options.direction
	...
	;if(function(t){di.length=0
	;for(var n=t.getElementsByTagName("input"),e=n.length;e--;){var o=n[e]
	;o.checked&&di.push(o);}
	}(e),!jo&&!(/mousedown|pointerdown/.test(r)&&0!==t.button||o.disabled)&&!c.isContentEditable&&(this.nativeDraggable||!Qe||!s||"SELECT"!==s.tagName.toUpperCase())&&!((s=ro(s,o.draggable,e,false))&&s.animated||No===s)){
	if(Fo=bo(s),Bo=bo(s,o.draggable),"function"==typeof l){
	if(l.call(this,t,s,this))return Po({sortable:n,rootEl:c,name:"filter",
	targetEl:s,toEl:e,fromEl:e}),Eo("filter",n,{evt:t}),void(i&&t.preventDefault())
	}else if(l&&(l=l.split(",").some(function(o){
	if(o=ro(c,o.trim(),e,false))return Po({sortable:n,rootEl:o,name:"filter",
	targetEl:s,fromEl:e,toEl:e}),Eo("filter",n,{evt:t}),true
	})))return void(i&&t.preventDefault())
	;o.handle&&!ro(c,o.handle,e,false)||this._prepareDragStart(t,a,s);}}},
	_prepareDragStart:function(t,n,e){
	var o,i=this,r=i.el,a=i.options,s=r.ownerDocument;if(e&&!jo&&e.parentNode===r){
	var c=mo(e)
	;if(Ao=r,$o=(jo=e).parentNode,zo=jo.nextSibling,No=e,Go=a.group,Li.dragged=jo,
	Xo={target:jo,clientX:(n||t).clientX,clientY:(n||t).clientY
	},Qo=Xo.clientX-c.left,
	Vo=Xo.clientY-c.top,this._lastX=(n||t).clientX,this._lastY=(n||t).clientY,
	jo.style["will-change"]="all",o=function(){Eo("delayEnded",i,{evt:t
	}),Li.eventCanceled?i._onDrop():(i._disableDelayedDragEvents(),
	!Ye&&i.nativeDraggable&&(jo.draggable=true),i._triggerDragStart(t,n),Po({
	sortable:i,name:"choose",originalEvent:t}),co(jo,a.chosenClass,true));
	},a.ignore.split(",").forEach(function(t){fo(jo,t.trim(),_i);
	}),no(s,"dragover",ki),
	no(s,"mousemove",ki),no(s,"touchmove",ki),a.supportPointer?(no(s,"pointerup",i._onDrop),
	!this.nativeDraggable&&no(s,"pointercancel",i._onDrop)):(no(s,"mouseup",i._onDrop),
	no(s,"touchend",i._onDrop),
	no(s,"touchcancel",i._onDrop)),Ye&&this.nativeDraggable&&(this.options.touchStartThreshold=4,
	jo.draggable=true),Eo("delayStart",this,{evt:t
	}),!a.delay||a.delayOnTouchOnly&&!n||this.nativeDraggable&&(Ke||Je))o();else {
	if(Li.eventCanceled)return void this._onDrop()
	;a.supportPointer?(no(s,"pointerup",i._disableDelayedDrag),
	no(s,"pointercancel",i._disableDelayedDrag)):(no(s,"mouseup",i._disableDelayedDrag),
	no(s,"touchend",i._disableDelayedDrag),
	no(s,"touchcancel",i._disableDelayedDrag)),
	no(s,"mousemove",i._delayedDragTouchMoveHandler),
	no(s,"touchmove",i._delayedDragTouchMoveHandler),
	a.supportPointer&&no(s,"pointermove",i._delayedDragTouchMoveHandler),
	...
	jo&&_i(jo),clearTimeout(this._dragStartTimer),this._disableDelayedDragEvents();},
	_disableDelayedDragEvents:function(){var t=this.el.ownerDocument
	;eo(t,"mouseup",this._disableDelayedDrag),
	eo(t,"touchend",this._disableDelayedDrag),
	eo(t,"touchcancel",this._disableDelayedDrag),
	eo(t,"pointerup",this._disableDelayedDrag),
	eo(t,"pointercancel",this._disableDelayedDrag),
	eo(t,"mousemove",this._delayedDragTouchMoveHandler),
	eo(t,"touchmove",this._delayedDragTouchMoveHandler),
	eo(t,"pointermove",this._delayedDragTouchMoveHandler);},
	_triggerDragStart:function(t,n){
	n=n||"touch"==t.pointerType&&t,!this.nativeDraggable||n?this.options.supportPointer?no(document,"pointermove",this._onTouchMove):no(document,n?"touchmove":"mousemove",this._onTouchMove):(no(jo,"dragend",this),
	no(Ao,"dragstart",this._onDragStart));try{document.selection?Mi(function(){
	document.selection.empty();}):window.getSelection().removeAllRanges();}catch(e){}
	},_dragStarted:function(t,n){if(ii=false,Ao&&jo){Eo("dragStarted",this,{evt:n
	}),this.nativeDraggable&&no(document,"dragover",xi);var e=this.options
	;!t&&co(jo,e.dragClass,false),
	co(jo,e.ghostClass,true),Li.active=this,t&&this._appendGhost(),Po({sortable:this,
	name:"start",originalEvent:n});}else this._nulling();},
	_emulateDragOver:function(){if(Jo){
	this._lastX=Jo.clientX,this._lastY=Jo.clientY,yi()
	;for(var t=document.elementFromPoint(Jo.clientX,Jo.clientY),n=t;t&&t.shadowRoot&&(t=t.shadowRoot.elementFromPoint(Jo.clientX,Jo.clientY))!==n;)n=t
	;if(jo.parentNode[To]._isOutsideThisEl(t),n)do{if(n[To]&&n[To]._onDragOver({
	clientX:Jo.clientX,clientY:Jo.clientY,target:t,rootEl:n
	})&&!this.options.dragoverBubble)break;t=n;}while(n=io(n));wi();}},
	_onTouchMove:function(t){if(Xo){
	var n=this.options,e=n.fallbackTolerance,o=n.fallbackOffset,i=t.touches?t.touches[0]:t,r=qo&&uo(qo,true),a=qo&&r&&r.a,s=qo&&r&&r.d,c=pi&&oi&&yo(oi),l=(i.clientX-Xo.clientX+o.x)/(a||1)+(c?c[0]-li[0]:0)/(a||1),u=(i.clientY-Xo.clientY+o.y)/(s||1)+(c?c[1]-li[1]:0)/(s||1)
	;if(!Li.active&&!ii){
	if(e&&Math.max(Math.abs(i.clientX-this._lastX),Math.abs(i.clientY-this._lastY))<e)return
	;this._onDragStart(t,true);}if(qo){r?(r.e+=l-(Ko||0),r.f+=u-(Yo||0)):r={a:1,b:0,
	c:0,d:1,e:l,f:u}
	;var d="matrix(".concat(r.a,",").concat(r.b,",").concat(r.c,",").concat(r.d,",").concat(r.e,",").concat(r.f,")")
	;lo(qo,"webkitTransform",d),
	lo(qo,"mozTransform",d),lo(qo,"msTransform",d),lo(qo,"transform",d),
	Ko=l,Yo=u,Jo=i;}t.cancelable&&t.preventDefault();}},_appendGhost:function(){
	if(!qo){
	var t=this.options.fallbackOnBody?document.body:Ao,n=mo(jo,true,pi,true,t),e=this.options
	;if(pi){
	for(oi=t;"static"===lo(oi,"position")&&"none"===lo(oi,"transform")&&oi!==document;)oi=oi.parentNode
	;oi!==document.body&&oi!==document.documentElement?(oi===document&&(oi=po()),
	n.top+=oi.scrollTop,n.left+=oi.scrollLeft):oi=po(),li=yo(oi);}
	co(qo=jo.cloneNode(true),e.ghostClass,false),
	co(qo,e.fallbackClass,true),co(qo,e.dragClass,true),
	lo(qo,"transition",""),lo(qo,"transform",""),
	lo(qo,"box-sizing","border-box"),lo(qo,"margin",0),
	lo(qo,"top",n.top),lo(qo,"left",n.left),
	lo(qo,"width",n.width),lo(qo,"height",n.height),
	lo(qo,"opacity","0.8"),lo(qo,"position",pi?"absolute":"fixed"),
	lo(qo,"zIndex","100000"),
	lo(qo,"pointerEvents","none"),Li.ghost=qo,t.appendChild(qo),
	lo(qo,"transform-origin",Qo/parseInt(qo.style.width)*100+"% "+Vo/parseInt(qo.style.height)*100+"%");
	}},_onDragStart:function(t,n){var e=this,o=t.dataTransfer,i=e.options
	;Eo("dragStart",this,{evt:t
	}),Li.eventCanceled?this._onDrop():(Eo("setupClone",this),
	Li.eventCanceled||((Ho=So(jo)).removeAttribute("id"),
	Ho.draggable=false,Ho.style["will-change"]="",
	this._hideClone(),co(Ho,this.options.chosenClass,false),
	Li.clone=Ho),e.cloneId=Mi(function(){
	Eo("clone",e),Li.eventCanceled||(e.options.removeCloneOnHide||Ao.insertBefore(Ho,jo),
	e._hideClone(),Po({sortable:e,name:"clone"}));
	}),!n&&co(jo,i.dragClass,true),n?(ri=true,
	e._loopId=setInterval(e._emulateDragOver,50)):(eo(document,"mouseup",e._onDrop),
	eo(document,"touchend",e._onDrop),
	eo(document,"touchcancel",e._onDrop),o&&(o.effectAllowed="move",
	i.setData&&i.setData.call(e,o,jo)),
	no(document,"drop",e),lo(jo,"transform","translateZ(0)")),
	ii=true,e._dragStartId=Mi(e._dragStarted.bind(e,n,t)),
	no(document,"selectstart",e),
	Zo=true,window.getSelection().removeAllRanges(),Qe&&lo(document.body,"user-select","none"));
	},_onDragOver:function(t){
	var n,e,o,i,r=this.el,a=t.target,s=this.options,c=s.group,l=Li.active,u=Go===c,d=s.sort,f=Wo||l,p=this,m=false
	;if(!ui){
	if(void 0!==t.preventDefault&&t.cancelable&&t.preventDefault(),a=ro(a,s.draggable,r,true),
	D("dragOver"),Li.eventCanceled)return m
	;if(jo.contains(t.target)||a.animated&&a.animatingX&&a.animatingY||p._ignoreWhileAnimating===a)return E(false)
	;if(ri=false,
	l&&!s.disabled&&(u?d||(o=$o!==Ao):Wo===this||(this.lastPutMode=Go.checkPull(this,l,jo,t))&&c.checkPut(this,l,jo,t))){
	if(i="vertical"===this._getDirection(t,a),
	n=mo(jo),D("dragOverValid"),Li.eventCanceled)return m
	;if(o)return $o=Ao,O(),this._hideClone(),
	D("revert"),Li.eventCanceled||(zo?Ao.insertBefore(jo,zo):Ao.appendChild(jo)),
	E(true);var h=go(r,s.draggable);if(!h||function(t,n,e){
	var o=mo(go(e.el,e.options.draggable)),i=_o(e.el,e.options,qo)
	...
	}(t,i,this)&&!h.animated){if(h===jo)return E(false)
	;if(h&&r===t.target&&(a=h),a&&(e=mo(a)),false!==Si(Ao,r,jo,n,a,e,t,!!a))return O(),
	h&&h.nextSibling?r.insertBefore(jo,h.nextSibling):r.appendChild(jo),
	$o=r,P(),E(true)}else if(h&&function(t,n,e){
	var o=mo(vo(e.el,0,e.options,true)),i=_o(e.el,e.options,qo)
	;return n?t.clientX<i.left-10||t.clientY<o.top&&t.clientX<o.right:t.clientY<i.top-10||t.clientY<o.bottom&&t.clientX<o.left
	}(t,i,this)){var v=vo(r,0,s,true);if(v===jo)return E(false)
	;if(e=mo(a=v),false!==Si(Ao,r,jo,n,a,e,t,false))return O(),
	r.insertBefore(jo,v),$o=r,P(),E(true)}else if(a.parentNode===r){e=mo(a)
	;var g,b,y,w=jo.parentNode!==r,k=!function(t,n,e){
	...
	}(jo.animated&&jo.toRect||n,a.animated&&a.toRect||e,i),x=i?"top":"left",L=ho(a,"top","top")||ho(jo,"top","top"),S=L?L.scrollTop:void 0
	;if(ti!==a&&(b=e[x],si=false,ci=!k&&s.invertSwap||w),g=function(t,n,e,o,i,r,a,s){
	var c=o?t.clientY:t.clientX,l=o?e.height:e.width,u=o?e.top:e.left,d=o?e.bottom:e.right,f=false
	;if(!a)if(s&&ei<l*i){
	if(!si&&(1===ni?c>u+l*r/2:c<d-l*r/2)&&(si=true),si)f=true;else if(1===ni?c<u+ei:c>d-ei)return -ni
	}else if(c>u+l*(1-i)/2&&c<d-l*(1-i)/2)return function(t){
	return bo(jo)<bo(t)?1:-1}(n)
	;return (f=f||a)&&(c<u+l*r/2||c>d-l*r/2)?c>u+l/2?1:-1:0
	}(t,a,e,i,k?1:s.swapThreshold,null==s.invertedSwapThreshold?s.swapThreshold:s.invertedSwapThreshold,ci,ti===a),
	0!==g){var _=bo(jo);do{_-=g,y=$o.children[_];
	}while(y&&("none"===lo(y,"display")||y===qo))}if(0===g||y===a)return E(false);ti=a,
	ni=g;var T=a.nextElementSibling,I=false,M=Si(Ao,r,jo,n,a,e,t,I=1===g)
	;if(false!==M)return 1!==M&&-1!==M||(I=1===M),
	ui=true,setTimeout(Ti,30),O(),I&&!T?r.appendChild(jo):a.parentNode.insertBefore(jo,I?T:a),
	L&&Lo(L,0,S-L.scrollTop),
	$o=jo.parentNode,void 0===b||ci||(ei=Math.abs(b-mo(a)[x])),P(),E(true)}
	if(r.contains(jo))return E(false)}return  false}function D(s,c){Eo(s,p,Be({evt:t,
	...
	return Si(Ao,r,jo,n,e,mo(e),t,o)},changed:P},c));}function O(){
	...
	p!==f&&(co(jo,Wo?Wo.options.ghostClass:l.options.ghostClass,false),
	co(jo,s.ghostClass,true)),Wo!==p&&p!==Li.active?Wo=p:p===Li.active&&Wo&&(Wo=null),
	f===p&&(p._ignoreWhileAnimating=a),p.animateAll(function(){
	D("dragOverAnimationComplete"),p._ignoreWhileAnimating=null;
	}),p!==f&&(f.animateAll(),
	f._ignoreWhileAnimating=null)),(a===jo&&!jo.animated||a===r&&!a.animated)&&(ti=null),
	s.dragoverBubble||t.rootEl||a===document||(jo.parentNode[To]._isOutsideThisEl(t.target),
	!n&&ki(t)),!s.dragoverBubble&&t.stopPropagation&&t.stopPropagation(),m=true}
	function P(){Ro=bo(jo),Uo=bo(jo,s.draggable),Po({sortable:p,name:"change",
	toEl:r,newIndex:Ro,newDraggableIndex:Uo,originalEvent:t});}},
	_ignoreWhileAnimating:null,_offMoveEvents:function(){
	eo(document,"mousemove",this._onTouchMove),
	eo(document,"touchmove",this._onTouchMove),
	eo(document,"pointermove",this._onTouchMove),
	eo(document,"dragover",ki),eo(document,"mousemove",ki),
	eo(document,"touchmove",ki);},_offUpEvents:function(){var t=this.el.ownerDocument
	;eo(t,"mouseup",this._onDrop),
	eo(t,"touchend",this._onDrop),eo(t,"pointerup",this._onDrop),
	eo(t,"pointercancel",this._onDrop),
	eo(t,"touchcancel",this._onDrop),eo(document,"selectstart",this);},
	_onDrop:function(t){var n=this.el,e=this.options
	;Ro=bo(jo),Uo=bo(jo,e.draggable),Eo("drop",this,{evt:t
	}),$o=jo&&jo.parentNode,Ro=bo(jo),
	Uo=bo(jo,e.draggable),Li.eventCanceled||(ii=false,
	ci=false,si=false,clearInterval(this._loopId),
	clearTimeout(this._dragStartTimer),Di(this.cloneId),
	Di(this._dragStartId),this.nativeDraggable&&(eo(document,"drop",this),
	eo(n,"dragstart",this._onDragStart)),
	this._offMoveEvents(),this._offUpEvents(),Qe&&lo(document.body,"user-select",""),
	lo(jo,"transform",""),
	t&&(Zo&&(t.cancelable&&t.preventDefault(),!e.dropBubble&&t.stopPropagation()),
	qo&&qo.parentNode&&qo.parentNode.removeChild(qo),
	(Ao===$o||Wo&&"clone"!==Wo.lastPutMode)&&Ho&&Ho.parentNode&&Ho.parentNode.removeChild(Ho),
	jo&&(this.nativeDraggable&&eo(jo,"dragend",this),
	_i(jo),jo.style["will-change"]="",
	Zo&&!ii&&co(jo,Wo?Wo.options.ghostClass:this.options.ghostClass,false),
	co(jo,this.options.chosenClass,false),Po({sortable:this,name:"unchoose",toEl:$o,
	newIndex:null,newDraggableIndex:null,originalEvent:t}),Ao!==$o?(Ro>=0&&(Po({
	rootEl:$o,name:"add",toEl:$o,fromEl:Ao,originalEvent:t}),Po({sortable:this,
	name:"remove",toEl:$o,originalEvent:t}),Po({rootEl:$o,name:"sort",toEl:$o,
	fromEl:Ao,originalEvent:t}),Po({sortable:this,name:"sort",toEl:$o,
	originalEvent:t})),Wo&&Wo.save()):Ro!==Fo&&Ro>=0&&(Po({sortable:this,
	name:"update",toEl:$o,originalEvent:t}),Po({sortable:this,name:"sort",toEl:$o,
	originalEvent:t})),Li.active&&(null!=Ro&&-1!==Ro||(Ro=Fo,Uo=Bo),Po({
	sortable:this,name:"end",toEl:$o,originalEvent:t
	}),this.save())))),this._nulling();},_nulling:function(){
	Eo("nulling",this),Ao=jo=$o=qo=zo=Ho=No=Co=Xo=Jo=Zo=Ro=Uo=Fo=Bo=ti=ni=Wo=Go=Li.dragged=Li.ghost=Li.clone=Li.active=null,
	di.forEach(function(t){t.checked=true;}),di.length=Ko=Yo=0;},
	handleEvent:function(t){switch(t.type){case "drop":case "dragend":this._onDrop(t)
	;break;case "dragenter":case "dragover":jo&&(this._onDragOver(t),function(t){
	t.dataTransfer&&(t.dataTransfer.dropEffect="move"),
	t.cancelable&&t.preventDefault();}(t));break;case "selectstart":t.preventDefault();
	}},toArray:function(){
	for(var t,n=[],e=this.el.children,o=0,i=e.length,r=this.options;o<i;o++)ro(t=e[o],r.draggable,this.el,false)&&n.push(t.getAttribute(r.dataIdAttr)||Ii(t))
	;return n},sort:function(t,n){var e={},o=this.el
	;this.toArray().forEach(function(t,n){var i=o.children[n]
	;ro(i,this.options.draggable,o,false)&&(e[t]=i);
	...
	closest:function(t,n){return ro(t,n||this.options.draggable,this.el,false)},
	option:function(t,n){var e=this.options;if(void 0===n)return e[t]
	;var o=Do.modifyOption(this,t,n);e[t]=void 0!==o?o:n,"group"===t&&bi(e);},
	destroy:function(){Eo("destroy",this);var t=this.el
	;t[To]=null,eo(t,"mousedown",this._onTapStart),
	eo(t,"touchstart",this._onTapStart),
	eo(t,"pointerdown",this._onTapStart),this.nativeDraggable&&(eo(t,"dragover",this),
	eo(t,"dragenter",this)),
	[].forEach.call(t.querySelectorAll("[draggable]"),function(t){
	t.removeAttribute("draggable");
	}),this._onDrop(),this._disableDelayedDragEvents(),
	ai.splice(ai.indexOf(this.el),1),this.el=t=null;},_hideClone:function(){if(!Co){
	if(Eo("hideClone",this),Li.eventCanceled)return
	;lo(Ho,"display","none"),this.options.removeCloneOnHide&&Ho.parentNode&&Ho.parentNode.removeChild(Ho),
	Co=true;}},_showClone:function(t){if("clone"===t.lastPutMode){if(Co){
	if(Eo("showClone",this),Li.eventCanceled)return
	;jo.parentNode!=Ao||this.options.group.revertClone?zo?Ao.insertBefore(Ho,zo):Ao.appendChild(Ho):Ao.insertBefore(Ho,jo),
	this.options.group.revertClone&&this.animate(jo,Ho),lo(Ho,"display",""),Co=false;}
	}else this._hideClone();}},fi&&no(document,"touchmove",function(t){
	(Li.active||ii)&&t.cancelable&&t.preventDefault();}),Li.utils={on:no,off:eo,
	css:lo,find:fo,is:function(t,n){return !!ro(t,n,t,false)},extend:function(t,n){
	if(t&&n)for(var e in n)n.hasOwnProperty(e)&&(t[e]=n[e]);return t},throttle:xo,
	closest:ro,toggleClass:co,clone:So,index:bo,nextTick:Mi,cancelNextTick:Di,
	detectDirection:gi,getChild:vo,expando:To},Li.get=function(t){return t[To]
	},Li.mount=function(){
	...
	;t.utils&&(Li.utils=Be(Be({},Li.utils),t.utils)),Do.mount(t);});
	},Li.create=function(t,n){return new Li(t,n)},Li.version="1.15.6"
	;var Oi,Ei,Pi,ji,$i,qi,Ai=[],zi=false;function Ni(){Ai.forEach(function(t){
	clearInterval(t.pid);}),Ai=[];}function Hi(){clearInterval(qi);}
	var Ci=xo(function(t,n,e,o){if(n.scroll){
	var i,r=(t.touches?t.touches[0]:t).clientX,a=(t.touches?t.touches[0]:t).clientY,s=n.scrollSensitivity,c=n.scrollSpeed,l=po(),u=false
	;Ei!==e&&(Ei=e,Ni(),Oi=n.scroll,i=n.scrollFn,true===Oi&&(Oi=wo(e,true)))
	;var d=0,f=Oi;do{
	var p=f,m=mo(p),h=m.top,v=m.bottom,g=m.left,b=m.right,y=m.width,w=m.height,k=void 0,x=void 0,L=p.scrollWidth,S=p.scrollHeight,_=lo(p),T=p.scrollLeft,I=p.scrollTop
	...
	;if(!Ai[d])for(var O=0;O<=d;O++)Ai[O]||(Ai[O]={})
	;Ai[d].vx==M&&Ai[d].vy==D&&Ai[d].el===p||(Ai[d].el=p,
	Ai[d].vx=M,Ai[d].vy=D,clearInterval(Ai[d].pid),
	0==M&&0==D||(u=true,Ai[d].pid=setInterval(function(){
	o&&0===this.layer&&Li.active._onTouchMove($i)
	;var n=Ai[this.layer].vy?Ai[this.layer].vy*c:0,e=Ai[this.layer].vx?Ai[this.layer].vx*c:0
	;"function"==typeof i&&"continue"!==i.call(Li.dragged.parentNode[To],e,n,t,$i,Ai[this.layer].el)||Lo(Ai[this.layer].el,e,n);
	}.bind({layer:d}),24))),d++;}while(n.bubbleScroll&&f!==l&&(f=wo(f,false)));zi=u;}
	},30),Fi=function(t){
	...
	;function Ri(){}function Bi(){}Ri.prototype={startIndex:null,
	...
	;var o=vo(this.sortable.el,this.startIndex,this.options)
	;o?this.sortable.el.insertBefore(n,o):this.sortable.el.appendChild(n),
	this.sortable.animateAll(),e&&e.animateAll();},drop:Fi},We(Ri,{
	pluginName:"revertOnSpill"}),Bi.prototype={onSpill:function(t){
	var n=t.dragEl,e=t.putSortable||this.sortable
	;e.captureAnimationState(),n.parentNode&&n.parentNode.removeChild(n),
	e.animateAll();},drop:Fi},We(Bi,{pluginName:"removeOnSpill"
	}),Li.mount(new function(){function t(){for(var t in this.defaults={scroll:true,
	...
	;this.sortable.nativeDraggable?no(document,"dragover",this._handleAutoScroll):this.options.supportPointer?no(document,"pointermove",this._handleFallbackAutoScroll):n.touches?no(document,"touchmove",this._handleFallbackAutoScroll):no(document,"mousemove",this._handleFallbackAutoScroll);
	},dragOverCompleted:function(t){var n=t.originalEvent
	;this.options.dragOverBubble||n.rootEl||this._handleAutoScroll(n);},
	drop:function(){
	this.sortable.nativeDraggable?eo(document,"dragover",this._handleAutoScroll):(eo(document,"pointermove",this._handleFallbackAutoScroll),
	eo(document,"touchmove",this._handleFallbackAutoScroll),
	eo(document,"mousemove",this._handleFallbackAutoScroll)),
	Hi(),Ni(),clearTimeout(ao),ao=void 0;},nulling:function(){
	$i=Ei=Oi=zi=qi=Pi=ji=null,Ai.length=0;},_handleFallbackAutoScroll:function(t){
	...
	;if($i=t,n||this.options.forceAutoScrollFallback||Ke||Je||Qe){
	Ci(t,this.options,r,n);var a=wo(r,true)
	;!zi||qi&&o===Pi&&i===ji||(qi&&Hi(),qi=setInterval(function(){
	var r=wo(document.elementFromPoint(o,i),true)
	;r!==a&&(a=r,Ni()),Ci(t,e.options,r,n);},10),Pi=o,ji=i);}else {
	if(!this.options.bubbleScroll||wo(r,true)===po())return void Ni()
	;Ci(t,this.options,wo(r,false),false);}}},We(t,{pluginName:"scroll",
	initializeByDefault:true})}),Li.mount(Bi,Ri);const Ui={box:t=>{var n;const e=G({
	title:k,element:t});null==(n=null==e?void 0:e.parentElement)||n.appendChild(j({
	id:"nst-item-resp",classList:"nst-box-row hidden"})),Xi();},item:t=>{
	t.removeEventListener("dblclick",Ji),t.addEventListener("dblclick",t=>{var n
	;(null==(n=t.target)?void 0:n.closest(".name"))&&Ji(t);});},nopager:()=>{}}
	;function Gi(t){var n;t.stopPropagation()
	...
	}(t,n),n.classList.remove("hidden"));}(i[o]);}function Wi(t){var n
	;t.stopPropagation(),t.preventDefault()
	;const e=null==(n=t.target.closest("#nst-quick-use"))?void 0:n.parentElement
	;if(!e)return;const o=e.getAttribute("data-itemID");if(!o)return;const i=f(L)
	;o in i&&(delete i[o],p({[L]:i}),Xi());}function Xi(){
	...
	id:"nst-quick-use",classList:"nst-box-button",onclick:Gi
	}),c="energy"===o?O("i",{classList:"currency-points"}):$({src:r,alt:o,
	classList:"nst-box-img"}),l=H({id:"nst-quick-name",innerText:o}),u=H({
	id:"nst-quick-close",classList:"nst-box-close",innerText:"✕",onclick:Wi})
	;s.append(c,l,u),a.appendChild(s),n.appendChild(a);
	}(t,e)),t.appendChild(e),new Li(t,{animation:150,dataIdAttr:"data-itemid",
	...
	e[t].order!==n&&(e[t].order=n,o=true);}),o&&p({[L]:e});}}});}function Ji(e){var o,i,r
	...
	;d[u]={id:u,order:m+1,name:c},p({[L]:d}),Xi();}function Ki(t){
	...
	;Ui[e?"box":i?"item":"nopager"](t);});});}).observe(t,{childList:true,subtree:true});}
	const Yi=[{key:"quickfaction",name:"faction quick item",
	description:"quickly use items from faction",onpage:V.Faction,
	category:Z.Faction,enabled:false,readyStates:["interactive"],
	run:()=>nt(Ki,Q.quickfaction)}];function Qi(){
	return n((mt().match(/ID=(\d+)/)||["","0"])[1])}async function Vi(){const t=Qi()
	;if(!t)return;const e=await async function(){const t=Qi();if(!t)return 0
	...
	function Zi(t){!function(t){var n
	...
	classList:"torn-btn",onclick:Vi})
	;e.appendChild(o),t.insertAdjacentElement("beforebegin",e);}(t);}const tr=[{
	...
	run:()=>nt(Zi,Q.quickghost)
	}],nr=["Primary","Secondary","Melee","Temporary"],er=["Medical","Drug","Energy Drink","Alcohol","Candy","Booster","Supply Pack",...nr]
	;let or="";async function ir(t,n,e=false){
	const{id:o}=t,i="https://www.torn.com/item.php?rfcv="+dt(),r={step:"useItem",
	itemID:o,item:o,...e?{fac:"1"}:{}},a=await wt("POST",i,r)
	...
	;o&&ir({id:o},t,i);}}(n,a)),r.appendChild(i);}),i.appendChild(N({innerHTML:o
	...
	;s.innerText=`${u}:${d}:${f}`;}(a,n),sr();}async function rr(t){var n
	;t.stopPropagation()
	;const e=null==(n=t.target.closest("#nst-quick-use"))?void 0:n.parentElement
	...
	;s&&(s.innerHTML="",nr.includes(a)?await async function(t,n){var e
	...
	;const s="https://www.torn.com/item.php?rfcv="+dt(),c=await wt("POST",s,r)+""
	;if(n.innerHTML=c,
	...
	"isEquipped"in t&&(t.isEquipped=false);}),l[o].isEquipped=a,p({[w]:l}),sr());
	}(r,s):await ir(r,s));}function ar(t){var n
	;t.stopPropagation(),t.preventDefault()
	;const e=null==(n=t.target.closest("#nst-quick-use"))?void 0:n.parentElement
	;if(!e)return;const o=e.getAttribute("data-itemID");if(!o)return;const i=f(w)
	;(null==i?void 0:i[o])&&(delete i[o],p({[w]:i}),sr());}function sr(){
	const t=document.getElementById("nst-"+y);if(!t)return
	;const n=f(w),e=JSON.stringify(n);if(e===or)return
	;for(or=e;t.lastChild;)t.removeChild(t.lastChild)
	...
	classList:"nst-box-button",onclick:rr}),u={src:s,alt:o,classList:"nst-box-img"
	},d={id:"nst-quick-name",innerText:""+o,classList:a?"text-nstgreen":""},f={
	id:"nst-quick-close",classList:"nst-box-close",innerText:"✕",onclick:ar}
	;l.appendChild($(u)),
	l.appendChild(H(d)),l.appendChild(H(f)),c.appendChild(l),n.appendChild(c);
	}(t,i)),t.appendChild(i),new Li(t,{animation:150,dataIdAttr:"data-itemid",
	store:{get:()=>{const t=f(w)
	;return Object.entries(t).sort((t,n)=>t[1].order-n[1].order).map(t=>t[0])},
	set:t=>{const n=t.toArray(),e=f(w);let o=false;n.forEach((t,n)=>{
	e[t].order!==n&&(e[t].order=n,o=true);}),o&&p({[w]:e});}}});}function cr(n){
	...
	;return a&&c&&er.includes(c)?{id:a,name:d,quantity:s,category:c,strangeID:l,
	...
	order:a+1},p({[w]:r}),sr();}function lr(t){var n
	...
	})),sr(),t.addEventListener("dblclick",cr);}const ur=[{key:"quickitem",
	name:"quick items",description:"quickly use items",onpage:V.Items,
	category:Z.Items,enabled:false,readyStates:["interactive"],
	run:()=>nt(lr,Q.quickitem)}];function dr(){hr(document);}function fr(t){
	return null==t?void 0:t.parentElement}function pr(t,n){
	const{item:e,selector:o,reg:i}=n,r=f("quick"+e)??false,a=fr(t);if(!a)return
	...
	;c!==d&&s.setAttribute("href",d);}function mr(t){
	const o=+(f("jailscore")??"0"),i=fr(t);if(!i)return
	...
	;t.setAttribute("title","score: "+e(l)),i.style.display=u?"none":"",pr(t,{
	item:"bail",selector:"bye",reg:"buy"}),pr(t,{item:"bust",selector:"bust",
	reg:"breakout"});}function hr(t){t.querySelectorAll("span.info-wrap").forEach(mr);
	}function vr(t){!function(t){const n=fr(t);if(!n)return;const e=G({
	...
	cback:()=>hr(t)}),[{title:"Quick Bust",event:dr},{title:"Quick Bail",event:dr
	...
	const e=t.querySelector("span.info-wrap");e&&n.push(e);}});}),n.forEach(mr);
	}).observe(t,{childList:true,subtree:true}),hr(t);}const gr=[{key:"quickjail",
	...
	const n=br[t],e="energy"===t?r:a,i=function(t,n){var e
	...
	}(i.querySelector('p[class^="bar-name"]'),t,e));});}const wr=[{
	...
	run:()=>nt(yr,Q.refillreminder)}];function kr(t){if(!t)return
	;const n=t.parentElement;t.remove(),null==n||n.remove();}const xr=[{
	key:"removeuglyimage",name:"hide new images",
	description:"hide new images from item page",onpage:V.Items,category:Z.Items,
	enabled:false,readyStates:["loading"],run:()=>nt(kr,Q.removeuglyimage,true)}]
	;function Lr(t){const n=t.parentElement
	;t.nodeType===Node.TEXT_NODE&&t.nodeValue&&(!n||!n.isContentEditable)&&(t.nodeValue=t.nodeValue.replaceAll("Natural Selection","NS"));
	}function Sr(t){const n=document.createTreeWalker(t,NodeFilter.SHOW_TEXT,null)
	;let e=n.currentNode;for(;e;)Lr(e),e=n.nextNode();}function _r(t){Sr(t)
	;const n=document.querySelector("#map");n&&function(t){new MutationObserver(t=>{
	for(const n of t)n.addedNodes.forEach(Sr),"attributes"===n.type&&Sr(n.target);
	}).observe(t,{childList:true,subtree:true,attributes:true});}(n);}const Tr=[{
	key:"renameterritory",name:"rename NS territory",
	description:"rename NS territory",onpage:V.City,category:Z.City,enabled:false,
	readyStates:["interactive"],run:()=>nt(_r,Q.renameterritory)}];let Ir={},Mr=null
	;function Dr(){
	...
	;const i=t,r=i.getAttribute("id");if(!r)return;Ir[r]||(Ir[r]=ht())
	;const a=(c=Ir[r],s(900-(ht()-c)));var c
	...
	;const f=`${"$"+e(n(d))}\n${a}`;l.innerText!==f&&(l.innerText=f);}):Ir={};}
	async function Or(t){const n=await t.clone().json()
	;if("lobby"!==(null==n?void 0:n.step))return t;const e=n.data
	;for(const o of Object.values(e)){const{ID:t,timeCreated:n}=o
	;void 0!==t&&(Ir[t]=n);}
	return null!==Mr&&clearInterval(Mr),Mr=setInterval(Dr,1e3),t}const Er=[{
	...
	run:()=>an(Or,"russianRouletteData"),condition:()=>"russianRoulette"===pt()}]
	;function Pr(t){var n,e
	...
	}function jr(t){const n=t.querySelectorAll(".bonus-attachment-icons")
	;if(!n.length)return
	;const e=Array.from(n).map(t=>c(t.title)).join("<br />"),o=t.querySelector("p.t-gray-6")
	;o&&o.innerHTML!==e&&(o.innerHTML=e);}function $r(t){
	for(const n of t)for(const t of Array.from(n.addedNodes))Pr(t)&&jr(t);}
	function qr(t){new MutationObserver($r).observe(t,{childList:true,subtree:true});}
	const Ar=[{key:"rwbonusauction",name:"rw bonus display",
	...
	run:()=>nt(qr,Q.auctionrwbonus)}];function zr(t){
	...
	e&&!e.querySelector("span")&&(e.appendChild(H({innerText:n
	})),e.appendChild(O("br",{})));}function Nr(t){const n=/(itemsContainner|row)/
	;new MutationObserver(t=>{
	...
	;if(e.length)for(const t of Array.from(e))zr(t);}}).observe(t,{childList:true,
	subtree:true});}const Hr=[{key:"rwbonusbazaar",name:"rw bonus display",
	description:"display rw weapon bonus over the item instead of tooltip",
	onpage:V.Bazaar,category:Z.Bazaar,enabled:false,readyStates:["loading"],
	run:()=>nt(Nr,Q.rwbonusbazaar)}];function Cr(t){
	if(t.classList.contains("nst-rw-display"))return;const n=c(t.title)
	;t.classList.add("nst-rw-display"),t.appendChild(H({innerText:n
	})),t.insertAdjacentElement("afterend",O("br",{}));}function Fr(t){
	const n=t.querySelectorAll(".bonus-attachment-icons");n.length&&n.forEach(Cr);}
	const Rr=[{key:"rwbonusdisplay",name:"rw bonus display",
	description:"display rw weapon bonus over the item instead of tooltip",
	onpage:V.DisplayCase,category:Z.DisplayCase,enabled:false,
	readyStates:["interactive"],run:()=>nt(Fr,Q.rwbonusdisplay)}];function Br(t){
	...
	}),i&&(t.title=r.outerHTML);}function Ur(t){t.forEach(t=>{
	Array.from(t.addedNodes).forEach(t=>{
	t instanceof HTMLElement&&t.parentElement&&/armoury-(weapons|armour)/g.test(t.parentElement.id)&&"UL"===t.tagName&&t.classList.contains("item-list")&&t.querySelectorAll("div.name").forEach(Br);
	});});}function Gr(t){new MutationObserver(Ur).observe(t,{childList:true,subtree:true
	});}const Wr=[{key:"rwbonusfaction",name:"rw bonus display",
	description:"display rw weapon bonus over the item instead of tooltip",
	onpage:V.Faction,category:Z.Faction,enabled:false,readyStates:["interactive"],
	run:()=>nt(Gr,Q.rwbonusfaction)}];function Xr(t){var n
	...
	}function Jr(t){const n=t.querySelector(".name-wrap")
	...
	r&&(n.classList.add("nst-rw-show"),n.appendChild(i));}function Kr(t){
	new MutationObserver(t=>{
	for(const n of t)if(Xr(n))for(const t of Array.from(n.addedNodes))t instanceof HTMLElement&&Jr(t);
	}).observe(t,{childList:true,subtree:true});}const Yr=[{key:"rwbonusitems",
	...
	}function ca(t){return document.getElementById(t)||null}function la(t,n,e=5){
	...
	;o.appendChild(i),t.appendChild(o);}function ua(t,n={}){const e=O("tr",n)
	;return t.forEach(t=>e.appendChild(t)),e}function da(t,n="",e={}){
	return O("td",{innerText:t,classList:"nst-table-cell "+n,...e})}
	async function fa(t){var n,o,i;!function(t){const n=G({title:"Stat Spies",
	...
	ta){const t=j({id:"nst-spies-avg",classList:"nst-box-column item-start"})
	;t.appendChild(O("table",{id:"nst-avg-table",classList:"nst-table"
	})),n.appendChild(t);}}(t)
	;const r=ca("nst-compare-table"),a=ca("nst-spies-table")
	;r&&la(r,"Loading...",3),a&&la(a,"Loading...",3);try{const t=await Lt({
	selection:"/spy/user/"+Qr})
	;(null==t?void 0:t.status)?((null==(n=null==t?void 0:t.compare)?void 0:n.status)?function(t){
	const n=ca("nst-compare-table");if(!n)return;n.innerHTML=""
	;const o=document.createDocumentFragment();o.appendChild(ua(ea.map(t=>O("th",{
	innerText:t,classList:ra})),{classList:"nst-table-row text-center nst-nodrag"}))
	;let i=!1;for(const[r,a]of Object.entries(t??{})){if(!a)continue;i=!0
	;const t=+a.amount||0,n=+a.difference||0,s=n>0?"text-nstgreen":n<0?"text-nstred":"text-nsttorntext",c=ua([da(r,"text-nsttorntext"),da(e(t),"text-nsttorntext"),(()=>{
	const o=da(e(t+n));return o.classList.add(s),o})()],{classList:"nst-table-row",
	"data-id":r});o.appendChild(c);}i?(o.appendChild(ua([(()=>{const t=O("td",{
	...
	})),n.appendChild(o),n.rows.length>1&&new Li(n,{animation:150,
	filter:".nst-nodrag",store:{get:()=>f("tscompare")??Object.keys(t),set:t=>p({
	tscompare:t.toArray()})}})):la(n,"No comparison data available.",3);
	}(null==(o=null==t?void 0:t.compare)?void 0:o.data):r&&la(r,"No comparison data available.",3),
	(null==(i=null==t?void 0:t.spy)?void 0:i.status)?function(t){
	const n=ca("nst-spies-table");if(!n)return;n.innerHTML=""
	;const o=document.createDocumentFragment();o.appendChild(ua(ea.map(t=>O("th",{
	innerText:t,classList:ra})),{classList:"nst-table-row text-center"
	})),o.appendChild(ua([O("td",{classList:"nst-table-cell text-nsttorntext",
	colSpan:3,innerText:"Last Update: "+((null==t?void 0:t.difference)??"")})],{
	classList:"nst-table-row nst-nodrag text-center"}));let i=!1;for(const r of ia){
	const n=+(null==t?void 0:t[r.toLowerCase()])||0,a=+(null==t?void 0:t["delta"+r])||0
	;if(!n&&!a)continue;i=!0
	;const s=a>0?"text-nstgreen":a<0?"text-nstred":"text-nsttorntext",c=ua([da(r,"text-nsttorntext"),da(e(n),"text-nsttorntext"),(()=>{
	const t=da(e(n+a));return t.classList.add(s),t})()],{classList:"nst-table-row"})
	;o.appendChild(c);}i?n.appendChild(o):la(n,"No spy data available.",3);
	}(null==t?void 0:t.spy):a&&la(a,"No spy data available.",3)):(r&&la(r,"Failed to load comparison data.",3),
	a&&la(a,"Failed to load spy data.",3));}catch(c){
	r&&la(r,["Error loading comparison data.",c].join("\n"),3),
	a&&la(a,["Error loading spy data.",c].join("\n"),3);}if(!ta)return
	;const s=ca("nst-avg-table");s&&la(s,"Loading...",1+2*na.length);try{
	await Promise.all(na.map(async t=>{const[n,e]=await Promise.all([St({
	playerID:Qr,selection:"personalstats",days:t}),St({playerID:Vr,
	selection:"personalstats",days:t})]);Zr.them[t]=n||{},Zr.you[t]=e||{};
	})),async function(){var t,n;const e=ca("nst-avg-table");if(!e)return
	;e.innerHTML="";const o=document.createDocumentFragment(),i=[O("th",{
	innerText:"Stat",classList:ra}),...na.flatMap(t=>[O("th",{
	innerText:`Them (${t}d)`,classList:ra}),O("th",{innerText:`You (${t}d)`,
	classList:ra})])];o.appendChild(ua(i,{classList:"nst-table-row text-center"}))
	;let r=!1;for(const a of oa){const e=[da(a,"text-nsttorntext")]
	;for(const o of na){
	const i=(null==(t=Zr.them)?void 0:t[o])??{},s=(null==(n=Zr.you)?void 0:n[o])??{},c=+i[a]||0,l=+s[a]||0
	;(c||l)&&(r=!0);const u=aa(a,c),d=aa(a,l),f=sa(c,l)
	;e.push(da(u,"text-nsttorntext"),da(d,f));}o.appendChild(ua(e,{
	classList:"nst-table-row"}));}
	r?e.appendChild(o):la(e,"No average stats available.",1+2*na.length);}();
	}catch(c){s&&la(s,["Error loading average stats.",c].join("\n"),1+2*na.length);}}
	const pa=[{key:"statspies",name:"stat spies",
	description:"add spies and stats on profile page",onpage:V.Profile,
	category:Z.Profile,enabled:false,readyStates:["interactive"],
	run:()=>nt(fa,Q.statspies)},{key:"statspiesavg",name:"stat average",
	...
	}],ma=["life","wall","revive","bs","hosp","la"],ha={},va=ft("user2ID")??"",ga={
	life:"",wall:"",revive:"",bs:"",hosp:"",la:""};let ba;const ya={life:t=>t+"%",
	wall:t=>t?"ON":"OFF",revive:t=>t?"ON":"OFF",bs:()=>"N/A",
	hosp:t=>""===t||0===t?"OUT":s(+t-ht()),la:t=>s(ht()-+t)};function wa(){
	ma.forEach(t=>{const n=ha[t];if(!n)return;const e=ya[t](ga[t])??""
	;n.innerText!==e&&(n.innerText=e);});}async function ka(t){
	if(document.querySelector("#nst-target-status"))return;await async function(){
	var t,n,e,o;try{const i={section:"user",select:"",objID:va},r=await xt(i)
	...
	;ga.life=u,ga.wall=f,ga.revive=d,ga.bs="",ga.hosp=a,ga.la=s;}catch(i){
	...
	classList:"nst-table-row text-center"});ma.forEach(t=>n.appendChild(O("th",{
	innerText:t,classList:"nst-table-cell nst-table-cell-head"}))),t.appendChild(n)
	;const e=O("tr",{classList:"nst-table-row"});return ma.forEach(t=>{
	const n=ya[t](ga[t])??"",o=O("td",{classList:"nst-table-cell text-nsttorntext"
	}),i=j({id:"nst-status-"+t,classList:"nst-status-item",innerText:n})
	;o.appendChild(i),e.appendChild(o),ha[t]=i;}),t.appendChild(e),t
	}()),o.appendChild(i),clearInterval(ba),ba=window.setInterval(wa,1e3);}
	async function xa(t){var n,e,o,i,r
	...
	;return ga.life=s,ga.la=c,t}const La=[{key:"targetstatus",name:"target info",
	...
	an(xa,"attackData"),nt(ka,Q.targetstatus);},condition:()=>"attack"===pt()}]
	;async function Sa(t){var n,o
	...
	;t.insertAdjacentElement("beforebegin",c);}const _a=[{key:"tradevalue",
	...
	run:()=>nt(Sa,Q.tradevalue)}];async function Ta(t){
	...
	href:o,target:"_blank",innerText:n}));}(n,o,r);}),t):t}const Ia=[{
	key:"warintercept",name:"intercept link",
	description:"add links for intercept attacks",onpage:V.Loader,category:Z.Fight,
	enabled:false,readyStates:["interactive"],run:()=>an(Ta,"attackData"),
	condition:()=>"attack"===pt()}],Ma={"Small Arms Cache":20,"Melee Cache":30,
	"Medium Arms Cache":50,"Heavy Arms Cache":70,"Armor Cache":60
	},Da=/^(\d+)x (.+)$/;function Oa(t,n){const e=t.match(Da);if(!e)return null
	;const o=parseInt(e[1],10),i=e[2];if(!Ma[i])return null;const r=n.get(i)
	;return r?{qty:o,name:i,value:parseInt(r.market_value,10)||0,bb:Ma[i]}:null}
	async function Ea(t){const n=null==t?void 0:t.parentElement;if(!n)return
	...
	let e=0,o=0,i=0;for(const r of t){const t=Oa(r,n);t&&(e+=t.qty,o+=t.value*t.qty,
	...
	innerText:r}));}(t,i,a,r);}(t,r));}const Pa=[{key:"warvalue",
	...
	run:()=>nt(Ea,Q.warvalue),condition:()=>{
	return "rankreport"===(null==(t=window.location.search.match(/\?step=(\w+)/))?void 0:t[1])
	;var t;}}],ja={abandon:"text-nstabandon",bury:"text-nstbury",burn:"text-nstburn",
	sink:"text-nstsink",dissolve:"text-nstdissolve"},$a={"biological waste":"sink",
	...
	"broken appliance":"sink",vehicle:"sink"};let qa=location.href,Aa=null
	;function za(t){
	Array.from(t.querySelectorAll(".crime-option-sections")).forEach(t=>{var n
	;const e=(null==(n=t.textContent)?void 0:n.trim().toLowerCase().split("?")[0])||"",o=$a[e],i=ja[o]
	;t.classList.add(i);const r=t.querySelector(`button[class*="${o}"]`)
	;t.addEventListener("click",t=>{t.target.closest("button")||r.click();});});}
	function Na(t){null==t||t.classList.add("nst-hide-profile-logs");}
	const Ha=[...et,...at,...It,...Dt,...Pt,...qt,...Nt,...Ft,...sn,...un,...fn,...hn,...gn,..._n,...Rn,...te,...se,...ue,...de,...pe,...me,...ve,...ge,...ye,...ke,...Le,...De,...Oe,...je,...ze,...Fe,...Yi,...tr,...ur,...gr,...wr,...xr,...Tr,...Er,...Ar,...Hr,...Rr,...Wr,...Yr,...pa,...La,..._a,...Ia,...Pa,{
	key:"disposalhighlight",name:"disposal highlight",
	description:"highlight best method for disposal crime",onpage:V.Page,
	category:Z.Crime,enabled:false,readyStates:["interactive"],run:()=>{
	null===Aa&&(Aa=setInterval(()=>{const t=location.href
	;t!==qa&&(qa=t,/disposal/.test(mt())&&(nt(za,Q.disposalhighlight),
	clearInterval(Aa),Aa=null));},500));},condition:()=>/crimes/.test(pt())},{
	key:"hideprofilelogs",name:"hide profile logs",
	description:"remove the activity log on profile page",onpage:V.Profile,
	category:Z.Profile,enabled:false,readyStates:["interactive"],
	run:()=>nt(Na,Q.hideprofilelogs)}];function Ca(){var t,n
	;console.debug("nst - init default start");const e={}
	;for(const r of Ha)e[r.key]={name:r.name,description:r.description,
	...
	}function Fa(t,n,e){return q({id:"nst-"+t,type:"password",
	classList:"nst-input m-2",maxLength:n,required:true,value:e})}function Ra(t,n=false){
	const e=document.getElementById("nst-ts-message");var o
	;e&&((o=e).innerText="",o.classList.remove("text-nstgreen"),
	e.innerText=t,e.classList.toggle("text-nstgreen",n));}async function Ba(){
	const t=document.getElementById("nst-tsapikey");if(!t)return
	;const n=t.value.trim();if(19!==n.length)return Ra("Invalid Key Length")
	;const e=await Lt({api:n,selection:""})
	;if(!(null==e?void 0:e.status))return Ra((null==e?void 0:e.error)||"Invalid Key")
	;try{p({tsapikey:n}),Ra("Key Saved",!0);}catch(o){Ra(o.message||"Unknown error");}
	}async function Ua(){const t=document.getElementById("nst-apikey");if(!t)return
	;const n=t.value.trim();if(16!==n.length)return Ra("Invalid Key Length")
	;const e=await xt({section:"user",select:"profile",api:n})
	;if(!(null==e?void 0:e.status))return Ra((null==e?void 0:e.error)||"Invalid Key")
	;try{const{t:t,o:o}=vt(e)
	;if(void 0===t||void 0===o)return Ra("API broken, wait for ched to fix");if(p({
	apikey:n
	}),!gt(e))return m("nstdata"),Ra("You are not allowed, contact seintz[2460991]")
	;p({userdata:e}),ds(),Ra("Key Saved",!0);}catch(o){Ra(o||"Unknown error");}}
	async function Ga(){
	confirm("Are you sure you want to reset?")&&(m("nstdata"),window.location.reload());
	}function Wa(t){const n=document.getElementById(t);if(!n)return;n.innerHTML=""
	...
	classList:"nst-api-wrap"}),r=j({classList:"nst-block"}).appendChild(H({
	id:"nst-ts-message",classList:"nst-message"
	})),a="tsapikey",s=Fa(a,19,(f(a)??"")+""),c=P({id:"nst-tslogin",
	classList:"torn-btn m-2",innerText:"save",onclick:Ba})
	;i.appendChild(o),i.appendChild(r),
	i.appendChild(s),i.appendChild(c),n.appendChild(i);}function Xa(t){
	...
	}),s=j({classList:"nst-block"}).appendChild(H({id:"nst-message",
	classList:"nst-message"})),c="apikey",l=Fa(c,16,(f(c)??"")+""),u=P({
	id:"nst-login",classList:"torn-btn m-2",innerText:"save",onclick:Ua}),d=P({
	id:"nst-reset",classList:"torn-btn m-2",innerText:"reset",onclick:Ga})
	;a.appendChild(r),
	a.appendChild(s),a.appendChild(l),a.appendChild(u),a.appendChild(d),
	n.appendChild(a);}function Ja(t,...n){const e=j({classList:"nst-block"
	}),o=O("h4",{classList:"nst-block-title",innerText:t})
	;return e.appendChild(o),n.forEach(t=>e.appendChild(t)),e}function Ka(t,n,e){
	const o=j({id:n,classList:"nst-outcome"});o.addEventListener("change",t=>{
	const n=t.target;n&&"radio"===n.type&&e(n.id);})
	;const i=document.createDocumentFragment()
	;return t.forEach(t=>i.appendChild(U(t,n))),o.appendChild(i),o}function Ya(t){
	const n=document.getElementById(t);if(!n)return;n.innerHTML=""
	...
	}()),e.appendChild(Ja("default outcome",Ka(["leave","mug","hospitalize"],"outcome",t=>p({
	...
	},"secondary")),t.appendChild(n),Ja("weapon reload",t)}()),n.appendChild(e);}
	function Qa(t){const n=document.getElementById(t);if(!n)return;n.innerHTML=""
	;const e=document.createDocumentFragment()
	;e.appendChild(Ja("default outcome",Ka(["easy-leave","easy-mug","easy-hospitalize"],"easy-outcome",t=>p({
	easyoutcome:t.replace(/easy-/g,"")
	})))),e.appendChild(Ja("default weapon",Ka(["easy-primary","easy-secondary","easy-melee"],"easy-weapon",t=>p({
	easyweapon:t.replace(/easy-/g,"")})),B({id:"nst-easy-temp"},"use temp first"))),
	n.appendChild(e);}let Va=null;function Za(t){const n=document.getElementById(t)
	;return n?(n.innerHTML="",n):null}function ts(t,n,e){
	t.className=e,t.innerHTML=`<b>${n}</b>`,t.classList.remove("hidden");}
	function ns(t){const n=Za(t);if(!n)return;const e=j({id:"nst-export-wrap",
	...
	;Va&&window.URL.revokeObjectURL(Va),Va=window.URL.createObjectURL(new Blob([n],{
	type:"application/json"
	})),t.setAttribute("href",Va+"#/nst-export"),t.setAttribute("download","nst-export.json"),
	t.classList.remove("hidden");}(o)});e.append(i,o),n.appendChild(e);}
	function es(t){const n=Za(t);if(!n)return;const e=H({})
	;e.classList.add("hidden");const o=j({id:"nst-import-wrap",
	classList:"nst-api-wrap"}),i=q({id:"nst-import-input",type:"file",
	...
	Ca(),ts(n,"Import Successful","text-nstgreen");}catch{
	ts(n,"Import Unsuccessful","text-nstred");}},o.onerror=t=>{
	ts(n,"Import Unsuccessful","text-nstred"),console.error(t);},o.readAsText(e[0]);
	}(i,e)});i.classList.add("hidden");const r=P({id:"nst-import-btn",
	innerText:"import",classList:"torn-btn m-2",onclick:()=>i.click()})
	;o.append(r,i,e),n.appendChild(o);}const os={"Data Storage":"Only locally",
	"Data Sharing":"Nobody",
	"Purpose of Use":"Optimization / Maintenance but only end user has access",
	"Key Storage & Sharing":"Stored locally but not shared",
	"Key Access Level":"Limited or Custom (see below)"};function is(t,n){const e=j({
	...
	}function rs(t){const n=document.getElementById(t);if(!n)return;n.innerHTML=""
	;const e=document.createDocumentFragment()
	;e.appendChild(is("Terms of Service",os)),
	e.appendChild(is("Api usage",_)),n.appendChild(e);}
	const as=["spring","summer","autumn","winter"];function ss(){
	const t=as.map(t=>document.querySelector(".content-wrapper."+t)).find(Boolean)
	...
	null==e||e.classList.toggle("hidden");}(r),ds();}(t);}function cs(t,n,e=()=>{}){
	...
	classList:"nst-menu-page",innerText:n,onclick:ls})
	...
	function us(t){const n=document.getElementById(t);if(!n)return;n.innerHTML=""
	...
	}),a=f("script"),s=null==a?void 0:a[o],c=q({...t,type:"checkbox",
	...
	}),l=A({innerText:n,htmlFor:null==t?void 0:t.id,title:e})
	;return i.appendChild(c),i.appendChild(l),i}({id:"nst-"+i,value:i
	},e,n.description.toLowerCase());c.appendChild(a);
	}),s.appendChild(c),n.appendChild(s);}function ds(){if(!gt())return;Ca()
	;const t=document.querySelector("#nst-ul-main");if(!t)return;const n={tsapi:Wa,
	attack:Ya,"easy-fight":Qa,export:ns,import:es}
	;Object.keys(n).forEach(e=>cs(t,e,n[e]))
	;const e=f("script"),o=Object.keys(e).sort().reduce((t,n)=>(t[n]=null==e?void 0:e[n],
	t),{})
	;Array.from(new Set(Object.values(o).map(t=>t.category).filter(Boolean))).sort().forEach(n=>cs(t,n,us));
	}function fs(t){if(document.getElementById("nst-icon"))return
	;const n=t.querySelector('ul[class^="status-icon"]');if(!n)return;const e=z({
	id:"nst-icon",classList:"nst-icon"})
	;n.insertBefore(e,n.firstChild),e.addEventListener("click",ss);}
	const ps=window.location.pathname.replace(/^\//,"").replace(/\.php$/,""),ms={
	loading:()=>{
	nt(D,"head"),nt(fs,"#sidebar"),gt()&&(document.onreadystatechange||(document.onreadystatechange=()=>{
	const t=document.readyState;ms[t]&&ms[t]();}),st(ps,"loading"),kt());},
	interactive:()=>{gt()&&st(ps,"interactive");},complete:()=>{st(ps,"complete");}}
	;ms[document.readyState]&&ms[document.readyState]();}();
