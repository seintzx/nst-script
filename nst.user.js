...
;var o=n(1601),i=n.n(o),a=n(6314),r=n.n(a)()(i())
...
},e.i=function(t,n,o,i,a){"string"==typeof t&&(t=[[null,t,void 0]]);var r={}
;if(o)for(var s=0;s<this.length;s++){var c=this[s][0];null!=c&&(r[c]=!0)}
for(var l=0;l<t.length;l++){var u=[].concat(t[l])
;o&&r[u[0]]||(void 0!==a&&(void 0===u[5]||(u[1]="@layer".concat(u[5].length>0?" ".concat(u[5]):""," {").concat(u[1],"}")),
u[5]=a),
...
function D(t,e,n,o,i){if(t.getBoundingClientRect||t===window){var a,r,s,c,l,d,m
;if(t!==window&&t.parentNode&&t!==T()?(r=(a=t.getBoundingClientRect()).top,
s=a.left,
...
;r-=f.top+parseInt(L(i,"border-top-width")),s-=f.left+parseInt(L(i,"border-left-width")),
c=r+a.height,l=s+a.width;break}}while(i=i.parentNode);if(o&&t!==window){
var p=M(i||t),h=p&&p.a,b=p&&p.d;p&&(c=(r/=b)+(d/=b),l=(s/=h)+(m/=h))}return{
top:r,left:s,bottom:c,right:l,width:m,height:d}}}function S(t,e,n){
for(var o=$(t,!0),i=D(t)[e];o;){var a=D(o)[n]
;if(!("top"===n||"left"===n?i>=a:i<=a))return o;if(o===T())break;o=$(o,!1)}
return!1}function I(t,e,n,o){for(var i=0,a=0,r=t.children;a<r.length;){
if("none"!==r[a].style.display&&r[a]!==Rt.ghost&&(o||r[a]!==Rt.dragged)&&k(r[a],n.draggable,t,!1)){
if(i===e)return r[a];i++}a++}return null}function P(t,e){
...
;return n}function A(t){var e=0,n=0,o=T();if(t)do{var i=M(t),a=i.a,r=i.d
...
var a,r,s,c;if(k(i,e.draggable,t,!1)&&!i.animated&&i!==n){var l=D(i)
...
;a.sortable=t,a.options=t.options,t[i]=a,s(n,a.defaults)}
...
var e=t.sortable,n=t.rootEl,o=t.name,a=t.targetEl,r=t.cloneEl,s=t.toEl,c=t.fromEl,l=t.oldIndex,m=t.newIndex,f=t.oldDraggableIndex,p=t.newDraggableIndex,h=t.originalEvent,b=t.putSortable,g=t.extraEventProperties
...
activeSortable:Rt.active,originalEvent:o,oldIndex:at,oldDraggableIndex:st,
...
var Q,V,Z,tt,et,nt,ot,it,at,rt,st,ct,lt,ut,dt,mt,ft,pt,ht,bt,gt,vt,wt,yt,kt,xt=!1,_t=!1,Ot=[],Lt=!1,Mt=!1,jt=[],Tt=!1,Dt=[],St="undefined"!=typeof document,It=p,Pt=d||u?"cssFloat":"float",Et=St&&!h&&!p&&"draggable"in document.createElement("div"),At=function(){
if(St){if(u)return!1;var t=document.createElement("x")
;return t.style.cssText="pointer-events:auto","auto"===t.style.pointerEvents}
}(),$t=function(t,e){
var n=L(t),o=parseInt(n.width)-parseInt(n.paddingLeft)-parseInt(n.paddingRight)-parseInt(n.borderLeftWidth)-parseInt(n.borderRightWidth),i=I(t,0,e),a=I(t,1,e),r=i&&L(i),s=a&&L(a),c=r&&parseInt(r.marginLeft)+parseInt(r.marginRight)+D(i).width,l=s&&parseInt(s.marginLeft)+parseInt(s.marginRight)+D(a).width
;if("flex"===n.display)return"column"===n.flexDirection||"column-reverse"===n.flexDirection?"vertical":"horizontal"
;if("grid"===n.display)return n.gridTemplateColumns.split(" ").length<=1?"vertical":"horizontal"
;if(i&&r.float&&"none"!==r.float){var u="left"===r.float?"left":"right"
;return!a||"both"!==s.clear&&s.clear!==u?"horizontal":"vertical"}
return i&&("block"===r.display||"flex"===r.display||"table"===r.display||"grid"===r.display||c>=o&&"none"===n[Pt]||a&&"none"===n[Pt]&&c+l>o)?"vertical":"horizontal"
},qt=function(t){function e(t,n){return function(o,i,a,r){
...
var n=D(t),o=i>=n.left-e&&i<=n.right+e,s=a>=n.top-e&&a<=n.bottom+e
;return o&&s?r=t:void 0}})),r);if(e){var n={}
;for(var o in t)t.hasOwnProperty(o)&&(n[o]=t[o])
;n.target=n.rootEl=e,n.preventDefault=void 0,
n.stopPropagation=void 0,e[F]._onDragOver(n)}}var i,a,r},Bt=function(t){
Q&&Q.parentNode[F]._isOutsideThisEl(t.target)};function Rt(t,e){
if(!t||!t.nodeType||1!==t.nodeType)throw"Sortable: `el` must be an HTMLElement, not ".concat({}.toString.call(t))
;this.el=t,this.options=e=s({},e),t[F]=this;var n,o,a={group:null,sort:!0,
...
;for(var r in W.initializePlugins(this,t,a),a)!(r in e)&&(e[r]=a[r])
;for(var c in qt(e),
...
var n=0,o=t.target,r=o.fromRect,s=D(o),c=o.prevFromRect,l=o.prevToRect,u=t.rect,d=M(o,!0)
;d&&(s.top-=d.f,
s.left-=d.e),o.toRect=s,o.thisAnimationDuration&&q(c,s)&&!q(r,s)&&(u.top-s.top)/(u.left-s.left)==(r.top-s.top)/(r.left-s.left)&&(n=function(t,e,n,o){
return Math.sqrt(Math.pow(e.top-t.top,2)+Math.pow(e.left-t.left,2))/Math.sqrt(Math.pow(e.top-n.top,2)+Math.pow(e.left-n.left,2))*o.animation
}(u,c,l,e.options)),
q(s,r)||(o.prevFromRect=r,o.prevToRect=s,n||(n=e.options.animation),
e.animate(o,u,s,n)),
...
;var i=M(this.el),a=i&&i.a,r=i&&i.d,s=(e.left-n.left)/(a||1),c=(e.top-n.top)/(r||1)
;t.animatingX=!!s,
t.animatingY=!!c,L(t,"transform","translate3d("+s+"px,"+c+"px,0)"),
...
t.animatingX=!1,t.animatingY=!1}),o)}}}))}function Ut(t,e,n,o,i,a,r,s){
...
var e=this,n=this.el,o=this.options,i=o.preventOnFilter,a=t.type,r=t.touches&&t.touches[0]||t.pointerType&&"touch"===t.pointerType&&t,s=(r||t).target,c=t.target.shadowRoot&&(t.path&&t.path[0]||t.composedPath&&t.composedPath()[0])||s,l=o.filter
;if(function(t){Dt.length=0
;for(var e=t.getElementsByTagName("input"),n=e.length;n--;){var o=e[n]
;o.checked&&Dt.push(o)}
}(n),!Q&&!(/mousedown|pointerdown/.test(a)&&0!==t.button||o.disabled)&&!c.isContentEditable&&(this.nativeDraggable||!f||!s||"SELECT"!==s.tagName.toUpperCase())&&!((s=k(s,o.draggable,n,!1))&&s.animated||nt===s)){
if(at=E(s),st=E(s,o.draggable),"function"==typeof l){
...
;o.handle&&!k(c,o.handle,n,!1)||this._prepareDragStart(t,r,s)}}},
_prepareDragStart:function(t,e,n){
var o,i=this,a=i.el,r=i.options,s=a.ownerDocument;if(n&&!Q&&n.parentNode===a){
var c=D(n)
;if(tt=a,V=(Q=n).parentNode,et=Q.nextSibling,nt=n,lt=r.group,Rt.dragged=Q,dt={
...
name:"choose",originalEvent:t}),O(Q,r.chosenClass,!0))
},r.ignore.split(",").forEach((function(t){j(Q,t.trim(),Ft)
})),g(s,"dragover",Nt),
...
}),!r.delay||r.delayOnTouchOnly&&!e||this.nativeDraggable&&(d||u))o();else{
...
r.supportPointer&&g(s,"pointermove",i._delayedDragTouchMoveHandler),
...
var e=this.options,n=e.fallbackTolerance,o=e.fallbackOffset,i=t.touches?t.touches[0]:t,a=Z&&M(Z,!0),r=Z&&a&&a.a,s=Z&&a&&a.d,c=It&&kt&&A(kt),l=(i.clientX-dt.clientX+o.x)/(r||1)+(c?c[0]-jt[0]:0)/(r||1),u=(i.clientY-dt.clientY+o.y)/(s||1)+(c?c[1]-jt[1]:0)/(s||1)
;if(!Rt.active&&!xt){
...
var e,n,o,a,r=this.el,s=t.target,c=this.options,l=c.group,u=Rt.active,d=lt===l,m=c.sort,f=ut||u,p=this,h=!1
;if(!Tt){
if(void 0!==t.preventDefault&&t.cancelable&&t.preventDefault(),s=k(s,c.draggable,r,!0),
N("dragOver"),Rt.eventCanceled)return h
;if(Q.contains(t.target)||s.animated&&s.animatingX&&s.animatingY||p._ignoreWhileAnimating===s)return R(!1)
;if(_t=!1,
...
;if(b&&r===t.target&&(s=b),s&&(n=D(s)),
!1!==Ut(tt,r,Q,e,s,n,t,!!s))return B(),b&&b.nextSibling?r.insertBefore(Q,b.nextSibling):r.appendChild(Q),
...
}(t,a,this)){var g=I(r,0,c,!0);if(g===Q)return R(!1)
;if(n=D(s=g),!1!==Ut(tt,r,Q,e,s,n,t,!1))return B(),
r.insertBefore(Q,g),V=r,H(),R(!0)}else if(s.parentNode===r){n=D(s)
;var v,w,y,x=Q.parentNode!==r,_=!function(t,e,n){
var o=n?t.left:t.top,i=n?t.right:t.bottom,a=n?t.width:t.height,r=n?e.left:e.top,s=n?e.right:e.bottom,c=n?e.width:e.height
;return o===r||i===s||o+a/2===r+c/2
}(Q.animated&&Q.toRect||e,s.animated&&s.toRect||n,a),M=a?"top":"left",j=S(s,"top","top")||S(Q,"top","top"),T=j?j.scrollTop:void 0
;if(vt!==s&&(w=n[M],Lt=!1,Mt=!_&&c.invertSwap||x),v=function(t,e,n,o,i,a,r,s){
...
}while(y&&("none"===L(y,"display")||y===Z))}if(0===v||y===s)return R(!1)
;vt=s,wt=v;var $=s.nextElementSibling,q=!1,z=Ut(tt,r,Q,e,s,n,t,q=1===v)
;if(!1!==z)return 1!==z&&-1!==z||(q=1===z),
Tt=!0,setTimeout(Ht,30),B(),q&&!$?r.appendChild(Q):s.parentNode.insertBefore(Q,q?$:s),
j&&C(j,0,T-j.scrollTop),V=Q.parentNode,void 0===w||Mt||(yt=Math.abs(w-D(s)[M])),
H(),R(!0)}if(r.contains(Q))return R(!1)}return!1}function N(c,l){J(c,p,i({evt:t,
isOwner:d,axis:a?"vertical":"horizontal",revert:o,dragRect:e,targetRect:n,
canSort:m,fromSortable:f,target:s,completed:R,onMove:function(n,o){
return Ut(tt,r,Q,e,n,D(n),t,o)},changed:H},l))}function B(){
...
O(Q,c.ghostClass,!0)),
ut!==p&&p!==Rt.active?ut=p:p===Rt.active&&ut&&(ut=null),f===p&&(p._ignoreWhileAnimating=s),
p.animateAll((function(){
N("dragOverAnimationComplete"),p._ignoreWhileAnimating=null
})),p!==f&&(f.animateAll(),
f._ignoreWhileAnimating=null)),(s===Q&&!Q.animated||s===r&&!s.animated)&&(vt=null),
...
function H(){rt=E(Q),ct=E(Q,c.draggable),Y({sortable:p,name:"change",toEl:r,
...
;rt=E(Q),ct=E(Q,n.draggable),J("drop",this,{evt:t
}),V=Q&&Q.parentNode,rt=E(Q),ct=E(Q,n.draggable),Rt.eventCanceled||(xt=!1,Mt=!1,
Lt=!1,
...
newIndex:null,newDraggableIndex:null,originalEvent:t}),tt!==V?(rt>=0&&(Y({
...
})),ut&&ut.save()):rt!==at&&rt>=0&&(Y({sortable:this,name:"update",toEl:V,
originalEvent:t}),Y({sortable:this,name:"sort",toEl:V,originalEvent:t
})),Rt.active&&(null!=rt&&-1!==rt||(rt=at,ct=st),Y({sortable:this,name:"end",
toEl:V,originalEvent:t}),this.save())))),this._nulling()},_nulling:function(){
J("nulling",this),
tt=Q=V=Z=et=ot=nt=it=dt=mt=gt=rt=ct=at=st=vt=wt=ut=lt=Rt.dragged=Rt.ghost=Rt.clone=Rt.active=null,
...
var i,a=(t.touches?t.touches[0]:t).clientX,r=(t.touches?t.touches[0]:t).clientY,s=e.scrollSensitivity,c=e.scrollSpeed,l=T(),u=!1
...
;var I=k&&(Math.abs(v-a)<=s&&j+w<_)-(Math.abs(g-a)<=s&&!!j),P=x&&(Math.abs(b-r)<=s&&S+y<O)-(Math.abs(h-r)<=s&&!!S)
...
;s(),c&&!c.el.contains(u)&&(a("spill"),this.onSpill({dragEl:o,putSortable:n}))}}
...
var e=t.completed,n=t.target,o=t.onMove,i=t.activeSortable,a=t.changed,r=t.cancel
...
var e,n,o,i,a,r,s=t.activeSortable,c=t.putSortable,l=t.dragEl,u=c||this.sortable,d=this.options
;ie&&O(ie,d.swapClass,!1),
ie&&(d.swap||c&&c.options.swap)&&l!==ie&&(u.captureAnimationState(),
u!==s&&s.captureAnimationState(),
n=ie,a=(e=l).parentNode,r=n.parentNode,a&&r&&!a.isEqualNode(n)&&!r.isEqualNode(e)&&(o=E(e),
i=E(n),
a.isEqualNode(r)&&o<i&&i++,a.insertBefore(n,a.children[o]),r.insertBefore(e,r.children[i])),
...
var e=t.sortable,n=t.isOwner,o=t.insertion,i=t.activeSortable,a=t.parentEl,r=t.putSortable,s=this.options
;if(o){
if(n&&i._hideClone(),ge=!1,s.animation&&he.length>1&&(ve||!n&&!i.options.sort&&!r)){
...
var e=t.originalEvent,n=t.rootEl,o=t.parentEl,i=t.sortable,a=t.dispatchSortableEvent,r=t.oldIndex,s=t.putSortable,c=s||this.sortable
...
u[b]?o.insertBefore(t,u[b]):o.appendChild(t),b++})),r===E(me))){var g=!1
...
ae(t,this.options,a,e);var r=$(a,!0)
;!ee||Zt&&o===Yt&&i===Qt||(Zt&&oe(),Zt=setInterval((function(){
var a=$(document.elementFromPoint(o,i),!0);a!==r&&(r=a,ne()),ae(t,n.options,a,e)
}),10),Yt=o,Qt=i)}else{
if(!this.options.bubbleScroll||$(a,!0)===T())return void ne()
;ae(t,this.options,$(a,!1),!1)}}},s(t,{pluginName:"scroll",
initializeByDefault:!0})}),Rt.mount(ce,se);const _e=Rt},4893:(t,e,n)=>{
n.r(e),n.d(e,{default:()=>g})
;var o=n(5072),i=n.n(o),a=n(7825),r=n.n(a),s=n(7659),c=n.n(s),l=n(5056),u=n.n(l),d=n(540),m=n.n(d),f=n(1113),p=n.n(f),h=n(6906),b={}
...
function o(t,o){for(var a={},r=[],s=0;s<t.length;s++){
var c=t[s],l=o.base?c[0]+o.base:c[0],u=a[l]||0,d="".concat(l," ").concat(u)
...
;o.byIndex=s,e.splice(s,0,{identifier:d,updater:p,references:1})}r.push(d)}
...
;e[s].references--}for(var c=o(t,i),l=0;l<a.length;l++){var u=n(a[l])
...
;const{bazaar:r}=a,s=(0,o.m)(r[1]?.cost??"")-1;(0,o.h)(t,s.toString())
...
;if(!e?.status)return
;const{bazaar:n}=e,i=n.reduce(((t,e)=>t+ +e?.price*+e.quantity),0),a=n.reduce(((t,e)=>t+ +e?.market_price*+e.quantity),0),r=(0,
...
;const r=Object.values(a).reduce(((t,e)=>t+e.value*e.count),0),s=Object.values(a).map((t=>`${t.name} x${t.count}`)).join(", ").replace(/, $/,"."),c=(0,
...
innerText:"Worth: $"+(0,o.O)(r)})),l.appendChild((0,o._)({
...
;if(n.length>2){
const t=n[0].replace(/:/g,""),e=(0,o.m)(n[1]),a=n[2].replace(/%/g,""),r=a.charAt(0),s=(0,
o.m)(a),c="+"==r?s/100+1:1-s/100;i[t]=Math.round(e*c),i.Total+=Math.round(e*c)}}
...
innerHTML:`<span>${t}</span>`}),r=(0,o.q)({classList:"desc",
...
;if(0===i.length)return;const a=(0,o.U)()-86400,r=(0,o.U)()-172800
;i.forEach((t=>{const n=t?.getAttribute("data-user");if(!n)return
;const o=e[n]?.last_action?.timestamp,i=t?.querySelector(".employee")
;if(!i)return;const s=o<r?"bg-nstred":o<a?"bg-nstyellow":""
;s&&i.classList.add(s)}))};e.R=async t=>{if(!t)return;const e=await(0,o.p)({
...
;const o=n(6185),i=(0,
o.k)("user2ID")??"",a=(0,o.S)(),{reloadone:r,reloadtwo:s,weapon:c}=a
...
o.J)(),r={method:"POST",headers:{"x-requested-with":"XMLHttpRequest"},
body:new URLSearchParams(i)};console.log(n,i),await fetch(a,{...r
...
;e.appendChild(n),e.appendChild(i),e.appendChild(a),t.appendChild(e);const r=(0,
o._)({classList:"nst-outcome"}),s={id:"nst-hold",checked:(0,o.S)("hold")
},c=(0,o.V)(s,"hold","",(t=>{const e=t.target.checked;(0,o.I)({hold:e})})),l={
...
;const o=n(6185),i=n(9607),a={},r={balboas:{req:["defense","dexterity"],
...
;r.selected=(0,o.S)("spgym"+t)?.toString()===e,i.appendChild(r)
...
const e=document.querySelector(`#nst-spgym-${t}-sel`),n=document.querySelector(`#nst-spgym-${t}-msg`),i=e.value,s=Object.keys(a).filter((t=>r[i].req.includes(t))).reduce(((t,e)=>({
...t,[e]:a[e]
})),{}),c=Object.keys(a).filter((t=>!r[i].req.includes(t))).reduce(((t,e)=>({
...t,[e]:a[e]
...
o.O)(l/1.25-u):(0,
o.O)(1.25*u-l),m=Object.keys(s).length>1?Object.keys(l>=1.25*u?c:s).join(" and "):(l>=1.25*u?Object.keys(c).filter((t=>a[t]===u)):Object.keys(s)).join(""),f=`Gain ${l>=1.25*u?"no more than":""} ${d} ${m}`
;n.innerText=f}))};e.et=t=>{
Object.entries(t?.stats).forEach((([t,e])=>a[t]=(0,o.m)(e?.value))),
(0,i.it)(s,"#gymroot"),c()},e.tt=t=>{
...
o.m)(n?.personalstats?.networth),r=Math.round(i-a),s=r>0?"text-nstgreen":r<0?"text-nstred":"",c=`<b class='${s}'>$${(0,
o.O)(r)}</b>`,l=(0,o.B)({classList:"last",tabIndex:0,
ariaLabel:"Live NW: "+(0,o.O)(i)}),u=(0,o.q)({classList:"divider",
innerHTML:"<span>Live Networth</span>"}),d=(0,o.q)({
classList:`desc ${s} font-bold`,innerText:` $${(0,o.O)(i)} `,
...
o.m)(n?.querySelector(".stock .stck-amount").innerText),c=a/r>=i?i:Math.trunc(a/r),l=Math.min(c,s).toString()
;(0,o.h)(e,l)}))}},1717:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0
}),e.gt=void 0;const o=n(6185),i=n(9607);let a;const r=t=>{
...
(0,i.it)(r,'#profile-mini-root [class*="profile-mini-_userProfileWrapper"]')}},
...
;const e=t?.querySelector(".title-black")?.childNodes[0].textContent.replace(/\n/g,"").trim(),n=e.toLowerCase().replaceAll(/[ -]/g,"_").replaceAll(/[:!,]/g,""),a=n in i?i?.[n]?.task:"mission not found",r=(0,
...
const n=e?.travel?.time_left,a=t?.travel?.time_left,r=e?.travel?.destination
;n<=120&&n!==a&&i({title:"NST: Travel",text:`${r} - Landing in ${(0,o.vt)(n)}`})
})(t,e),(0,o.kt)("hospnoti")&&((t,e)=>{
const n=e?.states?.hospital_timestamp,a=t?.states?.hospital_timestamp;if(!(n-(0,
o.U)()<=300&&n!==a))return;const r=Math.round(n-(0,o.U)());i({
title:"NST: Hospital",text:"Out of hosp in "+(0,o.vt)(r)})
...
;const i=o(n(246)),a=n(6185),r=t=>{t.stopPropagation()
...
;const i="https://www.torn.com/item.php?rfcv="+(0,a.J)(),r={method:"POST",
headers:{"x-requested-with":"XMLHttpRequest"},body:new URLSearchParams(o)
},s=await(await fetch(i,{...r})).json(),c=s.links??{},l=s.text??{},u=(0,a._)({})
...
a.m)(o.getAttribute("src")).toString(),r=n?.innerText.replace(/ x\d+$/,"").replace(/[ ]*Blood Bag[ :]*/,"").replace(/[ ]*Bottle of[ :]*/,"").replace(/[ ]*First Aid[ :]*/,"").replace(/[ ]*Lawyer's Business Card[ :]*/,"LBC").replace(/[ ]*Can of[ :]*/,"")
;if(!i)return;const s=(0,a.S)(a.qfs);if(Object.keys(s).includes(i))return
;const l=0===Object.values(s)?.length?0:+Object.values(s).reduce(((t,e)=>t?.order>e?.order?t:e))?.order??0
;s[i]={id:i,order:l+1,name:r},(0,a.I)({[a.qfs]:s}),c()},u={box:t=>{
...
value:!0}),e.jt=void 0
;const i=o(n(246)),a=n(6185),r=["Primary","Secondary","Melee","Temporary"],s=["Medical","Drug","Energy Drink","Alcohol","Candy","Booster","Supply Pack",...r],c=t=>{
t.stopPropagation()
;const e=t.target.closest("#nst-quick-use").parentElement.getAttribute("data-itemID")
...
;const r="https://www.torn.com/item.php?rfcv="+(0,a.J)(),s={method:"POST",
...
;if(!o)return;const i="https://www.torn.com/item.php?rfcv="+(0,a.J)(),r={
method:"POST",headers:{"x-requested-with":"XMLHttpRequest"},
body:new URLSearchParams(o)},s=await(await fetch(i,{...r
})).json(),c=s.links??{},l=s.text??{},u=(0,a._)({});u.appendChild((0,a.ot)({
...
const{id:n,name:o,quantity:i}=t,r=`/images/items/${n}/medium.png`,s=(0,a._)({
classList:"nst-box-btn-div"})
;s.setAttribute("data-itemID",n),s.setAttribute("data-qty",i);const u=(0,a.Z)({
id:"nst-quick-use",classList:"nst-box-button"}),d=(0,a.Mt)({src:r,alt:o,
classList:"nst-box-img"}),m=(0,a.q)({id:"nst-quick-name",innerText:o
}),f=(0,a.q)({id:"nst-quick-close",classList:"nst-box-close",innerText:"✕"})
...
;const n=e.closest("li"),o=n?.dataset?.item,i=n?.dataset?.qty,r=n?.dataset?.category??"",c=n?.querySelector('.cont-wrap ul [class*="equipped"]')?.getAttribute("data-id")??"",l=n?.querySelector(".title-wrap .name-wrap .name"),d=l?.innerText?.replace(/[ ]*Blood Bag[ :]*/,"")?.replace(/[ ]*Bottle of[ :]*/,"")?.replace(/[ ]*First Aid[ :]*/,"")?.replace(/[ ]*Lawyer's Business Card[ :]*/,"LBC")?.replace(/[ ]*Can of[ :]*/,"")
;if(!(n&&o&&r&&s.includes(r)))return;const m=(0,a.S)(a.qis)
...
;m[o]={id:o,order:f+1,name:d,quantity:i,category:r,strangeID:c},(0,a.I)({
[a.qis]:m}),u()};e.jt=t=>{
...
const{item:n,selector:i,reg:a}=e,r=(0,o.S)("quick"+n)??!1,s=t?.parentElement,c=s.querySelector("a."+i),l=c?.getAttribute("href")
;if(!c||!l)return
;const u=RegExp(a+"$","g"),d=RegExp(a+"1$","g"),m=r?l.replace(u,a+"1"):l.replace(d,a)
;c.setAttribute("href",m)},a=t=>{
const e=+((0,o.S)("jailscore")??"0"),n=t?.parentElement,a=t.querySelector("span.time").innerText.split(" ").reduce(((t,e)=>t+(/h/.test(e)?60*+e.replace(/h/g,""):/m/.test(e)?+e.replace(/m/g,""):0)),0),r=(0,
o.m)(t.querySelector("span.level").innerText.match(/\d+/g)?.join())*a
;t.setAttribute("title","score: "+(0,o.O)(r));const s=r>e&&0!==e
...
;Array.from(e).forEach((t=>a(t)))}});const s="Quick Bust",c=(0,o.St)(s),l={
id:"nst-"+c,type:"checkbox",value:c,checked:(0,o.S)(c)??!1}
;i.appendChild((0,o.V)(l,s,"",r));const u="Quick Bail",d=(0,o.St)(u),m={
id:"nst-"+d,type:"checkbox",value:d,checked:(0,o.S)(d)??!1}
;i.appendChild((0,o.V)(m,u,"",r))})(t),new MutationObserver((t=>{t.forEach((t=>{
...
const{name:n,selector:o,link:i,refillUsed:a}=e,r=o+' p[class^="bar-name"]',s=t?.querySelector(r),c=s?.parentElement?.parentElement
...
;const r=t.querySelector("div[class^='betBlock']"),s=r.getAttribute("aria-label").split(":")[1].trim(),c="$"+(0,
o.O)((0,o.m)(s));r.innerText=c+"\n"+n}))};e.At=t=>{if("lobby"!==t?.step)return
...
;const i=o(n(246)),a=n(488),r=n(6185),s=async()=>{
...
void(t.innerText="Invalid Key Length");const o=await(0,r.Ct)({api:n,selection:""
})
...
void(t.innerText=i?.error);const{Nt:a,Bt:s}=(0,r.Rt)(i)
;return void 0===a||void 0===s?(t.classList.remove("text-nstgreen"),
void(t.innerText="API broken, wait for ched to fix")):((0,r.I)({apikey:n
}),(0,r.Ut)(i)?((0,r.I)({userdata:i
}),t.classList.add("text-nstgreen"),t.innerText="Login Successful",
void u()):((0,
r.Ft)("nstdata"),t.classList.remove("text-nstgreen"),void(t.innerText="You are not allowed, contact seintz[2460991]")))
},l=async()=>{
confirm("Are you sure you want to reset?")&&((0,r.Ft)("nstdata"),window.location.reload())
},u=()=>{if(!(0,r.Ut)())return;(0,a.D)()
;const t=document.querySelector("#nst-ul-main");b(t,"tsapi",f),b(t,"attack",m)
;const e=(0,
r.S)("script"),n=Object.keys(e).sort().reduce(((t,n)=>(t[n]=e?.[n],t)),{})
...
r.S)("script"),i=Object.keys(o).sort().reduce(((t,e)=>(o?.[e]?.onpage===n&&(t[e]=o?.[e]),
t)),{}),a=(0,r._)({classList:"nst-script-block"})
;Object.entries(i).forEach((([t,e])=>{const n=e?.name,o=(0,r.St)(t),i={
id:"nst-"+o,value:o,checked:e?.enabled??!1
},s=(0,r.V)(i,n,e.description.toLowerCase(),(t=>{
const e=t.target,n=(0,r.S)("script");n[e.value].enabled=e.checked,(0,r.I)({
script:n})}));a.appendChild(s)})),e.appendChild(a)},m=t=>{
const e=document.getElementById(t);e&&(e.innerHTML="",e.appendChild((()=>{
const t=(0,r._)({classList:"nst-block"}),e=(0,r.nt)("h4",{
classList:"nst-block-title",innerText:"mug threshold"});return t.appendChild(e),
(0,r.Dt)({elem:t,title:"mug threshold"}),t})()),e.appendChild((()=>{
const t=(0,r._)({classList:"nst-block"}),e=(0,r.nt)("h4",{
...
;const o=(0,r.Y)("leave","outcome"),i=(0,
r.Y)("mug","outcome"),a=(0,r.Y)("hospitalize","outcome"),s={id:"nst-hold",
checked:(0,r.S)("hold")},c=(0,r.V)(s,"hold","",(t=>{const e=t.target.checked;(0,
r.I)({hold:e})}))
;return n.appendChild(o),n.appendChild(i),n.appendChild(a),t.appendChild(e),
t.appendChild(n),t.appendChild(c),t})()),e.appendChild((()=>{
const t=(0,r.S)("weapon"),e=(0,r._)({classList:"nst-block"}),n=(0,r.nt)("h4",{
...
animation:150,store:{get:()=>{const t=(0,r.S)("weapon"),e=["","","",""]
;return Object.entries(t).forEach((t=>e[t[1]]=t[0])),e},set:t=>{
const e=t.toArray(),n=(0,r.S)("weapon")
;e.forEach((t=>n[t]=e.indexOf(t))),(0,r.I)({weapon:n})}}});const a={
id:"nst-temp",checked:(0,r.S)("temp")},s=(0,r.V)(a,"use temp first","",(t=>{
const e=t.target.checked;(0,r.I)({temp:e})})),c={id:"nst-assa",
checked:(0,r.S)("assaperk")},l=(0,r.V)(c,"assassinate","",(t=>{
...
}),e=(0,r.nt)("h4",{classList:"nst-block-title",innerText:"weapon reload"
}),n=(0,r._)({id:"reload",classList:"nst-outcome"}),o={id:"nst-reloadone",
checked:(0,r.S)("reloadone")},i=(0,r.V)(o,"primary","",(t=>{
const e=t.target.checked;(0,r.I)({reloadone:e})})),a={id:"nst-reloadtwo",
checked:(0,r.S)("reloadtwo")},s=(0,r.V)(a,"secondary","",(t=>{
...
;const n=(0,r.lt)({href:"https://www.tornstats.com/settings/general",
...
})),c="tsapikey",l=(0,r.nt)("input",{id:"nst-"+c,type:"password",
classList:"nst-input m-2",maxLength:19,required:!0,value:(0,r.S)(c)??""
}),u=(0,r.Z)({id:"nst-tslogin",classList:"torn-btn m-2",innerText:"save"})
...
;if(!e)return;e.innerHTML="";const n=(0,r.lt)({
href:"https://www.torn.com/preferences.php#tab=api",target:"_blank",
innerText:"limited",classList:"text-nstyellow font-bold"}),o=(0,r.lt)({
...
i.appendChild(o),i.innerHTML+=" one ad-hoc";const a=(0,r._)({
classList:"nst-api-wrap"}),s=(0,r._)({classList:"nst-block"
}).appendChild((0,r.q)({id:"nst-message",classList:"nst-message"
})),u="apikey",d=(0,r.nt)("input",{id:"nst-"+u,type:"password",
classList:"nst-input m-2",maxLength:16,required:!0,value:(0,r.S)(u)??""
}),m=(0,r.Z)({id:"nst-login",classList:"torn-btn m-2",innerText:"save"
}),f=(0,r.Z)({id:"nst-reset",classList:"torn-btn m-2",innerText:"reset"})
;m.addEventListener("click",c),
f.addEventListener("click",l),a.appendChild(i),a.appendChild(s),
a.appendChild(d),a.appendChild(m),a.appendChild(f),e.appendChild(a)},h=t=>{
const e=t.target,n=e.id,o=e?.closest("#nst-menu-body"),i=e,a=o?.querySelector(".nst-menu-sel"),r=o?.querySelector(".nst-menu-active"),s=o?.querySelector("#"+n.replace(/-li/g,""))
...
const o=t?.parentElement,i="nst-"+e.toLowerCase(),a=i+"-li",s=(0,r.B)({id:a,
classList:"nst-menu-page",innerText:e})
;o.querySelector("#"+i)||o.querySelector("#"+a)||(t.appendChild(s),
...
classList:"nst-menu-body"});o.appendChild((0,r.q)({classList:"nst-logo"
})).appendChild((0,r.nt)("b",{innerText:"NST"}))
;const a=i.appendChild((0,r.nt)("ul",{id:"nst-ul-main",classList:"nst-ul-main"
}))
...
;if(e||!n)return;const o=(0,r.B)({id:"nst-icon",classList:"nst-icon"})
...
return t&&t.__esModule?t:{default:t}};Object.defineProperty(e,"__esModule",{
value:!0}),e.Ht=void 0;const i=o(n(246)),a=n(6185),r=(0,a.k)("XID")
;e.Ht=async t=>{(t=>{const e=t?.closest(".profile-wrapper"),n=(0,a.M)({
...
})(t);const e=await(0,a.Ct)({selection:"/spy/user/"+r})
...
;const i=+t?.[n]?.amount,r=+t?.[n]?.difference,s=r>0?"text-nstgreen":r<0?"text-nstred":"text-nsttorntext",c=(0,
...
innerText:""+(0,a.O)(i+r),classList:"nst-table-cell"})
...
classList:"nst-table-row nst-nodrag text-center"}),r=(0,a.nt)("td",{
classList:"nst-table-cell",colSpan:3}),s=(0,a.lt)({
...
;r.appendChild(s),o.appendChild(r),e.appendChild(o)
...
const o=+t?.[n.toLowerCase()],i=+t?.["delta"+n],r=i>0?"text-nstgreen":i<0?"text-nstred":"text-nsttorntext",s=(0,
...
Object.defineProperty(e,"__esModule",{value:!0}),e.Gt=void 0
;const o=n(6185),i=(0,o.k)("user2ID")??"";e.Gt=async t=>{
...
o.vt)((0,o.U)()-r),m=(0,o.vt)(a-(0,o.U)()),f=(0,o._)({id:"nst-target-status",
...
const i=(0,
o.m)(t.getAttribute("data-time")),a=(0,o.m)(e.getAttribute("data-time")),r=(0,
o.vt)((0,o.U)()-i),s=(0,o.vt)(a-(0,o.U)())
...
4538:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.Wt=void 0
;const o=n(6185);e.Wt=async t=>{
...
})(o),s=Object.values(a).filter((t=>t.name===i))[0]
;n+=parseInt(s?.market_value)*r}));const r=(0,o._)({classList:"nst-trade-value",
innerText:"MV: $"+(0,o.O)(n)});t.insertAdjacentElement("beforebegin",r)}},
6185:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0
}),e.Xt=e.G=e.H=e.Kt=e.kt=e.Jt=e.Ut=e.Yt=e.Rt=e.Ct=e.p=e.u=e.h=e.M=e.Qt=e.Vt=e.Zt=e.te=e.Y=e.V=e.Dt=e.ee=e.ne=e.Mt=e.lt=e.ot=e.B=e.Z=e.q=e._=e.nt=e.oe=e.St=e.vt=e.ie=e.ae=e.O=e.m=e.Ft=e.I=e.S=e.re=e.K=e.U=e.$=e.qt=e.se=e.ce=e.k=e.J=void 0,
e.qfs=e.qft=e.qis=e.qit=e.mugThres=e.minMugPerc=e.le=e.ue=void 0
...
e.ce=()=>window.location.search.match(/\?sid=(\w+)/)?.[1],
e.se=()=>window.location.search.match(/\?step=(\w+)/)?.[1],
e.qt=()=>window.location.pathname.replace(/\//,"").replace(/\.php/,""),
e.$=()=>window.location.hash.replace(/#\/\w+=/g,""),
e.U=()=>Math.round(Date.now()/1e3),
e.K=t=>!t||null==t||0===Object.keys(t).length,e.re=t=>{try{return JSON.parse(t)
...
localStorage.setItem("nstdata",JSON.stringify(n))},e.Ft=t=>{
...
},e.ie=t=>{const n=t.toLowerCase();let o=(0,e.m)(n),i=1
...
},e.St=t=>t.toLowerCase().replace(/ /g,""),e.oe=t=>{const e=t.replace(/ /g,"")
...
e.ne=t=>(0,e.nt)("input",t),e.ee=t=>(0,e.nt)("label",t),e.Dt=t=>{
const{elem:n,title:o,cback:i=(()=>{})}=t,a=(0,e.St)(o),r=(0,e._)({
classList:"nst-box-item"}),s=(0,e.nt)("input",{id:"nst-"+a,type:"text",
...
[a]:o}),i()})),r.appendChild(s),n.appendChild(r),r},e.V=(t,n,o,i)=>{
const a=(0,e._)({classList:"nst-box-item"}),r=(0,e.ne)({...t,type:"checkbox"
}),s={innerText:n,htmlFor:t?.id,title:o},c=(0,e.ee)(s)
;return a.addEventListener("change",i),a.appendChild(r),a.appendChild(c),a
},e.Y=(t,n)=>{const o=(0,e.S)("outcome").toString(),i=(0,e._)({
classList:"nst-box-item"}),a=(0,e.ne)({id:t,type:"radio",name:n,value:t,
checked:o===t}),r=(0,e.ee)({innerText:"hospitalize"===t?"hosp":t,htmlFor:t,
classList:""});return i.appendChild(a),i.appendChild(r),i
},e.te=(t,e)=>document?.getElementById(t)?.appendChild(e),
e.Zt=t=>document.body.appendChild(t),e.Vt=(t,e)=>{
...
;n.querySelector("#nst-arrow").innerHTML=c?r:a,(0,e.I)({[s]:c})};e.Qt=t=>{
...
;const i=(0,e.St)(o),s=i+"Folded",c=(0,
e.S)(s)?"nst-box-content hidden":"nst-box-content",l=(0,e._)({
classList:"nst-box"}),u=(0,e.Qt)(o)
;u.querySelector("#nst-arrow").innerHTML=(0,e.S)(s)?r:a;const d=(0,e._)({
...
const{section:n,select:o,objID:i,api:a}=t,r="https://api.torn.com/"+n+`/${i??""}?selections=${o}`+`&key=${a??(0,
e.S)("apikey")}&comment=nst`,s=await c("GET",r),l=(0,e.Xt)()?s:s?.response
;return void 0!==l?.error?(console.error(l?.error?.error),
[2,10,13,18].includes(l?.error?.code)&&(0,e.Ft)("nstdata"),{status:!1,
error:"broken key"}):{status:!0,...l}},e.Ct=async t=>{
const{selection:n,api:o}=t,i=`https://www.tornstats.com/api/v2/${o??(0,
e.S)("tsapikey")??(0,
e.S)("apikey")}${n}`,a=await c("GET",i),r=(0,e.Xt)()?a:a?.response
;return void 0===r?.status||!1===r?.status?(console.error(r?.message,r),{
status:!1}):r},e.Rt=(t={})=>{const n=(0,e.K)(t)?(0,e.S)("userdata"):t;return{
Nt:n?.player_id,Bt:n?.faction?.faction_id}
},e.Yt=t=>t.toString(16),e.Ut=(t={})=>{const n=(0,e.S)("apikey")
;if(16!==n?.length)return!1
;const i=(0,e.K)(t)?(0,e.S)("userdata"):t,{Nt:a,Bt:r}=(0,e.Rt)(i)
;return!(0,e.K)(i)&&!!(0,o.t)((0,e.Yt)(r),(0,e.Yt)(a))},e.Jt=async()=>{
setTimeout(e.Jt,6e4);const t=(0,e.S)();if((0,e.K)(t))return;const n=t?.apikey
;if(16!==n?.length)return;const o=t?.userdata,a=1e3*(o?.timestamp??0)
;if(Date.now()-3e4<=a)return;const r={section:"user",
...
api:n},s=await(0,e.p)(r);if(!s?.status)return;const{Nt:c,Bt:l}=(0,e.Rt)(s)
;if(void 0===c||void 0===l)return
;const u=s?.merit_perks?.filter((t=>t.includes("mug")))?.join()??0,d=((0,
e.m)(u)/5+20)/400;"player_id"in s&&(0,e.I)({userdata:s}),(0,e.I)({mugperc:d
}),(0,e.Xt)()||(0,i.yt)(o,s)},e.kt=(t="")=>{if(!(0,e.Ut)())return!1
...
e.G=t=>Object.keys(t).map((e=>`${e}=${t[e]}`)).join("&"),e.Xt=()=>void 0!==window.flutter_inappwebview,
e.ue=t=>{
(0,e.Xt)()||(XMLHttpRequest.prototype._original_send=XMLHttpRequest.prototype.send,
...
}catch(t){console.error(t),this._original_send(e)}})},e.le=(t,n)=>{
if((0,e.Xt)())return;const{fetch:o}=unsafeWindow
;unsafeWindow.fetch=async(...e)=>{
const i=await o(...e),a=e[0]?.match(/(?<=step=|sid=)(\w+)/g)?.[0]
;if(!a||a!==n)return i;let r;try{r=await(i?.clone()?.json())}catch(t){
return console.error(e,t),i}return t(r),i}
...
;const c=(t,n,o={},i={})=>new Promise(((a,r)=>{
if((0,e.Xt)())"GET"===t&&PDA_httpGet(n).then((t=>a(JSON.parse(t.responseText)))).catch(r),
"POST"===t&&PDA_httpPost(n,o,i).then((t=>a(JSON.parse(t.responseText)))).catch(r);else{
const e={url:n,method:t,headers:o,data:i,responseType:"json",onload:a,onerror:r}
...
;const r=o?.querySelector(e),s=o?.parentElement?.querySelector(e),c=r||s||!1
...
(0,t.kt)("specialgym")&&((0,
t.le)(q.et,"getInitialGymInfo"),(0,t.le)(q.tt,"train"))},index:()=>{},item:()=>{
(0,t.kt)("equipnoconfirm")&&(0,t.ue)(f.F)},imarket:()=>{
(0,t.kt)("marketnoconfirm")&&(0,t.ue)(w.ht)},loader:()=>{
(0,t.kt)("intercept")&&"attack"===(0,t.ce)()&&(0,t.le)(P.ct,"attackData")},
page:()=>{
(0,t.kt)("rrtimeout")&&"russianRoulette"===(0,t.ce)()&&(0,t.le)(B.At,"russianRouletteData")
},pmarket:()=>{},profiles:()=>{},search:()=>{},trade:()=>{},all:()=>{
(0,t.kt)("leftalign")&&(0,
g.ut)(),(0,t.kt)("minilastaction")&&(0,t.le)(E.gt,"UserMiniProfile")},
nopager:()=>{}},F={amarket:()=>{},bazaar:()=>{
(0,t.kt)("bazaarautoprice")&&(0,o.it)(i.l,"body")},city:()=>{
(0,t.kt)()&&(0,o.it)(T.Et,"body"),
(0,t.kt)("cityfinds")&&(0,o.it)(r.L,"#map .leaflet-marker-pane")},
companies:()=>{
(0,t.kt)("ezmoneydeposit")&&(0,o.it)(p.W,"body"),(0,t.kt)("employeela")&&(0,
o.it)(m.R,".manage-company"),
(0,t.kt)("companyrestock")&&/stock/.test((0,t.$)())&&(0,o.it)(s.j,"body")},
displaycase:()=>{
...
(0,t.kt)("")&&(0,o.it)(z.rt,'#gymroot ul[class*="properties"] [class*="strength"]')
},index:()=>{R[(0,t.Kt)()]()},item:()=>{
...
t.ce)()&&(0,o.it)(k.wt,".giver-cont-wrap"),
(0,t.kt)("fighterino")&&"attack"===(0,
t.ce)()&&(0,o.it)(I.X,'div[class^="playersModelWrap"]')
;const e=window.innerWidth<=784?'#attacker [class^="playerWindow"]':'#defender [class^="playerWindow"]'
;(0,t.kt)("targetstatus")&&"attack"===(0,t.ce)()&&(0,o.it)($.Gt,e)},page:()=>{
(0,
t.kt)("pokername")&&"holdem"===(0,t.ce)()&&(0,o.it)(C.Ot,"div[class^=players]")
},pmarket:()=>{
(0,t.kt)("pointsnoconfirm")&&(0,o.it)(_._t,".users-point-sell"),(0,
t.kt)("pointsmuglight")&&(0,o.it)(x.xt,".users-point-sell")},profiles:()=>{
(0,t.kt)("idtoname")&&(0,
o.it)(b.st,".user-info-value"),(0,t.kt)("statspies")&&(0,
o.it)(A.Ht,".user-info-value")},properties:()=>{
(0,t.kt)("ezmoneydeposit")&&(0,o.it)(p.W,"body")},shops:()=>{
(0,t.kt)("cshopmaxbuy")&&(0,o.it)(c.T,"body")},trade:()=>{
(0,t.kt)("tradevalue")&&(0,o.it)(S.Wt,"#trade-container .trade-cont")},war:()=>{
(0,
t.kt)("warvalue")&&"rankreport"===(0,t.se)()&&(0,o.it)(N.de,'li[class^="members-bonus-row"]')
},all:()=>{
(0,t.kt)("refillreminder")&&(0,o.it)(M.It,'[class*="bar"][class*="energy"]')},
nopager:()=>{}},H={loading:async()=>{
(0,o.it)(e.zt,"#sidebar"),(0,t.Ut)()&&(document.onreadystatechange=()=>H[document.readyState](),
(U.all??U.nopager)(),(U[(0,t.qt)()]??U.nopager)(),(0,t.Jt)())},interactive:()=>{
(0,t.Ut)()&&((F.all??F.nopager)(),(F[(0,t.qt)()]??F.nopager)())},complete:()=>{
(0,t.Ut)()}};H[document.readyState]()})()})();