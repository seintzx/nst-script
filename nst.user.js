...
;var o=n(1601),i=n.n(o),r=n(6314),a=n.n(r)()(i())
...
;const s=a},6314:t=>{t.exports=function(t){var e=[]
...
function T(t,e,n,o,i){if(t.getBoundingClientRect||t===window){var r,a,s,c,l,d,m
;if(t!==window&&t.parentNode&&t!==D()?(a=(r=t.getBoundingClientRect()).top,
s=r.left,
c=r.bottom,l=r.right,d=r.height,m=r.width):(a=0,s=0,c=window.innerHeight,
l=window.innerWidth,
...
;a-=f.top+parseInt(O(i,"border-top-width")),s-=f.left+parseInt(O(i,"border-left-width")),
c=a+r.height,l=s+r.width;break}}while(i=i.parentNode);if(o&&t!==window){
var p=M(i||t),h=p&&p.a,b=p&&p.d;p&&(c=(a/=b)+(d/=b),l=(s/=h)+(m/=h))}return{
top:a,left:s,bottom:c,right:l,width:m,height:d}}}function S(t,e,n){
for(var o=q(t,!0),i=T(t)[e];o;){var r=T(o)[n]
;if(!("top"===n||"left"===n?i>=r:i<=r))return o;if(o===D())break;o=q(o,!1)}
return!1}function I(t,e,n,o){for(var i=0,r=0,a=t.children;r<a.length;){
...
function q(t,e){if(!t||!t.getBoundingClientRect)return D();var n=t,o=!1;do{
...
}}while(n=n.parentNode);return D()}function $(t,e){
...
var R="Sortable"+(new Date).getTime(),H=[],G={initializeByDefault:!0},W={
...
var e=t.sortable,n=t.rootEl,o=t.name,r=t.targetEl,a=t.cloneEl,s=t.toEl,c=t.fromEl,l=t.oldIndex,m=t.newIndex,f=t.oldDraggableIndex,p=t.newDraggableIndex,h=t.originalEvent,b=t.putSortable,g=t.extraEventProperties
...
;W.pluginEvent.bind(Bt)(t,e,i({dragEl:Y,parentEl:V,ghostEl:Z,rootEl:tt,
...
;function Q(t){X(i({putSortable:ut,cloneEl:ot,targetEl:Y,rootEl:tt,oldIndex:rt,
oldDraggableIndex:st,newIndex:at,newDraggableIndex:ct},t))}
var Y,V,Z,tt,et,nt,ot,it,rt,at,st,ct,lt,ut,dt,mt,ft,pt,ht,bt,gt,vt,wt,yt,kt,xt=!1,_t=!1,Lt=[],Ot=!1,Mt=!1,jt=[],Dt=!1,Tt=[],St="undefined"!=typeof document,It=p,Pt=d||u?"cssFloat":"float",Et=St&&!h&&!p&&"draggable"in document.createElement("div"),At=function(){
if(St){if(u)return!1;var t=document.createElement("x")
;return t.style.cssText="pointer-events:auto","auto"===t.style.pointerEvents}
}(),qt=function(t,e){
var n=O(t),o=parseInt(n.width)-parseInt(n.paddingLeft)-parseInt(n.paddingRight)-parseInt(n.borderLeftWidth)-parseInt(n.borderRightWidth),i=I(t,0,e),r=I(t,1,e),a=i&&O(i),s=r&&O(r),c=a&&parseInt(a.marginLeft)+parseInt(a.marginRight)+T(i).width,l=s&&parseInt(s.marginLeft)+parseInt(s.marginRight)+T(r).width
...
},$t=function(t){function e(t,n){return function(o,i,r,a){
...
;d&&(s.top-=d.f,
s.left-=d.e),o.toRect=s,o.thisAnimationDuration&&$(c,s)&&!$(a,s)&&(u.top-s.top)/(u.left-s.left)==(a.top-s.top)/(a.left-s.left)&&(n=function(t,e,n,o){
return Math.sqrt(Math.pow(e.top-t.top,2)+Math.pow(e.left-t.left,2))/Math.sqrt(Math.pow(e.top-n.top,2)+Math.pow(e.left-n.left,2))*o.animation
}(u,c,l,e.options)),
$(s,a)||(o.prevFromRect=a,o.prevToRect=s,n||(n=e.options.animation),
e.animate(o,u,s,n)),
...
c.relatedRect=r||T(e),
c.willInsertAfter=s,c.originalEvent=a,t.dispatchEvent(c),f&&(l=f.call(m,c,a)),l}
...
;o.checked&&Tt.push(o)}
}(n),!Y&&!(/mousedown|pointerdown/.test(r)&&0!==t.button||o.disabled)&&!c.isContentEditable&&(this.nativeDraggable||!f||!s||"SELECT"!==s.tagName.toUpperCase())&&!((s=k(s,o.draggable,n,!1))&&s.animated||nt===s)){
...
var e=this.options,n=e.fallbackTolerance,o=e.fallbackOffset,i=t.touches?t.touches[0]:t,r=Z&&M(Z,!0),a=Z&&r&&r.a,s=Z&&r&&r.d,c=It&&kt&&A(kt),l=(i.clientX-dt.clientX+o.x)/(a||1)+(c?c[0]-jt[0]:0)/(a||1),u=(i.clientY-dt.clientY+o.y)/(s||1)+(c?c[1]-jt[1]:0)/(s||1)
;if(!Bt.active&&!xt){
if(n&&Math.max(Math.abs(i.clientX-this._lastX),Math.abs(i.clientY-this._lastY))<n)return
;this._onDragStart(t,!0)}if(Z){r?(r.e+=l-(ft||0),r.f+=u-(pt||0)):r={a:1,b:0,c:0,
d:1,e:l,f:u}
;var d="matrix(".concat(r.a,",").concat(r.b,",").concat(r.c,",").concat(r.d,",").concat(r.e,",").concat(r.f,")")
;O(Z,"webkitTransform",d),
O(Z,"mozTransform",d),O(Z,"msTransform",d),O(Z,"transform",d),ft=l,pt=u,mt=i}
...
var e,n,o,r,a=this.el,s=t.target,c=this.options,l=c.group,u=Bt.active,d=lt===l,m=c.sort,f=ut||u,p=this,h=!1
;if(!Dt){
...
;if(_t=!1,
u&&!c.disabled&&(d?m||(o=V!==tt):ut===this||(this.lastPutMode=lt.checkPull(this,u,Y,t))&&l.checkPut(this,u,Y,t))){
...
var o=T(I(n.el,0,n.options,!0)),i=F(n.el,n.options,Z)
...
;if(!a)if(s&&yt<l*i){
if(!Ot&&(1===wt?c>u+l*r/2:c<d-l*r/2)&&(Ot=!0),Ot)m=!0;else if(1===wt?c<u+yt:c>d-yt)return-wt
}else if(c>u+l*(1-i)/2&&c<d-l*(1-i)/2)return function(t){return E(Y)<E(t)?1:-1
}(e);return(m=m||a)&&(c<u+l*r/2||c>d-l*r/2)?c>u+l/2?1:-1:0
...
;vt=s,wt=v;var q=s.nextElementSibling,$=!1,z=Ft(tt,a,Y,e,s,n,t,$=1===v)
;if(!1!==z)return 1!==z&&-1!==z||($=1===z),
Dt=!0,setTimeout(Ht,30),U(),$&&!q?a.appendChild(Y):s.parentNode.insertBefore(Y,$?q:s),
...
canSort:m,fromSortable:f,target:s,completed:B,onMove:function(n,o){
...
f._ignoreWhileAnimating=null)),(s===Y&&!Y.animated||s===a&&!s.animated)&&(vt=null),
...
J("nulling",this),
tt=Y=V=Z=et=ot=nt=it=dt=mt=gt=at=ct=rt=st=vt=wt=ut=lt=Bt.dragged=Bt.ghost=Bt.clone=Bt.active=null,
...
closest:k,toggleClass:L,clone:N,index:E,nextTick:Wt,cancelNextTick:Xt,
detectDirection:qt,getChild:I},Bt.get=function(t){return t[R]
},Bt.mount=function(){
...
;Jt!==n&&(Jt=n,ne(),Kt=e.scroll,i=e.scrollFn,!0===Kt&&(Kt=q(n,!0)));var d=0,m=Kt
;do{
var f=m,p=T(f),h=p.top,b=p.bottom,g=p.left,v=p.right,w=p.width,y=p.height,k=void 0,x=void 0,_=f.scrollWidth,L=f.scrollHeight,M=O(f),j=f.scrollLeft,S=f.scrollTop
...
;var o=T(me,!1,!0,!0);he.forEach((function(t){t!==me&&U(t,o)})),ve=!0,ge=!0}
...
var c=T(me,!1,!0,!0);he.forEach((function(t){t!==me&&(U(t,c),r.appendChild(t))
...
})),o.options.animation&&!n&&o.multiDrag.isMultiDrag){fe=s({},e);var i=M(me,!0)
...
u[b]?o.insertBefore(t,u[b]):o.appendChild(t),b++})),a===E(me))){var g=!1
...
if(!this.options.bubbleScroll||q(r,!0)===D())return void ne()
...
;var o=n(5072),i=n.n(o),r=n(7825),a=n.n(r),s=n(7659),c=n.n(s),l=n(5056),u=n.n(l),d=n(540),m=n.n(d),f=n(1113),p=n.n(f),h=n(6906),b={}
...
;r[l]=u+1;var m=n(d),f={css:c[1],media:c[2],sourceMap:c[3],supports:c[4],
...
;0===e[u].references&&(e[u].updater(),e.splice(u,1))}r=c}}},7659:t=>{var e={}
...
innerText:`Total: $${(0,o.L)(i)} - MV: $${(0,o.L)(r)}`})
...
;const o=n(6185);e.O=async t=>{
const e=Array.from(t.querySelectorAll('[class*="torn-item"]'))
;if(0===e.length)return;const n=await(0,o.p)({section:"torn",select:"items"})
;if(!n?.status)return;const i=n?.items,r={};e.forEach((t=>{
const e=t.getAttribute("src"),n=(0,o.m)(e);r[n]={name:i[n]?.name,
type:i[n]?.type,value:+i[n]?.market_value,count:n in r?+r[n]?.count+1:1
},t.setAttribute("src",e.replace("small","large")),
t.classList.add("nst-city-item")}))
;const a=Object.values(r).reduce(((t,e)=>t+e.value*e.count),0),s=Object.values(r).map((t=>`${t.name} x${t.count}`)).join(", ").replace(/, $/,"."),c=(0,
...
innerText:"Worth: $"+(0,o.L)(a)})),l.appendChild((0,o._)({
classList:"nst-findslist",innerText:""+s})),c.appendChild(l)}},4051:(t,e,n)=>{
...
;e.D=()=>{document.addEventListener("dblclick",(t=>{const e=t?.target
...
;e.T=()=>{console.log("nst - init default start")
...
onpage:"trade"}},assaperk:!1,hold:!1,jailscore:1e4,lastnoti:1,mugperc:.075,
...
;e.P=t=>{
0!==(0,o.q)().match(/manage/g).length&&t&&Array.from(t.children).forEach((t=>{
const e=t.getAttribute("itemid"),n=t.querySelector(".name .desc")
;n&&e&&n.insertAdjacentElement("afterBegin",(0,o.$)({classList:"text-nstmain",
...
e.lastElementChild.removeAttribute("class");const r=(0,o._)({
classList:"nst-box-header"});r.appendChild((0,o.$)({classList:"nst-box-title"
})).appendChild((0,o.$)({id:"nst-box-title",innerText:"Effective Stats"
})),e.appendChild(r),Object.keys(i).forEach((t=>{const n=(0,o.U)({tabIndex:0,
ariaLabel:`${t} ${(0,o.L)(i[t])}`}),r=(0,o.$)({classList:"divider",
innerHTML:`<span>${t}</span>`}),a=(0,o.$)({classList:"desc",
...
;s&&a.classList.add(s)}))};e.B=async t=>{if(!t)return;const e=await(0,o.p)({
...
const{step:e,action:n,confirm:i}=(0,o.R)(t)
;return"actionForm"!==e||"equip"!==n||1===i?(0,o.H)({...(0,o.R)(t)}):(0,o.H)({
...(0,o.R)(t),confirm:1})}},9355:(t,e)=>{Object.defineProperty(e,"__esModule",{
value:!0}),e.G=void 0;const n=t=>{let e=0;t.addEventListener("click",(()=>{
if(1!=e++)return
...
Object.defineProperty(e,"__esModule",{value:!0}),e.W=void 0
;const o=n(6185),i=(0,
o.k)("user2ID")??"",r=(0,o.S)(),{reloadone:a,reloadtwo:s,weapon:c}=r
...
const t=u?.attackerAmmoStatus,e=u?.currentClips?.[0],n=u?.attackerItems[1]?.item[0]?.currentBonuses,i=u?.attackerItems[2]?.item[0]?.currentBonuses,r=u?.currentMove,l={
primary:()=>{
...
;if(0===r&&(0,o.S)()?.assaperk){if("Assassinate"===n?.[72]?.title)return 1
...
;const n=f(),i=(g[n]??g.error)();if((0,o.X)(i))return
;const r="https://www.torn.com/loader.php?sid=attackData&mode=json&rfcv="+(0,
o.K)(),a={method:"POST",headers:{"x-requested-with":"XMLHttpRequest"},
...
;e.W=t=>(t=>{const e=(0,o.M)({title:"fighterino",element:t})
...
;(0,o.I)({outcome:e})}))
;const n=(0,o.J)("leave","outcome"),i=(0,o.J)("mug","outcome"),r=(0,
o.J)("hospitalize","outcome")
;e.appendChild(n),e.appendChild(i),e.appendChild(r),t.appendChild(e);const a=(0,
o._)({classList:"nst-outcome"}),s={id:"nst-hold",checked:(0,o.S)("hold")
},c=(0,o.Y)(s,"hold","",(t=>{const e=t.target.checked;(0,o.I)({hold:e})})),l={
id:"nst-temp",checked:(0,o.S)("temp")},u=(0,o.Y)(l,"use temp first","",(t=>{
const e=t.target.checked;(0,o.I)({temp:e})})),d={id:"nst-assa",
checked:(0,o.S)("assaperk")},m=(0,o.Y)(d,"assassinate","",(t=>{
const e=t.target.checked;(0,o.I)({assaperk:e})}))
;return a.appendChild(c),a.appendChild(u),a.appendChild(m),t.appendChild(a),t
})(),i=(0,o._)({classList:"nst-box-column"}),r=(0,o.V)({id:"nst-fighteroo",
...
;const o=n(6185),i=n(9607),r={},a={balboas:{req:["defense","dexterity"],
...
const n=(0,o._)({id:"nst-spgym-"+t}),i=(0,o.et)("select",{
id:`nst-spgym-${t}-sel`,classList:"nst-spgym-sel"})
;Object.entries(a).forEach((([e,n])=>{const r={value:e,innerText:n.desc
},a=(0,o.et)("option",r)
;a.selected=(0,o.S)("spgym"+t)?.toString()===e,i.appendChild(a)
})),i.addEventListener("change",(t=>{
const e=t?.target,n=e.id.replace(/nst-/g,"").replace(/-sel/g,"").replace(/-/g,"")
;(0,o.I)({[n]:e.value})}));const r=(0,o.nt)({id:`nst-spgym-${t}-msg`,
classList:"nst-spgym-msg"});n.appendChild(i),n.appendChild(r),e.appendChild(n)
}))},c=()=>{["one","two"].forEach((t=>{
const e=document.querySelector(`#nst-spgym-${t}-sel`),n=document.querySelector(`#nst-spgym-${t}-msg`),i=e.value,s=Object.keys(r).filter((t=>a[i].req.includes(t))).reduce(((t,e)=>({
...t,[e]:r[e]
})),{}),c=Object.keys(r).filter((t=>!a[i].req.includes(t))).reduce(((t,e)=>({
...t,[e]:r[e]
...
o.L)(l/1.25-u):(0,
o.L)(1.25*u-l),m=Object.keys(s).length>1?Object.keys(l>=1.25*u?c:s).join(" and "):(l>=1.25*u?Object.keys(c).filter((t=>r[t]===u)):Object.keys(s)).join(""),f=`Gain ${l>=1.25*u?"no more than":""} ${d} ${m}`
;n.innerText=f}))};e.tt=t=>{
Object.entries(t?.stats).forEach((([t,e])=>r[t]=(0,o.m)(e?.value))),
(0,i.ot)(s,"#gymroot"),c()},e.Z=t=>{r[t?.stat?.name]=(0,o.m)(t?.stat?.newValue),
c()}},6703:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0
}),e.it=void 0;const o=n(6185);e.it=t=>{t=t.closest('ul[class*="properties"]')
;const e=(0,
o.S)("userdata"),n=[...e.faction_perks,...e.job_perks,...e.property_perks,...e.education_perks,...e.book_perks].filter((t=>t.includes("gym gains")))
...
o.m)(e.match(/\d+/))),0),s=(0,o._)({id:"nst-steadfast-"+i,
...
;const o=n(6185);e.st=t=>{if(!("currentFightStatistics"in t))return
...
;e.innerHTML="",e.appendChild((0,o.ct)({classList:"nst-intercept",
...
Object.defineProperty(e,"__esModule",{value:!0}),e.ut=void 0;const o=n(6185)
;e.ut=t=>{if(!t)return
;const e=t?.parentElement,n=(0,o.S)("userdata"),i=(0,o.m)(n?.networth?.total),r=(0,
o.m)(n?.personalstats?.networth),a=Math.round(i-r),s=a>0?"text-nstgreen":a<0?"text-nstred":"",c=`<b class='${s}'>$${(0,
o.L)(a)}</b>`,l=(0,o.U)({classList:"last",tabIndex:0,
ariaLabel:"Live NW: "+(0,o.L)(i)}),u=(0,o.$)({classList:"divider",
innerHTML:"<span>Live Networth</span>"}),d=(0,o.$)({
classList:`desc ${s} font-bold`,innerText:` $${(0,o.L)(i)} `,
style:"margin-left: 3px; margin-right: 3px;"}),m=(0,o.et)("i",{
...
}),e.dt=e.ft=void 0;const o=n(6185);e.ft=t=>{const{step:e}=(0,o.R)(t)
;if("buyItem"!==e)return(0,o.H)({...(0,o.R)(t)})
;const n=(0,o.q)()?.match(/(shop|market)/g)?.[0],i={market:t=>{
const e=t.replace("step=buyItem","step=buyItemConfirm");return(0,o.H)({
...(0,o.R)(e),item:0})},shop:t=>{
const e=t.replace("step=buyItem","step=buyItemConfirm");return(0,o.H)({
...(0,o.R)(e),item:0})},noloc:t=>(0,o.H)({...(0,o.R)(t)})}
;return(i[n]??i.noloc)(t)},e.dt=t=>{new MutationObserver((e=>{e.forEach((e=>{
const n=(0,o.q)()?.match(/(shop|market)/g)?.[0],i=".items > li.show-item-info"
...
}),e.bt=void 0;const o=n(6185),i=n(9607);let r;const a=t=>{
t?.querySelector("#nst-lastaction")||t.appendChild((0,o._)({id:"nst-lastaction",
innerText:"last action: "+r}))};e.bt=t=>{
r=(0,o.gt)(+t.user.lastAction.seconds).trim(),
(0,i.ot)(a,'#profile-mini-root [class*="profile-mini-_userProfileWrapper"]')}},
...
o.$)({innerHTML:"<br/><br/><b>todo:</b> "+r,classList:"text-nstmain"})
...
}),e.wt=void 0;const o=n(6185),i=(t,e)=>{GM.notification({title:t,text:e})}
;e.wt=()=>{const t=(0,o.S)()?.lastnoti
;t&&(Date.now()-6e4<=t||((0,o.yt)("drugnoti")&&(()=>{
const t=+(0,o.S)("userdata")?.cooldowns?.drug
;t>=60||0===t||i("NST: Drug Cooldown","Your drug cooldown expires in "+(0,
o.gt)(t))})(),(0,o.yt)("travnoti")&&(()=>{
const t=(0,o.S)("userdata")?.travel,e=+t?.time_left
;e>=300||0===e||i("NST: Travel",`${t?.destination} - Landing in ${(0,o.gt)(e)}`)
})(),(0,o.yt)("hospnoti")&&(()=>{
const t=+(0,o.S)("userdata")?.states?.hospital_timestamp,e=Math.round(t-Date.now()/1e3)
;e>=300||e<=0||i("NST: Hospital","Out of hosp in "+(0,o.gt)(e))})(),(0,o.I)({
lastnoti:Date.now()})))}},3243:(t,e,n)=>{Object.defineProperty(e,"__esModule",{
value:!0}),e.kt=void 0;const o=n(6185),i=t=>{
...
};e.kt=t=>{new MutationObserver((t=>{t.forEach((t=>{
Array.from(t.addedNodes).forEach((t=>{
...
}},8601:(t,e)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.xt=void 0
...
;t.setAttribute("href",e)};e.xt=t=>{new MutationObserver((t=>{t.forEach((t=>{
Array.from(t.addedNodes).forEach((t=>{
...
value:!0}),e._t=void 0;const i=o(n(246)),r=n(6185),a=t=>{t.stopPropagation()
...
;const i="https://www.torn.com/item.php?rfcv="+(0,r.K)(),a={method:"POST",
headers:{"x-requested-with":"XMLHttpRequest"},body:new URLSearchParams(o)
},s=await(await fetch(i,{...a})).json(),c=s.links??{},l=s.text??{},u=(0,r._)({})
;u.appendChild((0,r.nt)({innerHTML:l}));const d=(0,r.nt)({})
...
;Object.keys(n).includes(e)&&(delete n[e],(0,r.I)({[r.qfs]:n}),c())},c=()=>{
const t=document.getElementById("nst-"+r.qfs);if(t){
for(;t.lastChild;)t.removeChild(t.lastChild)
;Object.values((0,r.S)(r.qfs)).forEach((e=>((t,e)=>{
const{id:n,name:o,quantity:i}=t,c=`/images/items/${n}/medium.png`,l=(0,r._)({
classList:"nst-box-btn-div"})
;l.setAttribute("data-itemID",n),l.setAttribute("data-qty",i);const u=(0,r.V)({
id:"nst-quick-use",classList:"nst-box-button"}),d=(0,r.Lt)({src:c,alt:o,
classList:"nst-box-img"}),m=(0,r.$)({id:"nst-quick-name",innerText:o
}),f=(0,r.$)({id:"nst-quick-close",classList:"nst-box-close",innerText:"✕"})
...
;e.forEach((t=>n[t].order=e.indexOf(t))),(0,r.I)({[r.qfs]:n})}}})}},l=t=>{
...
;s[i]={id:i,order:l+1,name:a},(0,r.I)({[r.qfs]:s}),c()},u={box:t=>{
const e=(0,r.M)({title:r.qft,element:t});e?.parentElement?.appendChild((0,r._)({
...
},nopager:()=>{}};e._t=t=>{new MutationObserver((t=>{t.forEach((t=>{
...
;const a="https://www.torn.com/item.php?rfcv="+(0,r.K)(),s={method:"POST",
...
;if(!o)return;const i="https://www.torn.com/item.php?rfcv="+(0,r.K)(),a={
method:"POST",headers:{"x-requested-with":"XMLHttpRequest"},
body:new URLSearchParams(o)},s=await(await fetch(i,{...a
})).json(),c=s.links??{},l=s.text??{},u=(0,r._)({});u.appendChild((0,r.nt)({
innerHTML:l}));const d=(0,r.nt)({});Object.values(c).forEach((t=>{
const e=(0,r.ct)({classList:"t-blue h m-left10 "+t.class,href:t.url,
...
;Object.keys(n).includes(e)&&(delete n[e],(0,r.I)({[r.qis]:n}),u())},u=()=>{
const t=document.getElementById("nst-"+r.qis);if(t){
for(;t.lastChild;)t.removeChild(t.lastChild)
;Object.values((0,r.S)(r.qis)).forEach((e=>((t,e)=>{
const{id:n,name:o,quantity:i}=t,a=`/images/items/${n}/medium.png`,s=(0,r._)({
classList:"nst-box-btn-div"})
;s.setAttribute("data-itemID",n),s.setAttribute("data-qty",i);const u=(0,r.V)({
id:"nst-quick-use",classList:"nst-box-button"}),d=(0,r.Lt)({src:a,alt:o,
classList:"nst-box-img"}),m=(0,r.$)({id:"nst-quick-name",innerText:o
}),f=(0,r.$)({id:"nst-quick-close",classList:"nst-box-close",innerText:"✕"})
;u.addEventListener("click",c),
f.addEventListener("click",l),u.appendChild(d),u.appendChild(m),
u.appendChild(f),s.appendChild(u),e.appendChild(s)})(e,t))),new i.default(t,{
animation:150,dataIdAttr:"data-itemid",store:{get:()=>{const t=(0,r.S)(r.qis)
;return Object.entries(t).sort(((t,e)=>t[1].order-e[1].order)).map((t=>t[0]))},
set:t=>{const e=t.toArray(),n=(0,r.S)(r.qis)
;e.forEach((t=>n[t].order=e.indexOf(t))),(0,r.I)({[r.qis]:n})}}})}},d=t=>{
...
;if(!(n&&o&&a&&s.includes(a)))return;const m=(0,r.S)(r.qis)
...
;m[o]={id:o,order:f+1,name:d,quantity:i,category:a,strangeID:c},(0,r.I)({
[r.qis]:m}),u()};e.Ot=t=>{
const e=t?.parentElement,n=e?.querySelector("div.equipped-items-wrap"),o=(0,
r.M)({title:r.qit,element:n});o?.parentElement?.appendChild((0,r._)({
...
Object.defineProperty(e,"__esModule",{value:!0}),e.Mt=void 0
...
;if(!c||!l)return
;const u=RegExp(r+"$","g"),d=RegExp(r+"1$","g"),m=a?l.replace(u,r+"1"):l.replace(d,r)
...
;t.setAttribute("title","score: "+(0,o.L)(a));const s=a>e&&0!==e
...
;Array.from(i).forEach((t=>r(t)))};e.Mt=t=>{(t=>{const e=(0,o.M)({
title:"Quick Jail",element:t?.parentElement}),n=(0,o._)({
classList:"nst-box-column"}),i=(0,o._)({classList:"nst-box-column"})
;e.appendChild(n),e.appendChild(i),(0,o.jt)({elem:n,title:"Jail Score",
...
;i.appendChild((0,o.Y)(l,s,"",a));const u="Quick Bail",d=(0,o.Dt)(u),m={
id:"nst-"+d,type:"checkbox",value:d,checked:(0,o.S)(d)??!1}
;i.appendChild((0,o.Y)(m,u,"",a))})(t),new MutationObserver((t=>{t.forEach((t=>{
...
;r||s?.classList.add(l)}))}},8292:(t,e)=>{Object.defineProperty(e,"__esModule",{
value:!0}),e.St=void 0,e.St=t=>t?.remove()},263:(t,e)=>{
...
Object.defineProperty(e,"__esModule",{value:!0}),e.Pt=void 0;const o=n(6185),i={
...
i.classList.add("nst-edit"),t?.parentElement?.appendChild((0,o.$)({innerText:n
})),t?.parentElement?.appendChild((0,o.et)("br",{}))}))}))}))
...
;e.Pt=t=>i[(0,o.Et)()](t)},2268:function(t,e,n){
var o=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{
default:t}};Object.defineProperty(e,"__esModule",{value:!0}),e.At=void 0
...
void(t.innerText="Invalid Key Length");const o=await(0,a.qt)({api:n,selection:""
})
;if(!o?.status)return t.classList.remove("text-nstgreen"),void(t.innerText="Invalid Key")
;(0,a.I)({tsapikey:n}),t.classList.add("text-nstgreen"),t.innerText="Key Saved"
},c=async()=>{
...
api:n},i=await(0,a.p)(o);return i?.status?((0,a.I)({apikey:n
}),(0,a.$t)(i)?((0,a.I)({userdata:i
}),t.classList.add("text-nstgreen"),t.innerText="Login Successful",
void u()):((0,
a.zt)("nstdata"),t.classList.remove("text-nstgreen"),void(t.innerText="You are not allowed, contact seintz[2460991]"))):(t.classList.remove("text-nstgreen"),
void(t.innerText=i?.error))},l=async()=>{
confirm("Are you sure you want to reset?")&&((0,
a.zt)("nstdata"),window.location.reload())},u=()=>{if(!(0,a.$t)())return
;(0,r.T)();const t=document.querySelector("#nst-ul-main")
...
t)),{}),r=(0,a._)({classList:"nst-script-block"})
;Object.entries(i).forEach((([t,e])=>{const n=e?.name,o=(0,a.Dt)(t),i={
id:"nst-"+o,value:o,checked:e?.enabled??!1
},s=(0,a.Y)(i,n,e.description.toLowerCase(),(t=>{
const e=t.target,n=(0,a.S)("script");n[e.value].enabled=e.checked,(0,a.I)({
script:n})}));r.appendChild(s)})),e.appendChild(r)},m=t=>{
const e=document.getElementById(t);e&&(e.innerHTML="",e.appendChild((()=>{
const t=(0,a._)({classList:"nst-block"}),e=(0,a.et)("h4",{
classList:"nst-block-title",innerText:"mug threshold"});return t.appendChild(e),
(0,a.jt)({elem:t,title:"mug threshold"}),t})()),e.appendChild((()=>{
const t=(0,a._)({classList:"nst-block"}),e=(0,a.et)("h4",{
classList:"nst-block-title",innerText:"default outcome"}),n=(0,a._)({
id:"outcome",classList:"nst-outcome"});n.addEventListener("change",(t=>{
const e=t.target.id;(0,a.I)({outcome:e})}))
;const o=(0,a.J)("leave","outcome"),i=(0,
a.J)("mug","outcome"),r=(0,a.J)("hospitalize","outcome"),s={id:"nst-hold",
checked:(0,a.S)("hold")},c=(0,a.Y)(s,"hold","",(t=>{const e=t.target.checked;(0,
a.I)({hold:e})}))
;return n.appendChild(o),n.appendChild(i),n.appendChild(r),t.appendChild(e),
t.appendChild(n),t.appendChild(c),t})()),e.appendChild((()=>{
const t=(0,a.S)("weapon"),e=(0,a._)({classList:"nst-block"}),n=(0,a.et)("h4",{
classList:"nst-block-title",innerText:"weapon order"}),o=(0,a._)({id:"weapon"})
;Object.keys(t).forEach((t=>{const e=(0,a._)({id:t,classList:"list-group-item",
...
;e.forEach((t=>n[t]=e.indexOf(t))),(0,a.I)({weapon:n})}}});const r={
id:"nst-temp",checked:(0,a.S)("temp")},s=(0,a.Y)(r,"use temp first","",(t=>{
const e=t.target.checked;(0,a.I)({temp:e})})),c={id:"nst-assa",
checked:(0,a.S)("assaperk")},l=(0,a.Y)(c,"assassinate","",(t=>{
const e=t.target.checked;(0,a.I)({assaperk:e})}))
;return e.appendChild(n),e.appendChild(o),e.appendChild(s),e.appendChild(l),e
})()),e.appendChild((()=>{const t=(0,a._)({classList:"nst-block"
}),e=(0,a.et)("h4",{classList:"nst-block-title",innerText:"weapon reload"
}),n=(0,a._)({id:"reload",classList:"nst-outcome"}),o={id:"nst-reloadone",
checked:(0,a.S)("reloadone")},i=(0,a.Y)(o,"primary","",(t=>{
const e=t.target.checked;(0,a.I)({reloadone:e})})),r={id:"nst-reloadtwo",
checked:(0,a.S)("reloadtwo")},s=(0,a.Y)(r,"secondary","",(t=>{
const e=t.target.checked;(0,a.I)({reloadtwo:e})}))
...
}),o=(0,a._)({classList:"text-base"})
;o.innerHTML="Create your TS key ",o.appendChild(n);const i=(0,a._)({
classList:"nst-api-wrap"}),r=(0,a._)({classList:"nst-block"
}).appendChild((0,a.$)({id:"nst-ts-message",classList:"nst-message"
})),c="tsapikey",l=(0,a.et)("input",{id:"nst-"+c,type:"password",
classList:"nst-input m-2",maxLength:19,required:!0,value:(0,a.S)(c)??""
}),u=(0,a.V)({id:"nst-tslogin",classList:"torn-btn m-2",innerText:"save"})
...
;if(!e)return;e.innerHTML="";const n=(0,a.ct)({
...
}),i=(0,a._)({classList:"text-base"})
;i.innerHTML="Enter a ",i.appendChild(n),i.innerHTML+=" apikey or ",
i.appendChild(o),i.innerHTML+=" one ad-hoc";const r=(0,a._)({
classList:"nst-api-wrap"}),s=(0,a._)({classList:"nst-block"
}).appendChild((0,a.$)({id:"nst-message",classList:"nst-message"
})),u="apikey",d=(0,a.et)("input",{id:"nst-"+u,type:"password",
classList:"nst-input m-2",maxLength:16,required:!0,value:(0,a.S)(u)??""
}),m=(0,a.V)({id:"nst-login",classList:"torn-btn m-2",innerText:"save"
}),f=(0,a.V)({id:"nst-reset",classList:"torn-btn m-2",innerText:"reset"})
;m.addEventListener("click",c),
f.addEventListener("click",l),r.appendChild(i),r.appendChild(s),
r.appendChild(d),r.appendChild(m),r.appendChild(f),e.appendChild(r)},h=t=>{
...
const o=t?.parentElement,i="nst-"+e.toLowerCase(),r=i+"-li",s=(0,a.U)({id:r,
classList:"nst-menu-page",innerText:e})
;o.querySelector("#"+i)||o.querySelector("#"+r)||(t.appendChild(s),
o.appendChild((0,a._)({id:i,classList:"nst-menu-item hidden"
})),s.addEventListener("click",h),n(i))},g=()=>{
...
const e=(0,a._)({id:"nst-menu",classList:"nst-menu"}),n=(0,a._)({
id:"nst-menu-wrap",classList:"nst-menu-wrap "}),o=(0,a._)({id:"nst-menu-title",
classList:"nst-menu-title"}),i=(0,a._)({id:"nst-menu-body",
classList:"nst-menu-body"});o.appendChild((0,a.$)({classList:"nst-logo"
})).appendChild((0,a.et)("b",{innerText:"NST"}))
;const r=i.appendChild((0,a.et)("ul",{id:"nst-ul-main",classList:"nst-ul-main"
}))
...
;if(e||!n)return;const o=(0,a.U)({id:"nst-icon",classList:"nst-icon"})
...
return t&&t.__esModule?t:{default:t}};Object.defineProperty(e,"__esModule",{
value:!0}),e.Ct=void 0;const i=o(n(246)),r=n(6185),a=(0,r.k)("XID")
;e.Ct=async t=>{(t=>{const e=t?.closest(".profile-wrapper"),n=(0,r.M)({
title:"Stat Spies",element:e}),o=(0,r._)({id:"nst-compare",
classList:"nst-box-column"}),i=(0,r._)({id:"nst-spies",
classList:"nst-box-column item-start"});o.appendChild((0,r.et)("table",{
id:"nst-compare-table",classList:"nst-table"})),i.appendChild((0,r.et)("table",{
id:"nst-spies-table",classList:"nst-table"})),i.appendChild((0,r.et)("table",{
id:"nst-avg-table",classList:"nst-table"})),n.appendChild(o),n.appendChild(i)
})(t);const e=await(0,r.qt)({selection:"/spy/user/"+a})
;e?.status&&(e?.compare?.status&&(t=>{
const e=document.getElementById("nst-compare-table"),n=(0,r.et)("tr",{
classList:"nst-table-row text-center nst-nodrag"})
;e.appendChild(n),["Stat","Them","You"].forEach((t=>n.appendChild((0,
r.et)("th",{innerText:t,classList:"nst-table-cell nst-table-cell-head"
})))),Object.keys(t).forEach((n=>{const o=(0,r.et)("tr",{
...
r.et)("td",{innerText:""+n,classList:"nst-table-cell text-nsttorntext"
}),l=(0,r.et)("td",{innerText:""+(0,r.L)(i),
classList:"nst-table-cell text-nsttorntext"}),u=(0,r.et)("td",{
innerText:""+(0,r.L)(i+a),classList:"nst-table-cell"})
...
get:()=>(0,r.S)("tscompare")??Object.keys(t),set:t=>(0,r.I)({
tscompare:t.toArray()})}});const o=(0,r.et)("tr",{
classList:"nst-table-row nst-nodrag text-center"}),a=(0,r.et)("td",{
...
const e=document.getElementById("nst-spies-table"),n=(0,r.et)("tr",{
...
r.et)("tr",{classList:"nst-table-row"}),c=(0,r.et)("td",{innerText:""+n,
classList:"nst-table-cell text-nsttorntext"}),l=(0,r.et)("td",{
innerText:""+(0,r.L)(o),classList:"nst-table-cell text-nsttorntext"
}),u=(0,r.et)("td",{innerText:""+(0,r.L)(o+i),classList:"nst-table-cell"})
;u.classList.add(a),
s.appendChild(c),s.appendChild(l),s.appendChild(u),e.appendChild(s)}))
;const o=(0,r.et)("tr",{classList:"nst-table-row nst-nodrag text-center"}),i=(0,
r.et)("td",{classList:"nst-table-cell text-nsttorntext",colSpan:3,
innerText:"Last Update: "+(t?.difference??"")})
;o.appendChild(i),e.appendChild(o)})(e?.spy))}},8990:(t,e,n)=>{
Object.defineProperty(e,"__esModule",{value:!0}),e.Nt=void 0
;const o=n(6185),i=(0,o.k)("user2ID")??"";e.Nt=async t=>{
...
o.gt)(Date.now()/1e3-a),m=(0,o.gt)(r-Date.now()/1e3),f=(0,o._)({
id:"nst-target-status",classList:"nst-status-wrap"}),p=(0,o._)({
classList:"nst-status-middle"}),h=(0,o._)({classList:"nst-status-middle"}),b=(0,
o._)({id:"nst-status-life",classList:"nst-status-item",
innerText:`life: ${Math.floor(c/s*100)}%`}),g=(0,o._)({id:"nst-status-la",
classList:"nst-status-item",innerText:"la: "+d});g.setAttribute("data-time",a)
;const v=(0,o._)({id:"nst-status-hosp",classList:"nst-status-item",
innerText:"hosp: "+(""===m?"OUT":m)});v.setAttribute("data-time",r)
;const w=(0,o._)({id:"nst-status-wall",classList:"nst-status-item",
innerText:"wall: "+(u?"ON":"OFF")}),y=(0,o._)({id:"nst-status-rev",
...
const i=(0,o.m)(t.getAttribute("data-time")),r=(0,
o.m)(e.getAttribute("data-time")),a=(0,
o.gt)(Date.now()/1e3-i),s=(0,o.gt)(r-Date.now()/1e3)
...
4538:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.Ut=void 0
;const o=n(6185);e.Ut=async t=>{
...
;n+=parseInt(s?.market_value)*a}));const a=(0,o._)({classList:"nst-trade-value",
innerText:"MV: $"+(0,o.L)(n)});t.insertAdjacentElement("beforebegin",a)}},
6185:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0
}),e.Bt=e.Ft=e.Rt=e.H=e.R=e.Ht=e.yt=e.Gt=e.$t=e.Wt=e.Xt=e.qt=e.p=e.u=e.h=e.M=e.Kt=e.Jt=e.Qt=e.Yt=e.J=e.Y=e.jt=e.Vt=e.Zt=e.Lt=e.ct=e.nt=e.U=e.V=e.$=e._=e.et=e.te=e.Dt=e.gt=e.ee=e.ne=e.L=e.m=e.zt=e.I=e.S=e.oe=e.X=e.q=e.Et=e.ie=e.k=e.K=void 0,
e.qfs=e.qft=e.qis=e.qit=e.mugThres=e.minMugPerc=void 0;const o=n(3376),i=n(8689)
;e.K=()=>document.cookie.split("; ").find((t=>t.startsWith("rfc_v"))).split("=")[1],
...
e.q=()=>window.location.hash.replace(/#\/\w+=/g,""),
e.X=t=>!t||null==t||0===Object.keys(t).length,e.oe=t=>{try{return JSON.parse(t)
...
},e.Dt=t=>t.toLowerCase().replace(/ /g,""),e.te=t=>{const e=t.replace(/ /g,"")
;return e.charAt(0).toLowerCase()+e.slice(1)
},e.et=(t,e)=>Object.assign(document.createElement(t),e),
e._=t=>(0,e.et)("div",t),
e.$=t=>(0,e.et)("span",t),e.V=t=>(0,e.et)("button",t),e.U=t=>(0,
e.et)("li",t),e.nt=t=>(0,
e.et)("p",t),e.ct=t=>(0,e.et)("a",t),e.Lt=t=>(0,e.et)("img",t),
e.Zt=t=>(0,e.et)("input",t),e.Vt=t=>(0,e.et)("label",t),e.jt=t=>{
const{elem:n,title:o,cback:i=(()=>{})}=t,r=(0,e.Dt)(o),a=(0,e._)({
classList:"nst-box-item"}),s=(0,e.et)("input",{id:"nst-"+r,type:"text",
classList:"nst-input",value:(0,e.L)(+((0,e.S)(r)??"0")),placeholder:r})
;return s.addEventListener("keyup",(t=>{const n=t.target,o=(0,e.m)(n.value)
;n.value=o.toLocaleString("en-US");const r=(0,e.Dt)(n.placeholder);(0,e.I)({
[r]:o}),i()})),a.appendChild(s),n.appendChild(a),a},e.Y=(t,n,o,i)=>{
const r=(0,e._)({classList:"nst-box-item"}),a=(0,e.Zt)({...t,type:"checkbox"
}),s={innerText:n,htmlFor:t?.id,title:o},c=(0,e.Vt)(s)
;return r.addEventListener("change",i),r.appendChild(a),r.appendChild(c),r
},e.J=(t,n)=>{const o=(0,e.S)("outcome").toString(),i=(0,e._)({
classList:"nst-box-item"}),r=(0,e.Zt)({id:t,type:"radio",name:n,value:t,
checked:o===t}),a=(0,e.Vt)({innerText:"hospitalize"===t?"hosp":t,htmlFor:t,
classList:""});return i.appendChild(r),i.appendChild(a),i
},e.Yt=(t,e)=>document?.getElementById(t)?.appendChild(e),
e.Qt=t=>document.body.appendChild(t),e.Jt=(t,e)=>{
...
;n.querySelector("#nst-arrow").innerHTML=c?a:r,(0,e.I)({[s]:c})};e.Kt=t=>{
const n=(0,e._)({classList:"nst-box-header"});return n.appendChild((0,e.$)({
classList:"nst-box-title"})).appendChild((0,e.$)({id:"nst-box-title",innerText:t
})),n.appendChild((0,e._)({id:"nst-arrow"})),n.addEventListener("click",s),n
},e.M=t=>{const{element:n,title:o}=t;if(!n)return
;const i=(0,e.Dt)(o),s=i+"Folded",c=(0,
e.S)(s)?"nst-box-content hidden":"nst-box-content",l=(0,e._)({
classList:"nst-box"}),u=(0,e.Kt)(o)
;u.querySelector("#nst-arrow").innerHTML=(0,e.S)(s)?a:r;const d=(0,e._)({
...
e.S)("apikey")}&comment=nst`,s=await c("GET",a),l=(0,e.Rt)()?s:s?.response
;return void 0!==l?.error?(console.error(l?.error?.error),
[2,10,13,18].includes(l?.error?.code)&&(0,e.zt)("nstdata"),{status:!1,
error:"broken key"}):{status:!0,...l}},e.qt=async t=>{
const{selection:n,api:o}=t,i=`https://www.tornstats.com/api/v2/${o??(0,
e.S)("tsapikey")??(0,
e.S)("apikey")}${n}`,r=await c("GET",i),a=(0,e.Rt)()?r:r?.response
;return void 0===a?.status||!1===a?.status?(console.error(a?.message,a),{
status:!1}):a},e.Xt=(t={})=>{const n=(0,e.X)(t)?(0,e.S)("userdata"):t;return{
re:n?.player_id,ae:n?.faction?.faction_id}
},e.Wt=t=>t.toString(16),e.$t=(t={})=>{const n=(0,e.S)("apikey")
;if(16!==n?.length)return!1
;const i=(0,e.X)(t)?(0,e.S)("userdata"):t,{re:r,ae:a}=(0,e.Xt)(i)
;return!(0,e.X)(i)&&!!(0,o.t)((0,e.Wt)(a),(0,e.Wt)(r))},e.Gt=async()=>{
(0,e.Rt)()||setInterval(i.wt,6e4);const t=(0,e.S)("apikey")
;if(16!==t?.length)return;const n=(0,e.S)("userdata"),o=1e3*(n?.timestamp??0)
;if(Date.now()-6e4<=o)return;const r={section:"user",
...
api:t},a=await(0,e.p)(r);if(!a?.status)return
;const s=a.merit_perks.filter((t=>t.includes("mug"))).join(),c=((0,
e.m)(s)/5+20)/400;(0,e.I)({userdata:a}),(0,e.I)({mugperc:c})},e.yt=(t="")=>{
if(!(0,e.$t)())return!1;const n=(0,e.S)("script");if(""===t)return!0
;const o=n?.[t]?.enabled;return!!o},e.Ht=()=>{
...
},e.R=t=>t.split("&").reduce(((t,e)=>({...t,[e.split("=")[0]]:e.split("=")[1]
})),{}),
e.H=t=>Object.keys(t).map((e=>`${e}=${t[e]}`)).join("&"),e.Rt=()=>void 0!==window.flutter_inappwebview,
e.Ft=t=>{
(0,e.Rt)()||(XMLHttpRequest.prototype._original_send=XMLHttpRequest.prototype.send,
...
}catch(t){console.error(t),this._original_send(e)}})},e.Bt=(t,n)=>{
if((0,e.Rt)())return;const{fetch:o}=unsafeWindow
;unsafeWindow.fetch=async(...e)=>{
const i=await o(...e),r=e[0]?.match(/(?<=step=|sid=)(\w+)/g)?.[0]
...
if((0,e.Rt)())"GET"===t&&PDA_httpGet(n).then((t=>r(JSON.parse(t.responseText)))).catch(a),
"POST"===t&&PDA_httpPost(n,o,i).then((t=>r(JSON.parse(t.responseText)))).catch(a);else{
const e={url:n,method:t,headers:o,data:i,responseType:"json",onload:r,onerror:a}
;GM.xmlHttpRequest(e)}}))},9607:(t,e)=>{Object.defineProperty(e,"__esModule",{
value:!0}),e.ot=void 0,e.ot=(t,e,n=!1)=>{const o=document?.querySelector(e)
...
;const t=n(6185),e=n(2268),o=n(9607),i=n(276),r=n(1913),a=n(5661),s=n(4051),c=n(3980),l=n(714),u=n(1108),d=n(9149),m=n(7188),f=n(7716),p=n(9355),h=n(2718),b=n(5689),g=n(1379),v=n(8620),w=n(8954),y=n(3424),k=n(763),x=n(3243),_=n(8601),L=n(6215),O=n(3840),M=n(2957),j=n(8292),D=n(263),T=n(7052),S=n(4538),I=n(1549),P=n(2470),E=n(1717),A=n(8527),q=n(8990),$=n(8257),z=n(6703),C={
home:()=>{
(0,t.yt)("livenetworth")&&(0,o.ot)(v.ut,'ul.info-cont-wrap [aria-label^="Networth"]'),
(0,t.yt)("effectivestats")&&(0,o.ot)(d.N,".battle")},abro:()=>{
(0,t.yt)("maxbuyabroad")&&(0,o.ot)(y.ht,"body")},trav:()=>{}},N={amarket:()=>{
(0,t.yt)("rwbonusdisplay")&&(0,o.ot)(T.Pt,"body")},bazaar:()=>{
(0,t.yt)("rwbonusdisplay")&&(0,
o.ot)(T.Pt,"body"),(0,t.yt)("bazaarvalue")&&(0,o.ot)(r.v,"#bazaarRoot .wrapper")
},city:()=>{},companies:()=>{},displaycase:()=>{},faction:()=>{},gym:()=>{
(0,t.yt)("specialgym")&&((0,
t.Bt)($.tt,"getInitialGymInfo"),(0,t.Bt)($.Z,"train"))},index:()=>{},item:()=>{
(0,t.yt)("equipnoconfirm")&&(0,t.Ft)(f.F)},imarket:()=>{
(0,t.yt)("marketnoconfirm")&&(0,t.Ft)(w.ft)},loader:()=>{
(0,t.yt)("intercept")&&"attack"===(0,t.ie)()&&(0,t.Bt)(P.st,"attackData")},
pmarket:()=>{},profiles:()=>{},search:()=>{},trade:()=>{},all:()=>{
(0,t.yt)("leftalign")&&(0,
g.lt)(),(0,t.yt)("minilastaction")&&(0,t.Bt)(E.bt,"UserMiniProfile")},
nopager:()=>{}},U={amarket:()=>{},bazaar:()=>{
(0,t.yt)("bazaarautoprice")&&(0,o.ot)(i.l,"body")},city:()=>{
(0,t.yt)()&&(0,o.ot)(D.It,"body"),
(0,t.yt)("cityfinds")&&(0,o.ot)(a.O,"#map .leaflet-marker-pane")},
companies:()=>{
(0,t.yt)("ezmoneydeposit")&&(0,o.ot)(p.G,"body"),(0,t.yt)("employeela")&&(0,
o.ot)(m.B,".manage-company"),
(0,t.yt)("companyrestock")&&/stock/.test((0,t.q)())&&(0,o.ot)(s.j,"body")},
displaycase:()=>{
(0,t.yt)("displaycaseitemid")&&(0,o.ot)(l.P,"ul.dc-list"),(0,t.yt)("rwbonusdisplay")&&(0,
o.ot)(T.Pt,"ul.display-cabinet")},factions:()=>{
(0,t.yt)("ezmoneydeposit")&&(0,o.ot)(p.G,"body"),
(0,t.yt)(t.qfs)&&(0,o.ot)(h._t,"#faction-armoury")},gym:()=>{
(0,t.yt)("")&&(0,o.ot)(z.it,'#gymroot ul[class*="properties"] [class*="strength"]')
},index:()=>{C[(0,t.Ht)()]()},item:()=>{
(0,t.yt)("removeuglyimage")&&(0,o.ot)(j.St,'[class^="itemPreviewWrapper"]',!0),
(0,
t.yt)("easyloadoutequip")&&(0,o.ot)(u.C,'ul[class^="slots"]'),(0,t.yt)(t.qis)&&(0,
o.ot)(L.Ot,"div.items-wrap")},imarket:()=>{
(0,t.yt)("marketnoconfirm")&&(0,o.ot)(w.dt,"body")},jailview:()=>{
(0,t.yt)("quickjail")&&(0,o.ot)(O.Mt,"ul.users-list")},loader:()=>{
(0,t.yt)("missionhelper")&&"missions"===(0,
t.ie)()&&(0,o.ot)(k.vt,".giver-cont-wrap"),
(0,t.yt)("fighterino")&&"attack"===(0,
t.ie)()&&(0,o.ot)(I.W,'div[class^="playersModelWrap"]')
;const e=window.innerWidth<=784?'#attacker [class^="playerWindow"]':'#defender [class^="playerWindow"]'
;(0,t.yt)("targetstatus")&&"attack"===(0,t.ie)()&&(0,o.ot)(q.Nt,e)},
pmarket:()=>{(0,t.yt)("pointsnoconfirm")&&(0,o.ot)(_.xt,".users-point-sell"),(0,
t.yt)("pointsmuglight")&&(0,o.ot)(x.kt,".users-point-sell")},profiles:()=>{
(0,t.yt)("idtoname")&&(0,
o.ot)(b.rt,".user-info-value"),(0,t.yt)("statspies")&&(0,
o.ot)(A.Ct,".user-info-value")},properties:()=>{
(0,t.yt)("ezmoneydeposit")&&(0,o.ot)(p.G,"body")},shops:()=>{
(0,t.yt)("cshopmaxbuy")&&(0,o.ot)(c.D,"body")},trade:()=>{
(0,t.yt)("tradevalue")&&(0,o.ot)(S.Ut,"#trade-container .trade-cont")},all:()=>{
(0,t.yt)("refillreminder")&&(0,o.ot)(M.Tt,'[class*="bar"][class*="energy"]')},
nopager:()=>{}},B={loading:async()=>{
if((0,o.ot)(e.At,"#sidebar"),!(0,t.$t)())return
;document.onreadystatechange=()=>B[document.readyState](),
(N.all??N.nopager)(),(N[(0,t.Et)()]??N.nopager)();const n=(0,t.S)()
;(0,t.X)(n)||(0,t.Gt)()},interactive:()=>{
(0,t.$t)()&&((U.all??U.nopager)(),(U[(0,t.Et)()]??U.nopager)())},complete:()=>{
(0,t.$t)()}};B[document.readyState]()})()})();