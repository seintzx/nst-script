...
}}function j(t,e){var n="";if("string"==typeof t)n=t;else do{
var o=O(t,"transform");o&&"none"!==o&&(n=o+" "+n)}while(!e&&(t=t.parentNode))
;var i=window.DOMMatrix||window.WebKitCSSMatrix||window.CSSMatrix||window.MSCSSMatrix
;return i&&new i(n)}function M(t,e,n){if(t){
...
var f=j(i||t),h=f&&f.a,b=f&&f.d;f&&(c=(a/=b)+(u/=b),l=(s/=h)+(m/=h))}return{
top:a,left:s,bottom:c,right:l,width:m,height:u}}}function I(t,e,n){
for(var o=z(t,!0),i=D(t)[e];o;){var r=D(o)[n]
;if(!("top"===n||"left"===n?i>=r:i<=r))return o;if(o===T())break;o=z(o,!1)}
...
;return n}function A(t){var e=0,n=0,o=T();if(t)do{var i=j(t),r=i.a,a=i.d
;e+=t.scrollLeft*r,n+=t.scrollTop*a}while(t!==o&&(t=t.parentNode));return[e,n]}
function z(t,e){if(!t||!t.getBoundingClientRect)return T();var n=t,o=!1;do{
...
}function $(t,e){return function(){if(!k){var n=arguments
...
var Q,V,Z,tt,et,nt,ot,it,rt,at,st,ct,lt,dt,ut,mt,pt,ft,ht,bt,gt,wt,vt,yt,xt,kt=!1,_t=!1,Lt=[],Ot=!1,jt=!1,Mt=[],Tt=!1,Dt=[],It="undefined"!=typeof document,St=f,Pt=u||d?"cssFloat":"float",Et=It&&!h&&!f&&"draggable"in document.createElement("div"),At=function(){
...
;var e=i({},o[o.length-1].rect);if(t.thisAnimationDuration){var n=j(t,!0)
...
var n=0,o=t.target,a=o.fromRect,s=D(o),c=o.prevFromRect,l=o.prevToRect,d=t.rect,u=j(o,!0)
;u&&(s.top-=u.f,
...
;var i=j(this.el),r=i&&i.a,a=i&&i.d,s=(e.left-n.left)/(r||1),c=(e.top-n.top)/(a||1)
;t.animatingX=!!s,
...
},a.ignore.split(",").forEach((function(t){M(Q,t.trim(),Ft)
})),g(s,"dragover",Nt),
...
var e=this.options,n=e.fallbackTolerance,o=e.fallbackOffset,i=t.touches?t.touches[0]:t,r=Z&&j(Z,!0),a=Z&&r&&r.a,s=Z&&r&&r.d,c=St&&xt&&A(xt),l=(i.clientX-ut.clientX+o.x)/(a||1)+(c?c[0]-Mt[0]:0)/(a||1),d=(i.clientY-ut.clientY+o.y)/(s||1)+(c?c[1]-Mt[1]:0)/(s||1)
;if(!Ut.active&&!kt){
...
e.top+=xt.scrollTop,e.left+=xt.scrollLeft):xt=T(),Mt=A(xt)}
...
}(Q.animated&&Q.toRect||e,s.animated&&s.toRect||n,r),j=r?"top":"left",M=I(s,"top","top")||I(Q,"top","top"),T=M?M.scrollTop:void 0
;if(wt!==s&&(v=n[j],Ot=!1,jt=!_&&c.invertSwap||k),w=function(t,e,n,o,i,r,a,s){
...
}(t,s,n,r,_?1:c.swapThreshold,null==c.invertedSwapThreshold?c.swapThreshold:c.invertedSwapThreshold,jt,wt===s),
0!==w){var A=E(Q);do{A-=w,y=V.children[A]
}while(y&&("none"===O(y,"display")||y===Z))}if(0===w||y===s)return U(!1)
;wt=s,vt=w;var z=s.nextElementSibling,q=!1,$=Bt(tt,a,Q,e,s,n,t,q=1===w)
;if(!1!==$)return 1!==$&&-1!==$||(q=1===$),
Tt=!0,setTimeout(Ht,30),R(),q&&!z?a.appendChild(Q):s.parentNode.insertBefore(Q,q?z:s),
M&&C(M,0,T-M.scrollTop),V=Q.parentNode,void 0===v||jt||(yt=Math.abs(v-D(s)[j])),
...
}),V=Q&&Q.parentNode,at=E(Q),ct=E(Q,n.draggable),Ut.eventCanceled||(kt=!1,jt=!1,
Ot=!1,
...
find:M,is:function(t,e){return!!x(t,e,t,!1)},extend:function(t,e){
...
detectDirection:zt,getChild:S,expando:F},Ut.get=function(t){return t[F]
},Ut.mount=function(){
...
;Jt!==n&&(Jt=n,ne(),Kt=e.scroll,i=e.scrollFn,!0===Kt&&(Kt=z(n,!0)));var u=0,m=Kt
;do{
var p=m,f=D(p),h=f.top,b=f.bottom,g=f.left,w=f.right,v=f.width,y=f.height,x=void 0,k=void 0,_=p.scrollWidth,L=p.scrollHeight,j=O(p),M=p.scrollLeft,I=p.scrollTop
;p===l?(x=v<_&&("auto"===j.overflowX||"scroll"===j.overflowX||"visible"===j.overflowX),
k=y<L&&("auto"===j.overflowY||"scroll"===j.overflowY||"visible"===j.overflowY)):(x=v<_&&("auto"===j.overflowX||"scroll"===j.overflowX),
k=y<L&&("auto"===j.overflowY||"scroll"===j.overflowY))
;var S=x&&(Math.abs(w-r)<=s&&M+v<_)-(Math.abs(g-r)<=s&&!!M),P=k&&(Math.abs(b-a)<=s&&I+y<L)-(Math.abs(h-a)<=s&&!!I)
...
}.bind({layer:u}),24))),u++}while(e.bubbleScroll&&m!==l&&(m=z(m,!1)));ee=d}
}),30),ae=function(t){
...
})),o.options.animation&&!n&&o.multiDrag.isMultiDrag){pe=s({},e);var i=j(me,!0)
...
if(!this.options.bubbleScroll||z(r,!0)===T())return void ne()
...
value:!0}),e.j=void 0;const o=n(6185);e.j=()=>{
console.log("nst - init default start")
;const t=(0,o.M)()??{},e={},n=i.script,r=t?.script??n
...
;const o=n(6185),i=(0,
o.C)("user2ID")??"",r=(0,o.M)(),{reloadone:a,reloadtwo:s,weapon:c}=r
...
;if(0===r&&(0,o.M)()?.assaperk){if("Assassinate"===n?.[72]?.title)return 1
;if("Assassinate"===i?.[72]?.title)return 2}if((()=>{
if(void 0===d?.attackerItems?.[5]?.item[0]?.ID)return!1;const{temp:t}=(0,o.M)()
;if(!t)return!1
...
const{outcome:t}=(0,o.M)();return{step:"finish",fightResult:t}},hold:()=>({}),
...
o.L)({classList:"nst-outcome"}),s={id:"nst-hold",checked:(0,o.M)("hold")
},c=(0,o.F)(s,"hold","",(t=>{const e=t.target.checked;(0,o.T)({hold:e})})),l={
id:"nst-temp",checked:(0,o.M)("temp")},d=(0,o.F)(l,"use temp first","",(t=>{
const e=t.target.checked;(0,o.T)({temp:e})})),u={id:"nst-assa",
checked:(0,o.M)("assaperk")},m=(0,o.F)(u,"assassinate","",(t=>{
...
value:!0}),e.Z=void 0;const i=o(n(246)),r=n(488),a=n(6185),s=async()=>{
...
void(t.innerText="Invalid Key Length");const o=await(0,a.tt)({api:n,selection:""
})
...
void(t.innerText=i?.error);const{et:r,nt:s}=(0,a.ot)(i)
;return void 0===r||void 0===s?(t.classList.remove("text-nstgreen"),
void(t.innerText="API broken, wait for ched to fix")):((0,a.T)({apikey:n
}),(0,a.it)(i)?((0,a.T)({userdata:i
}),t.classList.add("text-nstgreen"),t.innerText="Login Successful",
void d()):((0,
a.rt)("nstdata"),t.classList.remove("text-nstgreen"),void(t.innerText="You are not allowed, contact seintz[2460991]")))
},l=async()=>{
confirm("Are you sure you want to reset?")&&((0,a.rt)("nstdata"),window.location.reload())
},d=()=>{if(!(0,a.it)())return;(0,r.j)()
;const t=document.querySelector("#nst-ul-main")
;v(t,"tsapi",h),v(t,"attack",f),v(t,"export",u),v(t,"import",m)
;const e=(0,a.M)("script"),n=Object.keys(e).sort().reduce(((t,n)=>(t[n]=e?.[n],
t)),{})
...
onclick:()=>s.click()}),s=(0,a.ct)({id:"nst-import-input",type:"file",
accept:"json",onchange:t=>{const e=new FileReader
;e.addEventListener("load",(t=>{const e=(0,a.lt)(""+t.target?.result)
;(0,a.T)(e),
(0,r.j)(),n.classList.remove("hidden"),n.classList.add("text-nstgreen"),
...
;const n=t.replace(/nst-/g,""),o=(0,a.M)("script"),i=Object.keys(o).sort().reduce(((t,e)=>(o?.[e]?.onpage===n&&(t[e]=o?.[e]),
t)),{}),r=(0,a.L)({classList:"nst-script-block"})
;Object.entries(i).forEach((([t,e])=>{const n=e?.name,o=(0,a.dt)(t),i={
id:"nst-"+o,value:o,checked:e?.enabled??!1
},s=(0,a.F)(i,n,e.description.toLowerCase(),(t=>{
const e=t.target,n=(0,a.M)("script");n[e.value].enabled=e.checked,(0,a.T)({
...
(0,a.ut)({elem:t,title:"mug threshold"}),t})()),e.appendChild((()=>{
const t=(0,a.L)({classList:"nst-block"}),e=(0,a._)("h4",{
...
id:"nst-hold",checked:(0,a.M)("hold")},c=(0,a.F)(s,"hold","",(t=>(0,a.T)({
...
const t=(0,a.M)("weapon"),e=(0,a.L)({classList:"nst-block"}),n=(0,a._)("h4",{
...
checked:(0,a.M)("reloadone")},i=(0,a.F)(o,"primary","",(t=>(0,a.T)({
reloadone:t.target.checked}))),r={id:"nst-reloadtwo",
checked:(0,a.M)("reloadtwo")},s=(0,a.F)(r,"secondary","",(t=>(0,a.T)({
...
;const n=(0,a.st)({href:"https://www.tornstats.com/settings/general",
...
classList:"nst-input m-2",maxLength:19,required:!0,value:(0,a.M)(c)??""
...
;e.innerHTML="";const n=(0,a.st)({
href:"https://www.torn.com/preferences.php#tab=api",target:"_blank",
innerText:"limited",classList:"text-nstyellow font-bold"}),o=(0,a.st)({
...
classList:"nst-input m-2",maxLength:16,required:!0,value:(0,a.M)(d)??""
...
const o=t?.parentElement,i="nst-"+e.toLowerCase(),r=i+"-li",s=(0,a.ft)({id:r,
...
;if(e||!n)return;const o=(0,a.ft)({id:"nst-icon",classList:"nst-icon"})
...
return t&&t.__esModule?t:{default:t}};Object.defineProperty(e,"__esModule",{
value:!0}),e.gt=void 0;const i=o(n(246)),r=n(6185),a=t=>{t.stopPropagation()
;const e=t.target.closest("#nst-quick-use").parentElement.getAttribute("data-itemID")
;if(!e)return;const n=(0,r.M)(r.qfs);Object.keys(n).includes(e)&&(async t=>{
...
;const i="https://www.torn.com/item.php?rfcv="+(0,r.R)(),a={method:"POST",
headers:{"x-requested-with":"XMLHttpRequest"},body:new URLSearchParams(o)
},s=await(await fetch(i,{...a})).json(),c=s.links??{},l=s.text??{},d=(0,r.L)({})
;d.appendChild((0,r.wt)({innerHTML:l}));const u=(0,r.wt)({})
...
id:"nst-quick-use",classList:"nst-box-button",onclick:a}),u=(0,r.vt)({src:c,
...
dataIdAttr:"data-itemid",store:{get:()=>{const t=(0,r.M)(r.qfs)
;return Object.entries(t).sort(((t,e)=>t[1].order-e[1].order)).map((t=>t[0]))},
set:t=>{const e=t.toArray(),n=(0,r.M)(r.qfs)
...
;if(!i)return;const s=(0,r.M)(r.qfs);if(Object.keys(s).includes(i))return
;const l=0===Object.values(s)?.length?0:+Object.values(s).reduce(((t,e)=>t?.order>e?.order?t:e))?.order
;s[i]={id:i,order:l+1,name:a},(0,r.T)({[r.qfs]:s}),c()},d={box:t=>{
...
;const{refills:{energy_refill_used:e,nerve_refill_used:n}}=(0,o.M)("userdata")
...
;r||s?.classList.add(l)}))}},3243:(t,e,n)=>{
...
const{item:n,selector:i,reg:r}=e,a=(0,o.M)("quick"+n)??!1,s=t?.parentElement,c=s.querySelector("a."+i),l=c?.getAttribute("href")
;if(!c||!l)return
;const d=RegExp(r+"$","g"),u=RegExp(r+"1$","g"),m=a?l.replace(d,r+"1"):l.replace(u,r)
;c.setAttribute("href",m)},r=t=>{
const e=+((0,o.M)("jailscore")??"0"),n=t?.parentElement,r=t.querySelector("span.time").innerText.split(" ").reduce(((t,e)=>t+(/h/.test(e)?60*+e.replace(/h/g,""):/m/.test(e)?+e.replace(/m/g,""):0)),0),a=(0,
...
;Array.from(e).forEach((t=>r(t)))}});const s="Quick Bust",c=(0,o.dt)(s),l={
id:"nst-"+c,type:"checkbox",value:c,checked:(0,o.M)(c)??!1}
;i.appendChild((0,o.F)(l,s,"",a));const d="Quick Bail",u=(0,o.dt)(d),m={
id:"nst-"+u,type:"checkbox",value:u,checked:(0,o.M)(u)??!1}
...
element:t.closest("#tab-menu")}),r="Hide Items",a=(0,o.dt)(r),s={id:"nst-"+a,
type:"checkbox",value:a,checked:(0,o.M)(a)??!1
},c=(0,o.M)(a)??!1,l=await(0,o.p)({section:"torn",select:"items"})
...
}),e.St=e.Pt=e.Et=e.At=e.zt=e.qt=e.it=e.$t=e.ot=e.tt=e.p=e.u=e.h=e.U=e.Ct=e.Nt=e.Rt=e.Ut=e.B=e.F=e.ut=e.Bt=e.ct=e.vt=e.st=e.wt=e.ft=e.H=e.k=e.L=e._=e.Ft=e.dt=e.W=e.Ht=e.Gt=e.Y=e.m=e.rt=e.T=e.M=e.lt=e.N=e.J=e.I=e.O=e.Wt=e.Xt=e.C=e.R=void 0,
...
}catch(t){console.error(t)}return null},e.M=(t="")=>{let e;try{
e=JSON.parse(localStorage.getItem("nstdata"))}catch{e={}}
return""===t?e??{}:e?.[t]},e.T=t=>{const n=(0,e.M)()
...
e.ft=t=>(0,
e._)("li",t),e.wt=t=>(0,e._)("p",t),e.st=t=>(0,e._)("a",t),e.vt=t=>(0,
e._)("img",t),e.ct=t=>(0,e._)("input",t),e.Bt=t=>(0,e._)("label",t),e.ut=t=>{
const{elem:n,title:o,cback:i=()=>{}}=t,r=(0,e.dt)(o),a=(0,e.L)({
classList:"nst-box-item"}),s=(0,e._)("input",{id:"nst-"+r,type:"text",
classList:"nst-input",value:(0,e.Y)(+((0,e.M)(r)??"0")),placeholder:r,
...
const r=(0,e.L)({classList:"nst-box-item",onchange:i}),a=(0,e.ct)({...t,
type:"checkbox"}),s={innerText:n,htmlFor:t?.id,title:o},c=(0,e.Bt)(s)
;return r.appendChild(a),r.appendChild(c),r},e.B=(t,n)=>{
const o=(0,e.M)("outcome").toString(),i=(0,e.L)({classList:"nst-box-item"
}),r=(0,e.ct)({id:t,type:"radio",name:n,value:t,checked:o===t}),a=(0,e.Bt)({
...
;n.querySelector("#nst-arrow").innerHTML=c?a:r,(0,e.T)({[s]:c})};e.Ct=t=>{
...
;const i=(0,e.dt)(o),s=i+"Folded",c=(0,e.M)(s)?"nst-box-content hidden":"nst-box-content",l=(0,
e.L)({classList:"nst-box"}),d=(0,e.Ct)(o)
;d.querySelector("#nst-arrow").innerHTML=(0,e.M)(s)?a:r;const u=(0,e.L)({
...
e.M)("apikey")}&comment=nst`,s=await c("GET",a),l=(0,e.St)()?s:s?.response
...
e.M)("tsapikey")??(0,
e.M)("apikey")}${n}`,r=await c("GET",i),a=(0,e.St)()?r:r?.response
;return void 0===a?.status||!1===a?.status?(console.error(a?.message,a),{
status:!1}):a},e.ot=(t={})=>{const n=(0,e.N)(t)?(0,e.M)("userdata"):t;return{
et:n?.player_id,nt:n?.faction?.faction_id}
},e.$t=t=>t.toString(16),e.it=(t={})=>{const n=(0,e.M)("apikey")
;if(16!==n?.length)return!1
;const i=(0,e.N)(t)?(0,e.M)("userdata"):t,{et:r,nt:a}=(0,e.ot)(i)
;return!(0,e.N)(i)&&!!(0,o.kt)((0,e.$t)(a),(0,e.$t)(r))},e.qt=async()=>{
setTimeout(e.qt,6e4);const t=(0,e.M)();if((0,e.N)(t))return;const n=t?.apikey
...
api:n},s=await(0,e.p)(a);if(!s?.status)return;const{et:c,nt:l}=(0,e.ot)(s)
...
}),(0,e.St)()||(0,i.Qt)(o,s)},e.zt=(t="")=>{if(!(0,e.it)())return!1
;const n=(0,e.M)("script");if(""===t)return!0;const o=n?.[t]?.enabled;return!!o
},e.At=()=>{
...
e.m)((0,e.M)("mugthreshold")),e.qit="Quick Items",
e.qis=(0,e.dt)(e.qit),e.qft="Quick Faction",e.qfs=(0,e.dt)(e.qft)
;const c=(t,n,o={},i={})=>new Promise(((r,a)=>{
if((0,e.St)())"GET"===t&&PDA_httpGet(n).then((t=>r(JSON.parse(t.responseText)))).catch(a),
...
t.stopPropagation()
;const e=t.target.closest("#nst-quick-use").parentElement.getAttribute("data-itemID")
;if(!e)return;const n=(0,r.M)(r.qis);Object.keys(n).includes(e)&&(async t=>{
...
})).json(),c=s.links??{},l=s.text??{},d=(0,r.L)({});d.appendChild((0,r.wt)({
innerHTML:l}));const u=(0,r.wt)({});Object.values(c).forEach((t=>{
...
id:"nst-quick-use",classList:"nst-box-button"}),u=(0,r.vt)({src:a,alt:o,
...
dataIdAttr:"data-itemid",store:{get:()=>{const t=(0,r.M)(r.qis)
;return Object.entries(t).sort(((t,e)=>t[1].order-e[1].order)).map((t=>t[0]))},
set:t=>{const e=t.toArray(),n=(0,r.M)(r.qis)
...
;if(!(n&&o&&a&&s.includes(a)))return;const m=(0,r.M)(r.qis)
...
;const e=(0,o.M)("userdata"),n=[...e.faction_perks,...e.job_perks,...e.property_perks,...e.education_perks,...e.book_perks].filter((t=>t.includes("gym gains")))
...
;s&&i.classList.add(s)}))};e.te=async t=>{if(!t)return;const e=await(0,o.p)({
...
;a.selected=(0,o.M)("spgym"+t)?.toString()===e,i.appendChild(a)}))
;const s=(0,o.wt)({id:`nst-spgym-${t}-msg`,classList:"nst-spgym-msg"})
;n.appendChild(i),n.appendChild(s),e.appendChild(n)}))})(t),e.ie=t=>{
...
}),e.ae=void 0,e.ae=t=>t?.remove()},8527:function(t,e,n){
var o=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{
default:t}};Object.defineProperty(e,"__esModule",{value:!0}),e.se=void 0
;const i=o(n(246)),r=n(6185),a=(0,r.C)("XID");e.se=async t=>{(t=>{
...
;const t=n(6185),e=n(2268),o=n(9607),i=n(276),r=n(1913),a=n(5661),s=n(4051),c=n(3980),l=n(714),d=n(1108),u=n(9149),m=n(7188),p=n(7716),f=n(9355),h=n(2718),b=n(5689),g=n(1379),w=n(8620),v=n(8954),y=n(3424),x=n(763),k=n(3243),_=n(8601),L=n(6215),O=n(3840),j=n(2957),M=n(8292),T=n(263),D=n(291),I=n(4538),S=n(1549),P=n(2470),E=n(1717),A=n(8527),z=n(8990),q=n(8257),$=n(6703),C=n(7673),N=n(7298),R=n(1896),U=n(2585),B=n(3403),F={
home:()=>{
(0,t.zt)("livenetworth")&&(0,o.X)(w.le,'ul.info-cont-wrap [aria-label^="Networth"]'),
(0,t.zt)("effectivestats")&&(0,o.X)(u.pe,".battle")},abro:()=>{
(0,t.zt)("maxbuyabroad")&&(0,o.X)(y.Lt,"body")},trav:()=>{}},H={amarket:()=>{(0,
...
(0,t.zt)("specialgym")&&((0,
o.X)(q.re,"#gymroot"),(0,t.Jt)(q.ie,"getInitialGymInfo"),(0,t.Jt)(q.ie,"train"))
},index:()=>{},item:()=>{
(0,t.zt)("equipnoconfirm")&&(0,t.Yt)(p.oe),(0,t.zt)("rwbonus")&&(0,
o.X)(D.v,"body")},imarket:()=>{(0,t.zt)("marketnoconfirm")&&(0,t.Yt)(v.ue)},
loader:()=>{
(0,t.zt)("intercept")&&"attack"===(0,t.Xt)()&&(0,t.Jt)(P.ht,"attackData")},
page:()=>{
(0,t.zt)("rrtimeout")&&"russianRoulette"===(0,t.Xt)()&&(0,t.Jt)(R.K,"russianRouletteData")
},pmarket:()=>{},profiles:()=>{},search:()=>{},trade:()=>{},all:()=>{
(0,t.zt)("leftalign")&&(0,
g.q)(),(0,t.zt)("minilastaction")&&(0,t.Jt)(E.G,"UserMiniProfile")},
nopager:()=>{}},G={amarket:()=>{},bazaar:()=>{
(0,t.zt)("bazaarautoprice")&&(0,o.X)(i.l,"body")},city:()=>{
(0,t.zt)()&&(0,o.X)(T.t,"body"),
(0,t.zt)("cityfinds")&&(0,o.X)(a.Dt,"#map .leaflet-marker-pane")},
companies:()=>{
(0,t.zt)("ezmoneydeposit")&&(0,o.X)(f.fe,"body"),(0,t.zt)("employeela")&&(0,
o.X)(m.te,".manage-company"),
(0,t.zt)("companyrestock")&&/stock/.test((0,t.I)())&&(0,o.X)(s.Mt,"body")},
displaycase:()=>{
(0,t.zt)("displaycaseitemid")&&(0,o.X)(l.D,"ul.dc-list"),(0,t.zt)("rwbonus")&&(0,
o.X)(D.v,"ul.display-cabinet")},factions:()=>{
(0,t.zt)("ezmoneydeposit")&&(0,o.X)(f.fe,"body"),
(0,t.zt)(t.qfs)&&(0,o.X)(h.gt,"#faction-armoury")},gym:()=>{
(0,t.zt)("")&&(0,o.X)($.Zt,'#gymroot ul[class*="properties"] [class*="strength"]')
},index:()=>{F[(0,t.At)()]()},item:()=>{
(0,t.zt)("removeuglyimage")&&(0,o.X)(M.ae,'[class^="itemPreviewWrapper"]',!0),
(0,
t.zt)("easyloadoutequip")&&(0,o.X)(d.P,'ul[class^="slots"]'),(0,t.zt)(t.qis)&&(0,
o.X)(L.Vt,"div.items-wrap")},imarket:()=>{
(0,t.zt)("marketnoconfirm")&&(0,o.X)(v.de,"body")},jailview:()=>{
(0,t.zt)("quickjail")&&(0,o.X)(O.Ot,"ul.users-list")},loader:()=>{
(0,t.zt)("missionhelper")&&"missions"===(0,
t.Xt)()&&(0,o.X)(x.S,".giver-cont-wrap"),
(0,t.zt)("fighterino")&&"attack"===(0,t.Xt)()&&(0,
o.X)(S.$,'div[class^="playersModelWrap"]'),
(0,t.zt)("targetstatus")&&"attack"===(0,
t.Xt)()&&(0,o.X)(z.me,'[class^="playerWindow"] [class*="defender"]')},page:()=>{
F[(0,
t.At)()](),(0,t.zt)("pokername")&&"holdem"===(0,t.Xt)()&&(0,o.X)(C.ne,"div[class^=players]")
},pmarket:()=>{
(0,t.zt)("pointsnoconfirm")&&(0,o.X)(_.ce,".users-point-sell"),(0,
t.zt)("pointsmuglight")&&(0,o.X)(k.xt,".users-point-sell")},profiles:()=>{
(0,t.zt)("idtoname")&&(0,
o.X)(b.It,".user-info-value"),(0,t.zt)("hidemedals")&&(0,
o.X)(B._t,".medals-wrapper"),
(0,t.zt)("statspies")&&(0,o.X)(A.se,".user-info-value")},properties:()=>{
(0,t.zt)("ezmoneydeposit")&&(0,o.X)(f.fe,"body")},shops:()=>{
(0,t.zt)("cshopmaxbuy")&&(0,o.X)(c.jt,"body")},trade:()=>{
(0,t.zt)("tradevalue")&&(0,
o.X)(I.Tt,"#trade-container .trade-cont"),(0,t.zt)("quickghost")&&(0,
...
(0,t.zt)("refillreminder")&&(0,o.X)(j.yt,'[class*="bar"][class*="energy"]')},
nopager:()=>{}},W={loading:async()=>{
(0,o.X)(e.Z,"#sidebar"),(0,t.it)()&&(document.onreadystatechange=()=>W[document.readyState](),
(H.all??H.nopager)(),(H[(0,t.O)()]??H.nopager)(),(0,t.qt)())},interactive:()=>{
