...
;s-=f.top+parseInt(O(i,"border-top-width")),r-=f.left+parseInt(O(i,"border-left-width")),
...
if("none"!==s[a].style.display&&s[a]!==Bt.ghost&&(o||s[a]!==Bt.dragged)&&k(s[a],n.draggable,t,!1)){
...
activeSortable:Bt.active,originalEvent:o,oldIndex:at,oldDraggableIndex:rt,
...
var Q,V,Z,tt,et,nt,ot,it,at,st,rt,ct,lt,ut,dt,mt,ft,pt,ht,bt,gt,vt,wt,yt,kt,xt=!1,_t=!1,Lt=[],Ot=!1,Mt=!1,jt=[],Tt=!1,Dt=[],St="undefined"!=typeof document,It=p,Pt=d||u?"cssFloat":"float",Et=St&&!h&&!p&&"draggable"in document.createElement("div"),At=function(){
if(St){if(u)return!1;var t=document.createElement("x")
;return t.style.cssText="pointer-events:auto","auto"===t.style.pointerEvents}
}(),$t=function(t,e){
var n=O(t),o=parseInt(n.width)-parseInt(n.paddingLeft)-parseInt(n.paddingRight)-parseInt(n.borderLeftWidth)-parseInt(n.borderRightWidth),i=I(t,0,e),a=I(t,1,e),s=i&&O(i),r=a&&O(a),c=s&&parseInt(s.marginLeft)+parseInt(s.marginRight)+D(i).width,l=r&&parseInt(r.marginLeft)+parseInt(r.marginRight)+D(a).width
...
;var e=(i=t.clientX,a=t.clientY,Lt.some((function(t){
...
n.stopPropagation=void 0,e[R]._onDragOver(n)}}var i,a,s},Ut=function(t){
Q&&Q.parentNode[R]._isOutsideThisEl(t.target)};function Bt(t,e){
if(!t||!t.nodeType||1!==t.nodeType)throw"Sortable: `el` must be an HTMLElement, not ".concat({}.toString.call(t))
;this.el=t,this.options=e=r({},e),t[R]=this;var n,o,a={group:null,sort:!0,
...
;t.animatingX=!!r,
t.animatingY=!!c,O(t,"transform","translate3d("+r+"px,"+c+"px,0)"),
...
t.animatingX=!1,t.animatingY=!1}),o)}}}))}function Ft(t,e,n,o,i,a,s,r){
...
function Rt(t){t.draggable=!1}function Ht(){Tt=!1}function Gt(t){
...
var c=D(n)
;if(tt=a,V=(Q=n).parentNode,et=Q.nextSibling,nt=n,lt=s.group,Bt.dragged=Q,dt={
...
},s.ignore.split(",").forEach((function(t){j(Q,t.trim(),Rt)
})),g(r,"dragover",Nt),
...
Q&&Rt(Q),clearTimeout(this._dragStartTimer),this._disableDelayedDragEvents()},
...
;if(Q.parentNode[R]._isOutsideThisEl(t),e)do{if(e[R]&&e[R]._onDragOver({
...
var e,n,o,a,s=this.el,r=t.target,c=this.options,l=c.group,u=Bt.active,d=lt===l,m=c.sort,f=ut||u,p=this,h=!1
;if(!Tt){
if(void 0!==t.preventDefault&&t.cancelable&&t.preventDefault(),r=k(r,c.draggable,s,!0),
N("dragOver"),Bt.eventCanceled)return h
;if(Q.contains(t.target)||r.animated&&r.animatingX&&r.animatingY||p._ignoreWhileAnimating===r)return B(!1)
;if(_t=!1,
...
var o=D(P(n.el,n.options.draggable)),i=F(n.el,n.options,Z)
...
}(t,a,this)&&!b.animated){if(b===Q)return B(!1)
;if(b&&s===t.target&&(r=b),r&&(n=D(r)),
!1!==Ft(tt,s,Q,e,r,n,t,!!r))return U(),b&&b.nextSibling?s.insertBefore(Q,b.nextSibling):s.appendChild(Q),
V=s,H(),B(!0)}else if(b&&function(t,e,n){
var o=D(I(n.el,0,n.options,!0)),i=F(n.el,n.options,Z)
;return e?t.clientX<i.left-10||t.clientY<o.top&&t.clientX<o.right:t.clientY<i.top-10||t.clientY<o.bottom&&t.clientX<o.left
}(t,a,this)){var g=I(s,0,c,!0);if(g===Q)return B(!1)
;if(n=D(r=g),!1!==Ft(tt,s,Q,e,r,n,t,!1))return U(),
s.insertBefore(Q,g),V=s,H(),B(!0)}else if(r.parentNode===s){n=D(r)
...
;if(vt!==r&&(w=n[M],Ot=!1,Mt=!_&&c.invertSwap||x),v=function(t,e,n,o,i,a,s,r){
...
}while(y&&("none"===O(y,"display")||y===Z))}if(0===v||y===r)return B(!1)
;vt=r,wt=v;var $=r.nextElementSibling,q=!1,z=Ft(tt,s,Q,e,r,n,t,q=1===v)
;if(!1!==z)return 1!==z&&-1!==z||(q=1===z),
Tt=!0,setTimeout(Ht,30),U(),q&&!$?s.appendChild(Q):r.parentNode.insertBefore(Q,q?$:r),
j&&C(j,0,T-j.scrollTop),V=Q.parentNode,void 0===w||Mt||(yt=Math.abs(w-D(r)[M])),
H(),B(!0)}if(s.contains(Q))return B(!1)}return!1}function N(c,l){J(c,p,i({evt:t,
isOwner:d,axis:a?"vertical":"horizontal",revert:o,dragRect:e,targetRect:n,
canSort:m,fromSortable:f,target:r,completed:B,onMove:function(n,o){
return Ft(tt,s,Q,e,n,D(n),t,o)},changed:H},l))}function U(){
...
p!==f&&(L(Q,ut?ut.options.ghostClass:u.options.ghostClass,!1),
L(Q,c.ghostClass,!0)),
ut!==p&&p!==Bt.active?ut=p:p===Bt.active&&ut&&(ut=null),f===p&&(p._ignoreWhileAnimating=r),
...
c.dragoverBubble||t.rootEl||r===document||(Q.parentNode[R]._isOutsideThisEl(t.target),
...
}),V=Q&&Q.parentNode,st=E(Q),ct=E(Q,n.draggable),Bt.eventCanceled||(xt=!1,Mt=!1,
Ot=!1,
...
this._offMoveEvents(),
this._offUpEvents(),f&&O(document.body,"user-select",""),O(Q,"transform",""),
...
Rt(Q),Q.style["will-change"]="",gt&&!xt&&L(Q,ut?ut.options.ghostClass:this.options.ghostClass,!1),
...
originalEvent:t}),Y({sortable:this,name:"sort",toEl:V,originalEvent:t
})),Bt.active&&(null!=st&&-1!==st||(st=at,ct=rt),Y({sortable:this,name:"end",
toEl:V,originalEvent:t}),this.save())))),this._nulling()},_nulling:function(){
J("nulling",this),
tt=Q=V=Z=et=ot=nt=it=dt=mt=gt=st=ct=at=rt=vt=wt=ut=lt=Bt.dragged=Bt.ghost=Bt.clone=Bt.active=null,
...
detectDirection:$t,getChild:I},Bt.get=function(t){return t[R]
},Bt.mount=function(){
...
;do{
var f=m,p=D(f),h=p.top,b=p.bottom,g=p.left,v=p.right,w=p.width,y=p.height,k=void 0,x=void 0,_=f.scrollWidth,L=f.scrollHeight,M=O(f),j=f.scrollLeft,S=f.scrollTop
...
;var I=k&&(Math.abs(v-a)<=r&&j+w<_)-(Math.abs(g-a)<=r&&!!j),P=x&&(Math.abs(b-s)<=r&&S+y<L)-(Math.abs(h-s)<=r&&!!S)
...
;var o=D(me,!1,!0,!0);he.forEach((function(t){t!==me&&U(t,o)})),ve=!0,ge=!0}
...
var c=D(me,!1,!0,!0);he.forEach((function(t){t!==me&&(U(t,c),a.appendChild(t))
...
initializeByDefault:!0})}),Bt.mount(ce,re);const _e=Bt},4893:(t,e,n)=>{
...
innerText:`Total: $${(0,o.L)(i)} - MV: $${(0,o.L)(a)}`})
...
innerText:"Worth: $"+(0,o.L)(s)})),l.appendChild((0,o._)({
...
onpage:"casino"},cityfinds:{name:"city finds",enabled:!1,
...
})),e.appendChild(a),Object.keys(i).forEach((t=>{const n=(0,o.U)({tabIndex:0,
ariaLabel:`${t} ${(0,o.L)(i[t])}`}),a=(0,o.q)({classList:"divider",
...
;if(0===o.length)return;const i=(Date.now()-864e5)/1e3,a=(Date.now()-1728e5)/1e3
;o.forEach((t=>{const n=t?.getAttribute("data-user");if(!n)return
;const o=e[n]?.last_action?.timestamp,s=t?.querySelector(".employee")
;if(!s)return;const r=o<a?"bg-nstred":o<i?"bg-nstyellow":""
;r&&s.classList.add(r)}))};e.B=async t=>{if(!t)return;const e=await(0,o.p)({
...
o.K)(),s={method:"POST",headers:{"x-requested-with":"XMLHttpRequest"},
...
;(0,o.I)({outcome:e})}))
;const n=(0,o.J)("leave","outcome"),i=(0,o.J)("mug","outcome"),a=(0,
...
},c=(0,o.Y)(r,"hold","",(t=>{const e=t.target.checked;(0,o.I)({hold:e})})),l={
...
})(),i=(0,o._)({classList:"nst-box-column"}),a=(0,o.V)({id:"nst-fighteroo",
...
;(0,o.I)({[n]:e.value})}));const a=(0,o.nt)({id:`nst-spgym-${t}-msg`,
...
o.L)(l/1.25-u):(0,
o.L)(1.25*u-l),m=Object.keys(r).length>1?Object.keys(l>=1.25*u?c:r).join(" and "):(l>=1.25*u?Object.keys(c).filter((t=>a[t]===u)):Object.keys(r)).join(""),f=`Gain ${l>=1.25*u?"no more than":""} ${d} ${m}`
;n.innerText=f}))};e.tt=t=>{
Object.entries(t?.stats).forEach((([t,e])=>a[t]=(0,o.m)(e?.value))),
(0,i.ot)(r,"#gymroot"),c()},e.Z=t=>{a[t?.stat?.name]=(0,o.m)(t?.stat?.newValue),
...
2470:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.rt=void 0
;const o=n(6185);e.rt=t=>{if(!("currentFightStatistics"in t))return
...
ariaLabel:"Live NW: "+(0,o.L)(i)}),u=(0,o.q)({classList:"divider",
innerHTML:"<span>Live Networth</span>"}),d=(0,o.q)({
classList:`desc ${r} font-bold`,innerText:` $${(0,o.L)(i)} `,
...
}),e.bt=void 0;const o=n(6185),i=n(9607);let a;const s=t=>{
t?.querySelector("#nst-lastaction")||t.appendChild((0,o._)({id:"nst-lastaction",
innerText:"last action: "+a}))};e.bt=t=>{
a=(0,o.gt)(+t.user.lastAction.seconds).trim(),
(0,i.ot)(s,'#profile-mini-root [class*="profile-mini-_userProfileWrapper"]')}},
...
}),e.wt=void 0;const o=n(6185),i=t=>GM.notification(t);e.wt=(t,e)=>{
(0,o.yt)("drugnoti")&&((t,e)=>{const n=e?.cooldowns?.drug,o=t?.cooldowns?.drug
;0!==o&&0===n&&i({title:"NST: Drug Cooldown",
text:"Your drug cooldown has expired."})})(t,e),(0,o.yt)("travnoti")&&((t,e)=>{
const n=e?.travel?.time_left,a=t?.travel?.time_left,s=e?.travel?.destination
;n<=120&&n!==a&&i({title:"NST: Travel",text:`${s} - Landing in ${(0,o.gt)(n)}`})
})(t,e),(0,o.yt)("hospnoti")&&((t,e)=>{
const n=e?.states?.hospital_timestamp,a=t?.states?.hospital_timestamp
;if(!(n<=300&&n!==a))return;const s=Math.round(n-Date.now()/1e3);i({
title:"NST: Hospital",text:"Out of hosp in "+(0,o.gt)(s)})
})(t,e),(0,o.yt)("eventnoti")&&((t,e)=>{
...
}},7673:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0}),e._t=void 0
;const o=n(6185),i=t=>{if(!t)return;if(t.querySelector("a"))return
;const e=t.innerHTML,n=(0,o.ct)({classList:"nst-pokername",
href:"profiles.php?NID="+e,innerText:""+e});t.innerHTML="",t.appendChild(n)}
;e._t=t=>{const e="p[class^=name]"
...
;const i="https://www.torn.com/item.php?rfcv="+(0,a.K)(),s={method:"POST",
...
;l.setAttribute("data-itemID",n),l.setAttribute("data-qty",i);const u=(0,a.V)({
id:"nst-quick-use",classList:"nst-box-button"}),d=(0,a.Ot)({src:c,alt:o,
...
;const s="https://www.torn.com/item.php?rfcv="+(0,a.K)(),r={method:"POST",
...
;if(!o)return;const i="https://www.torn.com/item.php?rfcv="+(0,a.K)(),s={
method:"POST",headers:{"x-requested-with":"XMLHttpRequest"},
body:new URLSearchParams(o)},r=await(await fetch(i,{...s
})).json(),c=r.links??{},l=r.text??{},u=(0,a._)({});u.appendChild((0,a.nt)({
...
classList:"nst-box-btn-div"})
;r.setAttribute("data-itemID",n),r.setAttribute("data-qty",i);const u=(0,a.V)({
id:"nst-quick-use",classList:"nst-box-button"}),d=(0,a.Ot)({src:s,alt:o,
classList:"nst-box-img"}),m=(0,a.q)({id:"nst-quick-name",innerText:o
}),f=(0,a.q)({id:"nst-quick-close",classList:"nst-box-close",innerText:"✕"})
...
;t.setAttribute("title","score: "+(0,o.L)(s));const r=s>e&&0!==e
...
;Array.from(i).forEach((t=>a(t)))};e.jt=t=>{(t=>{const e=(0,o.M)({
title:"Quick Jail",element:t?.parentElement}),n=(0,o._)({
classList:"nst-box-column"}),i=(0,o._)({classList:"nst-box-column"})
;e.appendChild(n),e.appendChild(i),(0,o.Tt)({elem:n,title:"Jail Score",
cback:()=>{const e=t.querySelectorAll("span.info-wrap")
;Array.from(e).forEach((t=>a(t)))}});const r="Quick Bust",c=(0,o.Dt)(r),l={
id:"nst-"+c,type:"checkbox",value:c,checked:(0,o.S)(c)??!1}
;i.appendChild((0,o.Y)(l,r,"",s));const u="Quick Bail",d=(0,o.Dt)(u),m={
id:"nst-"+d,type:"checkbox",value:d,checked:(0,o.S)(d)??!1}
;i.appendChild((0,o.Y)(m,u,"",s))})(t),new MutationObserver((t=>{t.forEach((t=>{
...
value:!0}),e.It=void 0,e.It=t=>t?.remove()},263:(t,e)=>{
Object.defineProperty(e,"__esModule",{value:!0}),e.Pt=void 0;const n=t=>{
...
e=e.nextSibling};e.Pt=t=>{o(t);const e=document.querySelector("#map")
...
Object.defineProperty(e,"__esModule",{value:!0}),e.Et=void 0;const o=n(6185),i={
...
;e.Et=t=>i[(0,o.At)()](t)},2268:function(t,e,n){
var o=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{
default:t}};Object.defineProperty(e,"__esModule",{value:!0}),e.$t=void 0
...
void(t.innerText="Invalid Key Length");const o=await(0,s.qt)({api:n,selection:""
})
...
}),(0,s.zt)(i)?((0,s.I)({userdata:i
}),t.classList.add("text-nstgreen"),t.innerText="Login Successful",
void u()):((0,
s.Ct)("nstdata"),t.classList.remove("text-nstgreen"),void(t.innerText="You are not allowed, contact seintz[2460991]"))):(t.classList.remove("text-nstgreen"),
void(t.innerText=i?.error))},l=async()=>{
confirm("Are you sure you want to reset?")&&((0,
s.Ct)("nstdata"),window.location.reload())},u=()=>{if(!(0,s.zt)())return
...
},r=(0,s.Y)(i,n,e.description.toLowerCase(),(t=>{
...
const t=(0,s._)({classList:"nst-block"}),e=(0,s.et)("h4",{
classList:"nst-block-title",innerText:"mug threshold"});return t.appendChild(e),
(0,s.Tt)({elem:t,title:"mug threshold"}),t})()),e.appendChild((()=>{
const t=(0,s._)({classList:"nst-block"}),e=(0,s.et)("h4",{
...
;const o=(0,s.J)("leave","outcome"),i=(0,
s.J)("mug","outcome"),a=(0,s.J)("hospitalize","outcome"),r={id:"nst-hold",
checked:(0,s.S)("hold")},c=(0,s.Y)(r,"hold","",(t=>{const e=t.target.checked;(0,
s.I)({hold:e})}))
;return n.appendChild(o),n.appendChild(i),n.appendChild(a),t.appendChild(e),
t.appendChild(n),t.appendChild(c),t})()),e.appendChild((()=>{
const t=(0,s.S)("weapon"),e=(0,s._)({classList:"nst-block"}),n=(0,s.et)("h4",{
...
id:"nst-temp",checked:(0,s.S)("temp")},r=(0,s.Y)(a,"use temp first","",(t=>{
const e=t.target.checked;(0,s.I)({temp:e})})),c={id:"nst-assa",
checked:(0,s.S)("assaperk")},l=(0,s.Y)(c,"assassinate","",(t=>{
...
}),e=(0,s.et)("h4",{classList:"nst-block-title",innerText:"weapon reload"
}),n=(0,s._)({id:"reload",classList:"nst-outcome"}),o={id:"nst-reloadone",
checked:(0,s.S)("reloadone")},i=(0,s.Y)(o,"primary","",(t=>{
const e=t.target.checked;(0,s.I)({reloadone:e})})),a={id:"nst-reloadtwo",
checked:(0,s.S)("reloadtwo")},r=(0,s.Y)(a,"secondary","",(t=>{
...
;const n=(0,s.ct)({href:"https://www.tornstats.com/settings/general",
...
})),c="tsapikey",l=(0,s.et)("input",{id:"nst-"+c,type:"password",
classList:"nst-input m-2",maxLength:19,required:!0,value:(0,s.S)(c)??""
}),u=(0,s.V)({id:"nst-tslogin",classList:"torn-btn m-2",innerText:"save"})
...
;if(!e)return;e.innerHTML="";const n=(0,s.ct)({
href:"https://www.torn.com/preferences.php#tab=api",target:"_blank",
innerText:"limited",classList:"text-nstyellow font-bold"}),o=(0,s.ct)({
...
})),u="apikey",d=(0,s.et)("input",{id:"nst-"+u,type:"password",
classList:"nst-input m-2",maxLength:16,required:!0,value:(0,s.S)(u)??""
}),m=(0,s.V)({id:"nst-login",classList:"torn-btn m-2",innerText:"save"
}),f=(0,s.V)({id:"nst-reset",classList:"torn-btn m-2",innerText:"reset"})
...
const o=t?.parentElement,i="nst-"+e.toLowerCase(),a=i+"-li",r=(0,s.U)({id:a,
...
})).appendChild((0,s.et)("b",{innerText:"NST"}))
;const a=i.appendChild((0,s.et)("ul",{id:"nst-ul-main",classList:"nst-ul-main"
}))
...
return t&&t.__esModule?t:{default:t}};Object.defineProperty(e,"__esModule",{
value:!0}),e.Nt=void 0;const i=o(n(246)),a=n(6185),s=(0,a.k)("XID")
;e.Nt=async t=>{(t=>{const e=t?.closest(".profile-wrapper"),n=(0,a.M)({
title:"Stat Spies",element:e}),o=(0,a._)({id:"nst-compare",
classList:"nst-box-column"}),i=(0,a._)({id:"nst-spies",
classList:"nst-box-column item-start"});o.appendChild((0,a.et)("table",{
id:"nst-compare-table",classList:"nst-table"})),i.appendChild((0,a.et)("table",{
id:"nst-spies-table",classList:"nst-table"})),i.appendChild((0,a.et)("table",{
id:"nst-avg-table",classList:"nst-table"})),n.appendChild(o),n.appendChild(i)
})(t);const e=await(0,a.qt)({selection:"/spy/user/"+s})
...
})))),Object.keys(t).forEach((n=>{const o=(0,a.et)("tr",{
...
}),l=(0,a.et)("td",{innerText:""+(0,a.L)(i),
classList:"nst-table-cell text-nsttorntext"}),u=(0,a.et)("td",{
innerText:""+(0,a.L)(i+s),classList:"nst-table-cell"})
...
tscompare:t.toArray()})}});const o=(0,a.et)("tr",{
classList:"nst-table-row nst-nodrag text-center"}),s=(0,a.et)("td",{
classList:"nst-table-cell",colSpan:3}),r=(0,a.ct)({
...
innerText:""+(0,a.L)(o),classList:"nst-table-cell text-nsttorntext"
}),u=(0,a.et)("td",{innerText:""+(0,a.L)(o+i),classList:"nst-table-cell"})
;u.classList.add(s),
r.appendChild(c),r.appendChild(l),r.appendChild(u),e.appendChild(r)}))
;const o=(0,a.et)("tr",{classList:"nst-table-row nst-nodrag text-center"}),i=(0,
...
o.gt)(Date.now()/1e3-s),m=(0,o.gt)(a-Date.now()/1e3),f=(0,o._)({
...
innerText:`life: ${Math.floor(c/r*100)}%`}),g=(0,o._)({id:"nst-status-la",
classList:"nst-status-item",innerText:"la: "+d});g.setAttribute("data-time",s)
...
const i=(0,o.m)(t.getAttribute("data-time")),a=(0,
o.m)(e.getAttribute("data-time")),s=(0,
o.gt)(Date.now()/1e3-i),r=(0,o.gt)(a-Date.now()/1e3)
...
4538:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.Bt=void 0
;const o=n(6185);e.Bt=async t=>{
...
}),e.Ft=e.Rt=e.Ht=e.H=e.R=e.Gt=e.yt=e.Wt=e.zt=e.Xt=e.Kt=e.qt=e.p=e.u=e.h=e.M=e.Jt=e.Yt=e.Qt=e.Vt=e.J=e.Y=e.Tt=e.Zt=e.te=e.Ot=e.ct=e.nt=e.U=e.V=e.q=e._=e.et=e.ee=e.Dt=e.gt=e.ne=e.oe=e.L=e.m=e.Ct=e.I=e.S=e.ie=e.X=e.$=e.At=e.ae=e.k=e.K=void 0,
...
e.ae=()=>window.location.search.match(/\?sid=(\w+)/)?.[1],
e.At=()=>window.location.pathname.replace(/\//,"").replace(/\.php/,""),
e.$=()=>window.location.hash.replace(/#\/\w+=/g,""),
e.X=t=>!t||null==t||0===Object.keys(t).length,e.ie=t=>{try{return JSON.parse(t)
...
localStorage.setItem("nstdata",JSON.stringify(n))},e.Ct=t=>{
...
},e.Dt=t=>t.toLowerCase().replace(/ /g,""),e.ee=t=>{const e=t.replace(/ /g,"")
;return e.charAt(0).toLowerCase()+e.slice(1)
},e.et=(t,e)=>Object.assign(document.createElement(t),e),
e._=t=>(0,e.et)("div",t),
e.q=t=>(0,e.et)("span",t),e.V=t=>(0,e.et)("button",t),e.U=t=>(0,
e.et)("li",t),e.nt=t=>(0,
e.et)("p",t),e.ct=t=>(0,e.et)("a",t),e.Ot=t=>(0,e.et)("img",t),
e.te=t=>(0,e.et)("input",t),e.Zt=t=>(0,e.et)("label",t),e.Tt=t=>{
const{elem:n,title:o,cback:i=(()=>{})}=t,a=(0,e.Dt)(o),s=(0,e._)({
classList:"nst-box-item"}),r=(0,e.et)("input",{id:"nst-"+a,type:"text",
classList:"nst-input",value:(0,e.L)(+((0,e.S)(a)??"0")),placeholder:a})
;return r.addEventListener("keyup",(t=>{const n=t.target,o=(0,e.m)(n.value)
;n.value=o.toLocaleString("en-US");const a=(0,e.Dt)(n.placeholder);(0,e.I)({
[a]:o}),i()})),s.appendChild(r),n.appendChild(s),s},e.Y=(t,n,o,i)=>{
...
;const i=(0,e.Dt)(o),r=i+"Folded",c=(0,
...
[2,10,13,18].includes(l?.error?.code)&&(0,e.Ct)("nstdata"),{status:!1,
...
status:!1}):s},e.Kt=(t={})=>{const n=(0,e.X)(t)?(0,e.S)("userdata"):t;return{
se:n?.player_id,re:n?.faction?.faction_id}
},e.Xt=t=>t.toString(16),e.zt=(t={})=>{const n=(0,e.S)("apikey")
;if(16!==n?.length)return!1
;const i=(0,e.X)(t)?(0,e.S)("userdata"):t,{se:a,re:s}=(0,e.Kt)(i)
;return!(0,e.X)(i)&&!!(0,o.t)((0,e.Xt)(s),(0,e.Xt)(a))},e.Wt=async()=>{
setTimeout(e.Wt,6e4);const t=(0,e.S)();if((0,e.X)(t))return;const n=t?.apikey
...
}),(0,e.Ht)()||(0,i.wt)(o,s)},e.yt=(t="")=>{if(!(0,e.zt)())return!1
...
e.H=t=>Object.keys(t).map((e=>`${e}=${t[e]}`)).join("&"),e.Ht=()=>void 0!==window.flutter_inappwebview,
e.Rt=t=>{
...
}catch(t){console.error(t),this._original_send(e)}})},e.Ft=(t,n)=>{
...
;const t=n(6185),e=n(2268),o=n(9607),i=n(276),a=n(1913),s=n(5661),r=n(4051),c=n(3980),l=n(714),u=n(1108),d=n(9149),m=n(7188),f=n(7716),p=n(9355),h=n(2718),b=n(5689),g=n(1379),v=n(8620),w=n(8954),y=n(3424),k=n(763),x=n(3243),_=n(8601),L=n(6215),O=n(3840),M=n(2957),j=n(8292),T=n(263),D=n(7052),S=n(4538),I=n(1549),P=n(2470),E=n(1717),A=n(8527),$=n(8990),q=n(8257),z=n(6703),C=n(7673),N={
home:()=>{
(0,t.yt)("livenetworth")&&(0,o.ot)(v.ut,'ul.info-cont-wrap [aria-label^="Networth"]'),
(0,t.yt)("effectivestats")&&(0,o.ot)(d.N,".battle")},abro:()=>{
(0,t.yt)("maxbuyabroad")&&(0,o.ot)(y.ht,"body")},trav:()=>{}},U={amarket:()=>{
(0,t.yt)("rwbonusdisplay")&&(0,o.ot)(D.Et,"body")},bazaar:()=>{
(0,t.yt)("rwbonusdisplay")&&(0,
o.ot)(D.Et,"body"),(0,t.yt)("bazaarvalue")&&(0,o.ot)(a.v,"#bazaarRoot .wrapper")
},city:()=>{},companies:()=>{},displaycase:()=>{},faction:()=>{},gym:()=>{
(0,t.yt)("specialgym")&&((0,
t.Ft)(q.tt,"getInitialGymInfo"),(0,t.Ft)(q.Z,"train"))},index:()=>{},item:()=>{
(0,t.yt)("equipnoconfirm")&&(0,t.Rt)(f.F)},imarket:()=>{
(0,t.yt)("marketnoconfirm")&&(0,t.Rt)(w.ft)},loader:()=>{
(0,t.yt)("intercept")&&"attack"===(0,t.ae)()&&(0,t.Ft)(P.rt,"attackData")},
pmarket:()=>{},profiles:()=>{},search:()=>{},trade:()=>{},all:()=>{
(0,t.yt)("leftalign")&&(0,
g.lt)(),(0,t.yt)("minilastaction")&&(0,t.Ft)(E.bt,"UserMiniProfile")},
nopager:()=>{}},B={amarket:()=>{},bazaar:()=>{
(0,t.yt)("bazaarautoprice")&&(0,o.ot)(i.l,"body")},city:()=>{
(0,t.yt)()&&(0,o.ot)(T.Pt,"body"),
(0,t.yt)("cityfinds")&&(0,o.ot)(s.O,"#map .leaflet-marker-pane")},
companies:()=>{
(0,t.yt)("ezmoneydeposit")&&(0,o.ot)(p.G,"body"),(0,t.yt)("employeela")&&(0,
o.ot)(m.B,".manage-company"),
(0,t.yt)("companyrestock")&&/stock/.test((0,t.$)())&&(0,o.ot)(r.j,"body")},
displaycase:()=>{
(0,t.yt)("displaycaseitemid")&&(0,o.ot)(l.P,"ul.dc-list"),(0,t.yt)("rwbonusdisplay")&&(0,
o.ot)(D.Et,"ul.display-cabinet")},factions:()=>{
(0,t.yt)("ezmoneydeposit")&&(0,o.ot)(p.G,"body"),
(0,t.yt)(t.qfs)&&(0,o.ot)(h.Lt,"#faction-armoury")},gym:()=>{
(0,t.yt)("")&&(0,o.ot)(z.it,'#gymroot ul[class*="properties"] [class*="strength"]')
},index:()=>{N[(0,t.Gt)()]()},item:()=>{
(0,t.yt)("removeuglyimage")&&(0,o.ot)(j.It,'[class^="itemPreviewWrapper"]',!0),
(0,
t.yt)("easyloadoutequip")&&(0,o.ot)(u.C,'ul[class^="slots"]'),(0,t.yt)(t.qis)&&(0,
o.ot)(L.Mt,"div.items-wrap")},imarket:()=>{
(0,t.yt)("marketnoconfirm")&&(0,o.ot)(w.dt,"body")},jailview:()=>{
(0,t.yt)("quickjail")&&(0,o.ot)(O.jt,"ul.users-list")},loader:()=>{
(0,t.yt)("missionhelper")&&"missions"===(0,
t.ae)()&&(0,o.ot)(k.vt,".giver-cont-wrap"),
(0,t.yt)("fighterino")&&"attack"===(0,
t.ae)()&&(0,o.ot)(I.W,'div[class^="playersModelWrap"]')
;const e=window.innerWidth<=784?'#attacker [class^="playerWindow"]':'#defender [class^="playerWindow"]'
;(0,t.yt)("targetstatus")&&"attack"===(0,t.ae)()&&(0,o.ot)($.Ut,e)},page:()=>{
(0,
t.yt)("pokername")&&"holdem"===(0,t.ae)()&&(0,o.ot)(C._t,"div[class^=players]")
},pmarket:()=>{
(0,t.yt)("pointsnoconfirm")&&(0,o.ot)(_.xt,".users-point-sell"),(0,
t.yt)("pointsmuglight")&&(0,o.ot)(x.kt,".users-point-sell")},profiles:()=>{
(0,t.yt)("idtoname")&&(0,
o.ot)(b.st,".user-info-value"),(0,t.yt)("statspies")&&(0,
o.ot)(A.Nt,".user-info-value")},properties:()=>{
(0,t.yt)("ezmoneydeposit")&&(0,o.ot)(p.G,"body")},shops:()=>{
(0,t.yt)("cshopmaxbuy")&&(0,o.ot)(c.T,"body")},trade:()=>{
(0,t.yt)("tradevalue")&&(0,o.ot)(S.Bt,"#trade-container .trade-cont")},all:()=>{
(0,t.yt)("refillreminder")&&(0,o.ot)(M.St,'[class*="bar"][class*="energy"]')},
nopager:()=>{}},F={loading:async()=>{
(0,o.ot)(e.$t,"#sidebar"),(0,t.zt)()&&(document.onreadystatechange=()=>F[document.readyState](),
(U.all??U.nopager)(),(U[(0,t.At)()]??U.nopager)(),(0,t.Wt)())},interactive:()=>{
(0,t.zt)()&&((B.all??B.nopager)(),(B[(0,t.At)()]??B.nopager)())},complete:()=>{
(0,t.zt)()}};F[document.readyState]()})()})();