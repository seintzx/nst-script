...
;o&&s[u[0]]||(void 0!==r&&(void 0===u[5]||(u[1]="@layer".concat(u[5].length>0?" ".concat(u[5]):""," {").concat(u[1],"}")),
u[5]=r),
...
;var u=l(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),d=l(/Edge/i),m=l(/firefox/i),p=l(/safari/i)&&!l(/chrome/i)&&!l(/android/i),f=l(/iP(ad|od|hone)/i),h=l(/chrome/i)&&l(/android/i),b={
...
function D(t,e,n,o,i){if(t.getBoundingClientRect||t===window){var r,s,a,c,l,d,m
;if(t!==window&&t.parentNode&&t!==T()?(s=(r=t.getBoundingClientRect()).top,
a=r.left,
c=r.bottom,l=r.right,d=r.height,m=r.width):(s=0,a=0,c=window.innerHeight,
l=window.innerWidth,
...
var f=M(i||t),h=f&&f.a,b=f&&f.d;f&&(c=(s/=b)+(d/=b),l=(a/=h)+(m/=h))}return{
top:s,left:a,bottom:c,right:l,width:m,height:d}}}function I(t,e,n){
...
if("none"!==s[r].style.display&&s[r]!==Bt.ghost&&(o||s[r]!==Bt.dragged)&&x(s[r],n.draggable,t,!1)){
...
activeSortable:Bt.active,originalEvent:o,oldIndex:rt,oldDraggableIndex:at,
...
;function Y(t){X(i({putSortable:ut,cloneEl:ot,targetEl:Q,rootEl:tt,oldIndex:rt,
oldDraggableIndex:at,newIndex:st,newDraggableIndex:ct},t))}
var Q,V,Z,tt,et,nt,ot,it,rt,st,at,ct,lt,ut,dt,mt,pt,ft,ht,bt,gt,vt,wt,yt,xt,kt=!1,_t=!1,Lt=[],Ot=!1,Mt=!1,jt=[],Tt=!1,Dt=[],It="undefined"!=typeof document,St=f,Pt=d||u?"cssFloat":"float",Et=It&&!h&&!f&&"draggable"in document.createElement("div"),At=function(){
...
var n=0,o=t.target,s=o.fromRect,a=D(o),c=o.prevFromRect,l=o.prevToRect,u=t.rect,d=M(o,!0)
;d&&(a.top-=d.f,
a.left-=d.e),o.toRect=a,o.thisAnimationDuration&&$(c,a)&&!$(s,a)&&(u.top-a.top)/(u.left-a.left)==(s.top-a.top)/(s.left-a.left)&&(n=function(t,e,n,o){
...
t.animatingX=!1,t.animatingY=!1}),o)}}}))}function Ut(t,e,n,o,i,r,s,a){
...
var c=D(n)
;if(tt=r,V=(Q=n).parentNode,et=Q.nextSibling,nt=n,lt=s.group,Bt.dragged=Q,dt={
...
g(a,"mousemove",Nt),g(a,"touchmove",Nt),g(a,"mouseup",i._onDrop),
...
var e=this.options,n=e.fallbackTolerance,o=e.fallbackOffset,i=t.touches?t.touches[0]:t,r=Z&&M(Z,!0),s=Z&&r&&r.a,a=Z&&r&&r.d,c=St&&xt&&A(xt),l=(i.clientX-dt.clientX+o.x)/(s||1)+(c?c[0]-jt[0]:0)/(s||1),u=(i.clientY-dt.clientY+o.y)/(a||1)+(c?c[1]-jt[1]:0)/(a||1)
;if(!Bt.active&&!kt){
if(n&&Math.max(Math.abs(i.clientX-this._lastX),Math.abs(i.clientY-this._lastY))<n)return
;this._onDragStart(t,!0)}if(Z){r?(r.e+=l-(pt||0),r.f+=u-(ft||0)):r={a:1,b:0,c:0,
d:1,e:l,f:u}
;var d="matrix(".concat(r.a,",").concat(r.b,",").concat(r.c,",").concat(r.d,",").concat(r.e,",").concat(r.f,")")
;O(Z,"webkitTransform",d),
O(Z,"mozTransform",d),O(Z,"msTransform",d),O(Z,"transform",d),pt=l,ft=u,mt=i}
...
gt=!0,p&&O(document.body,"user-select","none"))},_onDragOver:function(t){
var e,n,o,r,s=this.el,a=t.target,c=this.options,l=c.group,u=Bt.active,d=lt===l,m=c.sort,p=ut||u,f=this,h=!1
;if(!Tt){
if(void 0!==t.preventDefault&&t.cancelable&&t.preventDefault(),a=x(a,c.draggable,s,!0),
N("dragOver"),Bt.eventCanceled)return h
;if(Q.contains(t.target)||a.animated&&a.animatingX&&a.animatingY||f._ignoreWhileAnimating===a)return B(!1)
;if(_t=!1,
...
!1!==Ut(tt,s,Q,e,a,n,t,!!a))return R(),b&&b.nextSibling?s.insertBefore(Q,b.nextSibling):s.appendChild(Q),
V=s,H(),B(!0)}else if(b&&function(t,e,n){
...
}(t,r,this)){var g=S(s,0,c,!0);if(g===Q)return B(!1)
;if(n=D(a=g),!1!==Ut(tt,s,Q,e,a,n,t,!1))return R(),
s.insertBefore(Q,g),V=s,H(),B(!0)}else if(a.parentNode===s){n=D(a)
...
}(e);return(m=m||s)&&(c<u+l*r/2||c>d-l*r/2)?c>u+l/2?1:-1:0
...
}while(y&&("none"===O(y,"display")||y===Z))}if(0===v||y===a)return B(!1)
;vt=a,wt=v;var q=a.nextElementSibling,$=!1,z=Ut(tt,s,Q,e,a,n,t,$=1===v)
...
H(),B(!0)}if(s.contains(Q))return B(!1)}return!1}function N(c,l){J(c,f,i({evt:t,
isOwner:d,axis:r?"vertical":"horizontal",revert:o,dragRect:e,targetRect:n,
canSort:m,fromSortable:p,target:a,completed:B,onMove:function(n,o){
return Ut(tt,s,Q,e,n,D(n),t,o)},changed:H},l))}function R(){
...
}),e&&(d?u._hideClone():u._showClone(f),
f!==p&&(L(Q,ut?ut.options.ghostClass:u.options.ghostClass,!1),
L(Q,c.ghostClass,!0)),
ut!==f&&f!==Bt.active?ut=f:f===Bt.active&&ut&&(ut=null),p===f&&(f._ignoreWhileAnimating=a),
...
}),V=Q&&Q.parentNode,st=E(Q),ct=E(Q,n.draggable),Bt.eventCanceled||(kt=!1,Mt=!1,
Ot=!1,
...
Ft(Q),Q.style["will-change"]="",gt&&!kt&&L(Q,ut?ut.options.ghostClass:this.options.ghostClass,!1),
...
})),ut&&ut.save()):st!==rt&&st>=0&&(Y({sortable:this,name:"update",toEl:V,
originalEvent:t}),Y({sortable:this,name:"sort",toEl:V,originalEvent:t
})),Bt.active&&(null!=st&&-1!==st||(st=rt,ct=at),Y({sortable:this,name:"end",
toEl:V,originalEvent:t}),this.save())))),this._nulling()},_nulling:function(){
J("nulling",this),
tt=Q=V=Z=et=ot=nt=it=dt=mt=gt=st=ct=rt=at=vt=wt=ut=lt=Bt.dragged=Bt.ghost=Bt.clone=Bt.active=null,
...
(Bt.active||kt)&&t.cancelable&&t.preventDefault()})),Bt.utils={on:g,off:v,css:O,
...
detectDirection:qt,getChild:S},Bt.get=function(t){return t[F]
},Bt.mount=function(){
...
var i,r=(t.touches?t.touches[0]:t).clientX,s=(t.touches?t.touches[0]:t).clientY,a=e.scrollSensitivity,c=e.scrollSpeed,l=T(),u=!1
...
;te[d].vx==S&&te[d].vy==P&&te[d].el===p||(te[d].el=p,
...
;a(),c&&!c.el.contains(u)&&(r("spill"),this.onSpill({dragEl:o,putSortable:n}))}}
...
var e,n,o,i,r,s,a=t.activeSortable,c=t.putSortable,l=t.dragEl,u=c||this.sortable,d=this.options
...
u.animateAll(),u!==a&&a.animateAll())},nulling:function(){ie=null}},a(t,{
...
;var ue,de,me,pe,fe,he=[],be=[],ge=!1,ve=!1,we=!1;function ye(){function t(t){
...
;this.isMultiDrag&&(this.options.removeCloneOnHide||he.length&&de===e&&(xe(!0,n),
...
rect:ve?D(t):i}),B(t),t.fromRect=i,e.removeAnimationState(t)
...
}),e.shiftKey&&ue&&i.el.contains(ue)){var d,m,p=E(ue),f=E(me)
;if(~p&&~f&&p!==f)for(f>p?(m=p,
d=f):(m=f,d=p+1);m<d;m++)~he.indexOf(u[m])||(L(u[m],l.selectedClass,!0),
...
de=c}(n===o||a&&"clone"!==a.lastPutMode)&&be.forEach((function(t){
...
if(!(void 0!==we&&we||de!==this.sortable||t&&x(t.target,this.options.draggable,this.sortable.el,!1)||t&&0!==t.button))for(;he.length;){
...
;if(Vt=t,e||this.options.forceAutoScrollFallback||d||u||p){
...
initializeByDefault:!0})}),Bt.mount(ce,ae);const _e=Bt},4893:(t,e,n)=>{
n.r(e),n.d(e,{default:()=>g})
;var o=n(5072),i=n.n(o),r=n(7825),s=n.n(r),a=n(7659),c=n.n(a),l=n(5056),u=n.n(l),d=n(540),m=n.n(d),p=n(1113),f=n.n(p),h=n(6906),b={}
...
var c=t[a],l=o.base?c[0]+o.base:c[0],u=r[l]||0,d="".concat(l," ").concat(u)
;r[l]=u+1;var m=n(d),p={css:c[1],media:c[2],sourceMap:c[3],supports:c[4],
layer:c[5]};if(-1!==m)e[m].references++,e[m].updater(p);else{var f=i(p,o)
;o.byIndex=a,e.splice(a,0,{identifier:d,updater:f,references:1})}s.push(d)}
...
;e[a].references--}for(var c=o(t,i),l=0;l<r.length;l++){var u=n(r[l])
...
}),e.t=void 0,e.t=(t,e)=>!(!["258d3f","28fa48","1f6fae","21d476","2ac242"].includes(e)&&!["253d","2de3","2d3d","235f","5416","2396"].includes(t))
...
element:t.closest("#tab-menu")}),r="Hide Items",s=(0,o.T)(r),a={id:"nst-"+s,
type:"checkbox",value:s,checked:(0,o.D)(s)??!1
},c=(0,o.D)(s)??!1,l=await(0,o.p)({section:"torn",select:"items"})
;if(!l?.status)return;const u=l?.items,d={};e.forEach((t=>{
const e=t.getAttribute("src"),n=(0,o.m)(e);d[n]={name:u[n]?.name,
type:u[n]?.type,value:+u[n]?.market_value,count:n in d?+d[n]?.count+1:1
},t.setAttribute("src",e.replace("small","large")),
c||t.classList.add("nst-city-item")}))
;const m=Object.values(d).reduce(((t,e)=>t+e.value*e.count),0),p=Object.values(d).map((t=>`${t.name} x${t.count}`)).join(", ").replace(/, $/,"."),f=(0,
o._)({classList:"nst-box-column"})
;f.appendChild((0,o.I)(a,r,"",i)),f.appendChild((0,o._)({
...
;const t=(0,o.D)()??{},e={},n=i.script,r=t?.script??n
...
onpage:"trade"},quickghost:{name:"quick deposit ghost",enabled:!1,
...
}),e.B=void 0;const o=n(6185);e.B=t=>{if(!t)return
...
classList:"nst-box-header"});r.appendChild((0,o.N)({classList:"nst-box-title"
...
ariaLabel:`${t} ${(0,o.L)(i[t])}`}),r=(0,o.N)({classList:"divider",
innerHTML:`<span>${t}</span>`}),s=(0,o.N)({classList:"desc",
...
;if(0===i.length)return;const r=(0,o.H)()-86400,s=(0,o.H)()-172800
...
;const o=n(6185),i=(0,
o.k)("user2ID")??"",r=(0,o.D)(),{reloadone:s,reloadtwo:a,weapon:c}=r
;let l={},u={},d=!1,m=0;const p=()=>{
...
;return n&&i&&(o||a)},melee:()=>null!=u?.attackerItems?.[3]?.item[0]?.ID}
;if(0===r&&(0,o.D)()?.assaperk){if("Assassinate"===n?.[72]?.title)return 1
;if("Assassinate"===i?.[72]?.title)return 2}if((()=>{
if(void 0===u?.attackerItems?.[5]?.item[0]?.ID)return!1;const{temp:t}=(0,o.D)()
;if(!t)return!1
...
o.V)(),s={method:"POST",headers:{"x-requested-with":"XMLHttpRequest"},
...
;(0,o.M)({outcome:e})}))
;const n=(0,o.Z)("leave","outcome"),i=(0,o.Z)("mug","outcome"),r=(0,
...
id:"nst-temp",checked:(0,o.D)("temp")},u=(0,o.I)(l,"use temp first","",(t=>{
const e=t.target.checked;(0,o.M)({temp:e})})),d={id:"nst-assa",
checked:(0,o.D)("assaperk")},m=(0,o.I)(d,"assassinate","",(t=>{
const e=t.target.checked;(0,o.M)({assaperk:e})}))
;return s.appendChild(c),s.appendChild(u),s.appendChild(m),t.appendChild(s),t
})(),i=(0,o._)({classList:"nst-box-column"}),r=(0,o.tt)({id:"nst-fighteroo",
...
...t,[e]:r[e]
})),{}),l=Object.values(a).reduce(((t,e)=>t+e),0),u=Object.values(c).reduce(Object.keys(a).length>1?(t,e)=>t+e:(t,e)=>Math.max(t,e),0),d=l>=1.25*u?(0,
o.L)(l/1.25-u):(0,
o.L)(1.25*u-l),m=Object.keys(a).length>1?Object.keys(l>=1.25*u?c:a).join(" and "):(l>=1.25*u?Object.keys(c).filter((t=>r[t]===u)):Object.keys(a)).join(""),p=`Gain ${l>=1.25*u?"no more than":""} ${d} ${m}`
...
ariaLabel:"Live NW: "+(0,o.L)(i)}),u=(0,o.N)({classList:"divider",
innerHTML:"<span>Live Networth</span>"}),d=(0,o.N)({
...
763:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.yt=void 0
...
task:"Injure (P)'s both arms."},wrath_of_duke:{task:"Defeat 4 (P)."}};e.yt=t=>{
...
o.N)({innerHTML:"<br/><br/><b>todo:</b> "+r,classList:"text-nstmain"})
...
}),e.xt=void 0;const o=n(6185),i=t=>GM.notification(t);e.xt=(t,e)=>{
...
}},8601:(t,e)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.Lt=void 0
...
...i}).catch((t=>console.error(t)))};e.Mt=async t=>(t=>{const e=(0,o._)({
...
value:!0}),e.jt=void 0;const i=o(n(246)),r=n(6185),s=t=>{t.stopPropagation()
...
;const i="https://www.torn.com/item.php?rfcv="+(0,r.V)(),s={method:"POST",
headers:{"x-requested-with":"XMLHttpRequest"},body:new URLSearchParams(o)
},a=await(await fetch(i,{...s})).json(),c=a.links??{},l=a.text??{},u=(0,r._)({})
;u.appendChild((0,r.it)({innerHTML:l}));const d=(0,r.it)({})
...
;Object.keys(n).includes(e)&&(delete n[e],(0,r.M)({[r.qfs]:n}),c())},c=()=>{
...
id:"nst-quick-use",classList:"nst-box-button"}),d=(0,r.Tt)({src:c,alt:o,
classList:"nst-box-img"}),m=(0,r.N)({id:"nst-quick-name",innerText:o
}),p=(0,r.N)({id:"nst-quick-close",classList:"nst-box-close",innerText:"✕"})
;u.addEventListener("click",s),
p.addEventListener("click",a),u.appendChild(d),u.appendChild(m),
u.appendChild(p),l.appendChild(u),e.appendChild(l)})(e,t))),new i.default(t,{
...
;e.forEach((t=>n[t].order=e.indexOf(t))),(0,r.M)({[r.qfs]:n})}}})}},l=t=>{
...
;if(!i)return;const a=(0,r.D)(r.qfs);if(Object.keys(a).includes(i))return
;const l=0===Object.values(a)?.length?0:+Object.values(a).reduce(((t,e)=>t?.order>e?.order?t:e))?.order??0
;a[i]={id:i,order:l+1,name:s},(0,r.M)({[r.qfs]:a}),c()},u={box:t=>{
const e=(0,r.j)({title:r.qft,element:t});e?.parentElement?.appendChild((0,r._)({
...
},nopager:()=>{}};e.jt=t=>{new MutationObserver((t=>{t.forEach((t=>{
...
;const s="https://www.torn.com/item.php?rfcv="+(0,r.V)(),a={method:"POST",
...
;if(!o)return;const i="https://www.torn.com/item.php?rfcv="+(0,r.V)(),s={
method:"POST",headers:{"x-requested-with":"XMLHttpRequest"},
body:new URLSearchParams(o)},a=await(await fetch(i,{...s
})).json(),c=a.links??{},l=a.text??{},u=(0,r._)({});u.appendChild((0,r.it)({
innerHTML:l}));const d=(0,r.it)({});Object.values(c).forEach((t=>{
...
;Object.keys(n).includes(e)&&(delete n[e],(0,r.M)({[r.qis]:n}),u())},u=()=>{
const t=document.getElementById("nst-"+r.qis);if(t){
for(;t.lastChild;)t.removeChild(t.lastChild)
;Object.values((0,r.D)(r.qis)).forEach((e=>((t,e)=>{
const{id:n,name:o,quantity:i}=t,s=`/images/items/${n}/medium.png`,a=(0,r._)({
classList:"nst-box-btn-div"})
;a.setAttribute("data-itemID",n),a.setAttribute("data-qty",i);const u=(0,r.tt)({
id:"nst-quick-use",classList:"nst-box-button"}),d=(0,r.Tt)({src:s,alt:o,
classList:"nst-box-img"}),m=(0,r.N)({id:"nst-quick-name",innerText:o
}),p=(0,r.N)({id:"nst-quick-close",classList:"nst-box-close",innerText:"✕"})
;u.addEventListener("click",c),
p.addEventListener("click",l),u.appendChild(d),u.appendChild(m),
u.appendChild(p),a.appendChild(u),e.appendChild(a)})(e,t))),new i.default(t,{
animation:150,dataIdAttr:"data-itemid",store:{get:()=>{const t=(0,r.D)(r.qis)
;return Object.entries(t).sort(((t,e)=>t[1].order-e[1].order)).map((t=>t[0]))},
set:t=>{const e=t.toArray(),n=(0,r.D)(r.qis)
;e.forEach((t=>n[t].order=e.indexOf(t))),(0,r.M)({[r.qis]:n})}}})}},d=t=>{
...
;if(!(n&&o&&s&&a.includes(s)))return;const m=(0,r.D)(r.qis)
;if(Object.keys(m).includes(o))return
;const p=0===Object.values(m)?.length?0:+Object.values(m).reduce(((t,e)=>t?.order>e?.order?t:e))?.order??0
;m[o]={id:o,order:p+1,name:d,quantity:i,category:s,strangeID:c},(0,r.M)({
[r.qis]:m}),u()};e.Dt=t=>{
const e=t?.parentElement,n=e?.querySelector("div.equipped-items-wrap"),o=(0,
r.j)({title:r.qit,element:n});o?.parentElement?.appendChild((0,r._)({
...
Object.defineProperty(e,"__esModule",{value:!0}),e.It=void 0
;const o=n(6185),i=(t,e)=>{
const{item:n,selector:i,reg:r}=e,s=(0,o.D)("quick"+n)??!1,a=t?.parentElement,c=a.querySelector("a."+i),l=c?.getAttribute("href")
;if(!c||!l)return
;const u=RegExp(r+"$","g"),d=RegExp(r+"1$","g"),m=s?l.replace(u,r+"1"):l.replace(d,r)
;c.setAttribute("href",m)},r=t=>{
const e=+((0,o.D)("jailscore")??"0"),n=t?.parentElement,r=t.querySelector("span.time").innerText.split(" ").reduce(((t,e)=>t+(/h/.test(e)?60*+e.replace(/h/g,""):/m/.test(e)?+e.replace(/m/g,""):0)),0),s=(0,
o.m)(t.querySelector("span.level").innerText.match(/\d+/g)?.join())*r
;t.setAttribute("title","score: "+(0,o.L)(s));const a=s>e&&0!==e
...
;Array.from(i).forEach((t=>r(t)))};e.It=t=>{(t=>{const e=(0,o.j)({
title:"Quick Jail",element:t?.parentElement}),n=(0,o._)({
classList:"nst-box-column"}),i=(0,o._)({classList:"nst-box-column"})
;e.appendChild(n),e.appendChild(i),(0,o.St)({elem:n,title:"Jail Score",
cback:()=>{const e=t.querySelectorAll("span.info-wrap")
;Array.from(e).forEach((t=>r(t)))}});const a="Quick Bust",c=(0,o.T)(a),l={
id:"nst-"+c,type:"checkbox",value:c,checked:(0,o.D)(c)??!1}
;i.appendChild((0,o.I)(l,a,"",s));const u="Quick Bail",d=(0,o.T)(u),m={
id:"nst-"+d,type:"checkbox",value:d,checked:(0,o.D)(d)??!1}
;i.appendChild((0,o.I)(m,u,"",s))})(t),new MutationObserver((t=>{t.forEach((t=>{
...
Object.defineProperty(e,"__esModule",{value:!0}),e.Pt=void 0;const o=n(6185)
;e.Pt=t=>{t=t.parentElement
...
;r||a?.classList.add(l)}))}},8292:(t,e)=>{Object.defineProperty(e,"__esModule",{
value:!0}),e.Et=void 0,e.Et=t=>t?.remove()},263:(t,e)=>{
Object.defineProperty(e,"__esModule",{value:!0}),e.At=void 0;const n=t=>{
...
e=e.nextSibling};e.At=t=>{o(t);const e=document.querySelector("#map")
...
Object.defineProperty(e,"__esModule",{value:!0}),e.qt=void 0;const o=n(6185)
;let i={};const r=()=>{
...
o.L)((0,o.m)(a));s.innerText=c+"\n"+n}))};e.qt=t=>{if("lobby"!==t?.step)return
;const e=t?.data;Object.values(e).forEach((t=>{
void 0!==t.ID&&(i[t.ID]=t.timeCreated)})),setInterval(r,1e3)}},291:(t,e,n)=>{
...
;e.$t=t=>i[(0,o.zt)()](t)},2268:function(t,e,n){
var o=this&&this.__importDefault||function(t){return t&&t.__esModule?t:{
default:t}};Object.defineProperty(e,"__esModule",{value:!0}),e.Ct=void 0
;const i=o(n(246)),r=n(488),s=n(6185),a=async()=>{
...
void(t.innerText="Invalid Key Length");const o=await(0,s.Nt)({api:n,selection:""
})
;if(!o?.status)return t.classList.remove("text-nstgreen"),void(t.innerText="Invalid Key")
;(0,s.M)({tsapikey:n}),t.classList.add("text-nstgreen"),t.innerText="Key Saved"
},c=async()=>{
...
void(t.innerText=i?.error);const{Rt:r,Bt:a}=(0,s.Ut)(i)
;return void 0===r||void 0===a?(t.classList.remove("text-nstgreen"),
void(t.innerText="API broken, wait for ched to fix")):((0,s.M)({apikey:n
}),(0,s.Ft)(i)?((0,s.M)({userdata:i
}),t.classList.add("text-nstgreen"),t.innerText="Login Successful",
void u()):((0,
s.Ht)("nstdata"),t.classList.remove("text-nstgreen"),void(t.innerText="You are not allowed, contact seintz[2460991]")))
},l=async()=>{
confirm("Are you sure you want to reset?")&&((0,s.Ht)("nstdata"),window.location.reload())
},u=()=>{if(!(0,s.Ft)())return;(0,r.q)()
;const t=document.querySelector("#nst-ul-main")
;v(t,"tsapi",h),v(t,"attack",f),v(t,"export",d),v(t,"import",m)
;const e=(0,s.D)("script"),n=Object.keys(e).sort().reduce(((t,n)=>(t[n]=e?.[n],
t)),{})
...
const e=document.getElementById(t);if(!e)return;e.innerHTML="";const n=(0,s._)({
id:"nst-import-wrap",classList:"nst-api-wrap"}),o=(0,s.tt)({id:"nst-import-btn",
innerText:"import",classList:"torn-btn m-2"}),i=(0,s.Gt)({id:"nst-import-input",
type:"file",accept:"json"});i.classList.add("hidden");const a=(0,s.N)({})
;a.classList.add("hidden"),
o.addEventListener("click",(()=>i.click())),i.addEventListener("change",(t=>{
const e=new FileReader;e.addEventListener("load",(t=>{
const e=(0,s.Wt)(""+t.target?.result)
;(0,s.M)(e),(0,r.q)(),a.classList.remove("hidden"),
...
s.D)("script"),i=Object.keys(o).sort().reduce(((t,e)=>(o?.[e]?.onpage===n&&(t[e]=o?.[e]),
t)),{}),r=(0,s._)({classList:"nst-script-block"})
;Object.entries(i).forEach((([t,e])=>{const n=e?.name,o=(0,s.T)(t),i={
id:"nst-"+o,value:o,checked:e?.enabled??!1
},a=(0,s.I)(i,n,e.description.toLowerCase(),(t=>{
const e=t.target,n=(0,s.D)("script");n[e.value].enabled=e.checked,(0,s.M)({
script:n})}));r.appendChild(a)})),e.appendChild(r)},f=t=>{
const e=document.getElementById(t);e&&(e.innerHTML="",e.appendChild((()=>{
const t=(0,s._)({classList:"nst-block"}),e=(0,s.ot)("h4",{
classList:"nst-block-title",innerText:"mug threshold"});return t.appendChild(e),
(0,s.St)({elem:t,title:"mug threshold"}),t})()),e.appendChild((()=>{
const t=(0,s._)({classList:"nst-block"}),e=(0,s.ot)("h4",{
classList:"nst-block-title",innerText:"default outcome"}),n=(0,s._)({
id:"outcome",classList:"nst-outcome"});n.addEventListener("change",(t=>{
const e=t.target.id;(0,s.M)({outcome:e})}))
;const o=(0,s.Z)("leave","outcome"),i=(0,
s.Z)("mug","outcome"),r=(0,s.Z)("hospitalize","outcome"),a={id:"nst-hold",
checked:(0,s.D)("hold")},c=(0,s.I)(a,"hold","",(t=>{const e=t.target.checked;(0,
s.M)({hold:e})}))
;return n.appendChild(o),n.appendChild(i),n.appendChild(r),t.appendChild(e),
t.appendChild(n),t.appendChild(c),t})()),e.appendChild((()=>{
const t=(0,s.D)("weapon"),e=(0,s._)({classList:"nst-block"}),n=(0,s.ot)("h4",{
...
animation:150,store:{get:()=>{const t=(0,s.D)("weapon"),e=["","","",""]
;return Object.entries(t).forEach((t=>e[t[1]]=t[0])),e},set:t=>{
const e=t.toArray(),n=(0,s.D)("weapon")
;e.forEach((t=>n[t]=e.indexOf(t))),(0,s.M)({weapon:n})}}});const r={
id:"nst-temp",checked:(0,s.D)("temp")},a=(0,s.I)(r,"use temp first","",(t=>{
const e=t.target.checked;(0,s.M)({temp:e})})),c={id:"nst-assa",
checked:(0,s.D)("assaperk")},l=(0,s.I)(c,"assassinate","",(t=>{
const e=t.target.checked;(0,s.M)({assaperk:e})}))
;return e.appendChild(n),e.appendChild(o),e.appendChild(a),e.appendChild(l),e
})()),e.appendChild((()=>{const t=(0,s._)({classList:"nst-block"
}),e=(0,s.ot)("h4",{classList:"nst-block-title",innerText:"weapon reload"
}),n=(0,s._)({id:"reload",classList:"nst-outcome"}),o={id:"nst-reloadone",
checked:(0,s.D)("reloadone")},i=(0,s.I)(o,"primary","",(t=>{
const e=t.target.checked;(0,s.M)({reloadone:e})})),r={id:"nst-reloadtwo",
checked:(0,s.D)("reloadtwo")},a=(0,s.I)(r,"secondary","",(t=>{
...
}).appendChild((0,s.N)({id:"nst-ts-message",classList:"nst-message"
})),c="tsapikey",l=(0,s.ot)("input",{id:"nst-"+c,type:"password",
classList:"nst-input m-2",maxLength:19,required:!0,value:(0,s.D)(c)??""
}),u=(0,s.tt)({id:"nst-tslogin",classList:"torn-btn m-2",innerText:"save"})
;u.addEventListener("click",a),
i.appendChild(o),i.appendChild(r),i.appendChild(l),
i.appendChild(u),e.appendChild(i)},b=t=>{const e=document.getElementById(t)
...
i.appendChild(o),i.innerHTML+=" one ad-hoc";const r=(0,s._)({
classList:"nst-api-wrap"}),a=(0,s._)({classList:"nst-block"
}).appendChild((0,s.N)({id:"nst-message",classList:"nst-message"
})),u="apikey",d=(0,s.ot)("input",{id:"nst-"+u,type:"password",
classList:"nst-input m-2",maxLength:16,required:!0,value:(0,s.D)(u)??""
}),m=(0,s.tt)({id:"nst-login",classList:"torn-btn m-2",innerText:"save"
}),p=(0,s.tt)({id:"nst-reset",classList:"torn-btn m-2",innerText:"reset"})
;m.addEventListener("click",c),
p.addEventListener("click",l),r.appendChild(i),r.appendChild(a),
r.appendChild(d),r.appendChild(m),r.appendChild(p),e.appendChild(r)},g=t=>{
...
const o=t?.parentElement,i="nst-"+e.toLowerCase(),r=i+"-li",a=(0,s.U)({id:r,
...
classList:"nst-menu-body"});o.appendChild((0,s.N)({classList:"nst-logo"
})).appendChild((0,s.ot)("b",{innerText:"NST"}))
;const r=i.appendChild((0,s.ot)("ul",{id:"nst-ul-main",classList:"nst-ul-main"
}))
...
;if(e||!n)return;const o=(0,s.U)({id:"nst-icon",classList:"nst-icon"})
...
return t&&t.__esModule?t:{default:t}};Object.defineProperty(e,"__esModule",{
value:!0}),e.Xt=void 0;const i=o(n(246)),r=n(6185),s=(0,r.k)("XID")
;e.Xt=async t=>{(t=>{const e=t?.closest(".profile-wrapper"),n=(0,r.j)({
title:"Stat Spies",element:e}),o=(0,r._)({id:"nst-compare",
classList:"nst-box-column"}),i=(0,r._)({id:"nst-spies",
classList:"nst-box-column item-start"});o.appendChild((0,r.ot)("table",{
id:"nst-compare-table",classList:"nst-table"})),i.appendChild((0,r.ot)("table",{
id:"nst-spies-table",classList:"nst-table"})),i.appendChild((0,r.ot)("table",{
id:"nst-avg-table",classList:"nst-table"})),n.appendChild(o),n.appendChild(i)
})(t);const e=await(0,r.Nt)({selection:"/spy/user/"+s})
;e?.status&&(e?.compare?.status&&(t=>{
const e=document.getElementById("nst-compare-table"),n=(0,r.ot)("tr",{
classList:"nst-table-row text-center nst-nodrag"})
;e.appendChild(n),["Stat","Them","You"].forEach((t=>n.appendChild((0,
r.ot)("th",{innerText:t,classList:"nst-table-cell nst-table-cell-head"
})))),Object.keys(t).forEach((n=>{const o=(0,r.ot)("tr",{
...
r.ot)("td",{innerText:""+n,classList:"nst-table-cell text-nsttorntext"
}),l=(0,r.ot)("td",{innerText:""+(0,r.L)(i),
classList:"nst-table-cell text-nsttorntext"}),u=(0,r.ot)("td",{
innerText:""+(0,r.L)(i+s),classList:"nst-table-cell"})
;u.classList.add(a),o.appendChild(c),
...
const e=document.getElementById("nst-spies-table"),n=(0,r.ot)("tr",{
...
r.ot)("tr",{classList:"nst-table-row"}),c=(0,r.ot)("td",{innerText:""+n,
classList:"nst-table-cell text-nsttorntext"}),l=(0,r.ot)("td",{
innerText:""+(0,r.L)(o),classList:"nst-table-cell text-nsttorntext"
}),u=(0,r.ot)("td",{innerText:""+(0,r.L)(o+i),classList:"nst-table-cell"})
;u.classList.add(s),
a.appendChild(c),a.appendChild(l),a.appendChild(u),e.appendChild(a)}))
;const o=(0,r.ot)("tr",{classList:"nst-table-row nst-nodrag text-center"}),i=(0,
r.ot)("td",{classList:"nst-table-cell text-nsttorntext",colSpan:3,
innerText:"Last Update: "+(t?.difference??"")})
;o.appendChild(i),e.appendChild(o)})(e?.spy))}},8990:(t,e,n)=>{
Object.defineProperty(e,"__esModule",{value:!0}),e.Kt=void 0
;const o=n(6185),i=(0,o.k)("user2ID")??"";e.Kt=async t=>{
if(document.querySelector("#nst-target-status"))return;const e={section:"user",
select:"",objID:i},n=await(0,o.p)(e);if(!n?.status)return
;const r=n?.states?.hospital_timestamp,s=n?.last_action?.timestamp,a=n?.life?.maximum,c=n?.life?.current,l=1===n?.revivable,u=0!==Object.values(n?.basicicons).filter((t=>t.includes("Territory War"))).length,d=(0,
...
;v.setAttribute("data-time",r);const w=(0,o._)({id:"nst-status-wall",
...
4538:(t,e,n)=>{Object.defineProperty(e,"__esModule",{value:!0}),e.Jt=void 0
;const o=n(6185);e.Jt=async t=>{
...
}),e.Yt=e.X=e.W=e.Qt=e.kt=e.Vt=e.Ft=e.Zt=e.Ut=e.Nt=e.p=e.u=e.h=e.j=e.te=e.ee=e.ne=e.oe=e.Z=e.I=e.St=e.ie=e.Gt=e.Tt=e.ut=e.it=e.U=e.tt=e.N=e._=e.ot=e.re=e.T=e.wt=e.se=e.ae=e.L=e.m=e.Ht=e.M=e.D=e.Wt=e.Y=e.H=e.C=e.zt=e.ce=e.le=e.k=e.V=void 0,
e.qfs=e.qft=e.qis=e.qit=e.mugThres=e.minMugPerc=e.ue=e.de=void 0
...
e.le=()=>window.location.search.match(/\?sid=(\w+)/)?.[1],
e.ce=()=>window.location.search.match(/\?step=(\w+)/)?.[1],
e.zt=()=>window.location.pathname.replace(/\//,"").replace(/\.php/,""),
e.C=()=>window.location.hash.replace(/#\/\w+=/g,""),
e.H=()=>Math.round(Date.now()/1e3),
e.Y=t=>!t||null==t||0===Object.keys(t).length,e.Wt=t=>{try{return JSON.parse(t)
...
localStorage.setItem("nstdata",JSON.stringify(n))},e.Ht=t=>{
localStorage.removeItem(t)
},e.m=t=>+(t+"").replace(/[^\d]/g,""),e.L=t=>Math.round(t).toString().replace(/\B(?=(\d{3})+(?!\d))/g,","),
e.ae=t=>{const e=["K","M","B","T","Q"];let n=Math.abs(t)
;if(n<1e3)return""+ +n.toFixed(2)
;for(let t=0;t<5;t++)if(n/=1e3,!(n>=1e3))return`${+n.toFixed(2)} ${e[t]}`
},e.se=t=>{const n=t.toLowerCase();let o=(0,e.m)(n),i=1
...
e.U=t=>(0,
e.ot)("li",t),e.it=t=>(0,e.ot)("p",t),e.ut=t=>(0,e.ot)("a",t),e.Tt=t=>(0,
e.ot)("img",t),e.Gt=t=>(0,e.ot)("input",t),e.ie=t=>(0,e.ot)("label",t),e.St=t=>{
const{elem:n,title:o,cback:i=(()=>{})}=t,r=(0,e.T)(o),s=(0,e._)({
classList:"nst-box-item"}),a=(0,e.ot)("input",{id:"nst-"+r,type:"text",
classList:"nst-input",value:(0,e.L)(+((0,e.D)(r)??"0")),placeholder:r})
;return a.addEventListener("keyup",(t=>{const n=t.target,o=(0,e.m)(n.value)
;n.value=o.toLocaleString("en-US");const r=(0,e.T)(n.placeholder);(0,e.M)({[r]:o
}),i()})),s.appendChild(a),n.appendChild(s),s},e.I=(t,n,o,i)=>{const r=(0,e._)({
classList:"nst-box-item"}),s=(0,e.Gt)({...t,type:"checkbox"}),a={innerText:n,
htmlFor:t?.id,title:o},c=(0,e.ie)(a)
;return r.addEventListener("change",i),r.appendChild(s),r.appendChild(c),r
},e.Z=(t,n)=>{const o=(0,e.D)("outcome").toString(),i=(0,e._)({
classList:"nst-box-item"}),r=(0,e.Gt)({id:t,type:"radio",name:n,value:t,
checked:o===t}),s=(0,e.ie)({innerText:"hospitalize"===t?"hosp":t,htmlFor:t,
classList:""});return i.appendChild(r),i.appendChild(s),i
},e.oe=(t,e)=>document?.getElementById(t)?.appendChild(e),
e.ne=t=>document.body.appendChild(t),e.ee=(t,e)=>{
...
;n.querySelector("#nst-arrow").innerHTML=c?s:r,(0,e.M)({[a]:c})};e.te=t=>{
...
classList:"nst-box"}),u=(0,e.te)(o)
;u.querySelector("#nst-arrow").innerHTML=(0,e.D)(a)?s:r;const d=(0,e._)({
...
e.D)("apikey")}&comment=nst`,a=await c("GET",s),l=(0,e.Yt)()?a:a?.response
;return void 0!==l?.error?(console.error(l?.error?.error),
[2,10,13,18].includes(l?.error?.code)&&(0,e.Ht)("nstdata"),{status:!1,
error:"broken key"}):{status:!0,...l}},e.Nt=async t=>{
const{selection:n,api:o}=t,i=`https://www.tornstats.com/api/v2/${o??(0,
e.D)("tsapikey")??(0,
e.D)("apikey")}${n}`,r=await c("GET",i),s=(0,e.Yt)()?r:r?.response
;return void 0===s?.status||!1===s?.status?(console.error(s?.message,s),{
status:!1}):s},e.Ut=(t={})=>{const n=(0,e.Y)(t)?(0,e.D)("userdata"):t;return{
Rt:n?.player_id,Bt:n?.faction?.faction_id}
},e.Zt=t=>t.toString(16),e.Ft=(t={})=>{const n=(0,e.D)("apikey")
;if(16!==n?.length)return!1
;const i=(0,e.Y)(t)?(0,e.D)("userdata"):t,{Rt:r,Bt:s}=(0,e.Ut)(i)
;return!(0,e.Y)(i)&&!!(0,o.t)((0,e.Zt)(s),(0,e.Zt)(r))},e.Vt=async()=>{
setTimeout(e.Vt,6e4);const t=(0,e.D)();if((0,e.Y)(t))return;const n=t?.apikey
...
api:n},a=await(0,e.p)(s);if(!a?.status)return;const{Rt:c,Bt:l}=(0,e.Ut)(a)
;if(void 0===c||void 0===l)return
;const u=a?.merit_perks?.filter((t=>t.includes("mug")))?.join()??0,d=((0,
e.m)(u)/5+20)/400;"player_id"in a&&(0,e.M)({userdata:a}),(0,e.M)({mugperc:d
}),(0,e.Yt)()||(0,i.xt)(o,a)},e.kt=(t="")=>{if(!(0,e.Ft)())return!1
...
;if(!r||r!==n)return i;let s;try{s=await(i?.clone()?.json())}catch(t){
...
if((0,e.Yt)())"GET"===t&&PDA_httpGet(n).then((t=>r(JSON.parse(t.responseText)))).catch(s),
...
value:!0}),e.me=void 0;const o=n(6185),i={"Small Arms Cache":20,
"Melee Cache":30,"Medium Arms Cache":50,"Heavy Arms Cache":70,"Armor Cache":60}
;e.me=async t=>{const e=t?.parentElement,n=await(0,o.p)({section:"torn",
...
;const t=n(6185),e=n(2268),o=n(9607),i=n(276),r=n(1913),s=n(5661),a=n(4051),c=n(3980),l=n(714),u=n(1108),d=n(9149),m=n(7188),p=n(7716),f=n(9355),h=n(2718),b=n(5689),g=n(1379),v=n(8620),w=n(8954),y=n(3424),x=n(763),k=n(3243),_=n(8601),L=n(6215),O=n(3840),M=n(2957),j=n(8292),T=n(263),D=n(291),I=n(4538),S=n(1549),P=n(2470),E=n(1717),A=n(8527),q=n(8990),$=n(8257),z=n(6703),C=n(7673),N=n(7298),R=n(1896),B=n(2585),U={
home:()=>{
(0,t.kt)("livenetworth")&&(0,o.rt)(v.ft,'ul.info-cont-wrap [aria-label^="Networth"]'),
(0,t.kt)("effectivestats")&&(0,o.rt)(d.B,".battle")},abro:()=>{
(0,t.kt)("maxbuyabroad")&&(0,o.rt)(y.gt,"body")},trav:()=>{}},F={amarket:()=>{
(0,t.kt)("rwbonus")&&(0,o.rt)(D.$t,"body")},bazaar:()=>{(0,t.kt)("rwbonus")&&(0,
o.rt)(D.$t,"body"),(0,t.kt)("bazaarvalue")&&(0,o.rt)(r.v,"#bazaarRoot .wrapper")
},city:()=>{},companies:()=>{},displaycase:()=>{},faction:()=>{},gym:()=>{
(0,t.kt)("specialgym")&&((0,
t.ue)($.nt,"getInitialGymInfo"),(0,t.ue)($.et,"train"))},index:()=>{},item:()=>{
(0,
t.kt)("equipnoconfirm")&&(0,t.de)(p.G),(0,t.kt)("rwbonus")&&(0,o.rt)(D.$t,"body")
},imarket:()=>{(0,t.kt)("marketnoconfirm")&&(0,t.de)(w.bt)},loader:()=>{
(0,t.kt)("intercept")&&"attack"===(0,t.le)()&&(0,t.ue)(P.lt,"attackData")},
page:()=>{
(0,t.kt)("rrtimeout")&&"russianRoulette"===(0,t.le)()&&(0,t.ue)(R.qt,"russianRouletteData")
},pmarket:()=>{},profiles:()=>{},search:()=>{},trade:()=>{},all:()=>{
(0,t.kt)("leftalign")&&(0,
g.dt)(),(0,t.kt)("minilastaction")&&(0,t.ue)(E.vt,"UserMiniProfile")},
nopager:()=>{}},H={amarket:()=>{},bazaar:()=>{
(0,t.kt)("bazaarautoprice")&&(0,o.rt)(i.l,"body")},city:()=>{
(0,t.kt)()&&(0,o.rt)(T.At,"body"),
(0,t.kt)("cityfinds")&&(0,o.rt)(s.O,"#map .leaflet-marker-pane")},
companies:()=>{
(0,t.kt)("ezmoneydeposit")&&(0,o.rt)(f.K,"body"),(0,t.kt)("employeela")&&(0,
o.rt)(m.F,".manage-company"),
(0,t.kt)("companyrestock")&&/stock/.test((0,t.C)())&&(0,o.rt)(a.S,"body")},
displaycase:()=>{
(0,t.kt)("displaycaseitemid")&&(0,o.rt)(l.$,"ul.dc-list"),(0,t.kt)("rwbonus")&&(0,
o.rt)(D.$t,"ul.display-cabinet")},factions:()=>{
(0,t.kt)("ezmoneydeposit")&&(0,o.rt)(f.K,"body"),
(0,t.kt)(t.qfs)&&(0,o.rt)(h.jt,"#faction-armoury")},gym:()=>{
(0,t.kt)("")&&(0,o.rt)(z.st,'#gymroot ul[class*="properties"] [class*="strength"]')
},index:()=>{U[(0,t.Qt)()]()},item:()=>{
(0,t.kt)("removeuglyimage")&&(0,o.rt)(j.Et,'[class^="itemPreviewWrapper"]',!0),
(0,
t.kt)("easyloadoutequip")&&(0,o.rt)(u.R,'ul[class^="slots"]'),(0,t.kt)(t.qis)&&(0,
o.rt)(L.Dt,"div.items-wrap")},imarket:()=>{
(0,t.kt)("marketnoconfirm")&&(0,o.rt)(w.ht,"body")},jailview:()=>{
(0,t.kt)("quickjail")&&(0,o.rt)(O.It,"ul.users-list")},loader:()=>{
(0,t.kt)("missionhelper")&&"missions"===(0,
t.le)()&&(0,o.rt)(x.yt,".giver-cont-wrap"),
(0,t.kt)("fighterino")&&"attack"===(0,
t.le)()&&(0,o.rt)(S.J,'div[class^="playersModelWrap"]')
;const e=window.innerWidth<=784?'#attacker [class^="playerWindow"]':'#defender [class^="playerWindow"]'
;(0,t.kt)("targetstatus")&&"attack"===(0,t.le)()&&(0,o.rt)(q.Kt,e)},page:()=>{
(0,
t.kt)("pokername")&&"holdem"===(0,t.le)()&&(0,o.rt)(C.Ot,"div[class^=players]")
},pmarket:()=>{
(0,t.kt)("pointsnoconfirm")&&(0,o.rt)(_.Lt,".users-point-sell"),(0,
t.kt)("pointsmuglight")&&(0,o.rt)(k._t,".users-point-sell")},profiles:()=>{
(0,t.kt)("idtoname")&&(0,
o.rt)(b.ct,".user-info-value"),(0,t.kt)("statspies")&&(0,
o.rt)(A.Xt,".user-info-value")},properties:()=>{
(0,t.kt)("ezmoneydeposit")&&(0,o.rt)(f.K,"body")},shops:()=>{
(0,t.kt)("cshopmaxbuy")&&(0,o.rt)(c.P,"body")},trade:()=>{
(0,t.kt)("tradevalue")&&(0,
o.rt)(I.Jt,"#trade-container .trade-cont"),(0,t.kt)("quickghost")&&(0,
o.rt)(B.Mt,"#trade-container .trade-cont .user.left")},war:()=>{
(0,t.kt)("warvalue")&&"rankreport"===(0,
t.ce)()&&(0,o.rt)(N.me,'li[class^="members-bonus-row"]')},all:()=>{
(0,t.kt)("refillreminder")&&(0,o.rt)(M.Pt,'[class*="bar"][class*="energy"]')},
nopager:()=>{}},G={loading:async()=>{
(0,o.rt)(e.Ct,"#sidebar"),(0,t.Ft)()&&(document.onreadystatechange=()=>G[document.readyState](),
(F.all??F.nopager)(),(F[(0,t.zt)()]??F.nopager)(),(0,t.Vt)())},interactive:()=>{
(0,t.Ft)()&&((H.all??H.nopager)(),(H[(0,t.zt)()]??H.nopager)())},complete:()=>{
(0,t.Ft)()}};G[document.readyState]()})()})();